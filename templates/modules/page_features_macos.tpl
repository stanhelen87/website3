<div id="content" class="site-content">
	<div id="primary" class="content-area"> 
		<div class="content">
			<section class="features_WM">
				<div class="container">		
					<h1>{t('SITE_FEATURES_MACOS_HEAD')}</h1>
					<small>{t('SITE_FEATURES_MACOS_SUBHEAD')}</small>
					...
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="carousel-inner">
								...
								<div class="item active"><img src="/assets/img/mac_new/preview_mac_01.jpg" alt=""/>
								...
								<div class="item">
				      				<img src="/assets/img/mac_new/preview_mac_02.jpg" alt="" />
				      				<div class="carousel-caption">
				    					<h3>{t('SITE_FEATURES_WINDOWS_SLIDE_HEAD_2')}</h3>
										<p>{t('SITE_FEATURES_WINDOWS_SLIDE_TEXT_2')}</p>
				      				</div>
								</div>
								<div class="item"><img src="/assets/img/mac_new/preview_mac_03.jpg" alt="" />
				      				<div class="carousel-caption">
								...
								<div class="item">
				      				<img src="/assets/img/mac_new/preview_mac_04.jpg" alt="" />
				      				<div class="carousel-caption">
								...
								<div class="item">
				      				<img src="/assets/img/mac_new/preview_mac_05.jpg" alt=""/>
				      				<div class="carousel-caption">
						...
						<div class="features_WM_info col-lg-5 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-lg-12 col-md-5 col-sm-6 col-xs-12">
								<div class="features_WM_btn_container">
									<a class="main_btn" href="http://download.pamfax.biz/PamFaxInstaller.dmg">{t('BTN_DOWNLOAD')}</a>
{if !isset($User)}
									<a class="main_btn rose" href="#" data-toggle="modal" data-target="#registrationModal">{t('BTN_SIGN_UP')}</a>
{/if}
								</div>
							</div>
						</div>
