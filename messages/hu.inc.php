...
"BTN_PAY_N_SEND" => "Fizetés és küldés",
"BTN_PLAN" => "Plan",
"BTN_PORTAL" => "Portal",
...
"BTN_SEND" => "Fax küldése",
"BTN_SENDASFAX" => "Send as fax",
"BTN_SEND_ANOTHER" => "Új fax küldése",
...
"BTN_SHARE" => "Share",
"BTN_SHOW_GOOGLE_MAP" => "A címzettek helyének megjelenítése a  {img_google} térképen.",
...
"BTN_START_UPDATE" => "Igen, kezdjük a frissítést.",
...
"BTN_UP" => "Up",
"BTN_UPDATE_LATER" => "Nem, kés?bb frissítek.",
...
"ERR_FAX_23443" => "Destination unreachable",
"ERR_FAX_23468" => "Invalid number format",
...
"MSG_COVERTEXT_REQUIRED" => "Ha csak egy fed?lapot küld, üzenetet is meg kell adnia.",
...
"MSG_CREDITS_RESTORED" => "A krediteket visszaállítottuk.",
...
"MSG_DUPS_REMOVED" => "Bizonyos számokat több példányban szerepeltek. A költség <br>csökkentése céljából a duplikátumokat eltávolítottuk.",
...
"MSG_FAXNUMBER_MISSING" => "Adjon meg egy faxszámot!",
...
"MSG_MAILRECIPIENT_MISSING" => "Adja meg az e-mail címzettjét!",
...
"MSG_MULFAXNUMBERS_MISSING" => "Legalább egy faxszámot adjon meg!",
...
"MSG_NO_RECIPIENT" => "Nem található megfelel? címzett.",
...
"MSG_PREPARE_PREVIEW" => "El?nézet készítése...",
...
"MSG_SMSRECIPIENT_MISSING" => "Adja meg az SMS címzettjét!",
"MSG_SOME_INVALID_NUMBERS" => "A megadott faxszámok között hibásnak t?n? is van!",
"MSG_SOME_UNPAID_FAXES_SENT" => "Some unpaid faxes were sent, the others remain unpaid due to insufficient credit.",
"MSG_STORING_CREDIT" => "Kreditinformációk tárolása...",
...
"MSG_WAIT_DEFAULT" => "Kérjük, várjon...",
...
"TITLE_COVER_TEXT" => "Írja be az üzenetet!",
...
"TITLE_NOTIFY" => "Értesítési beállítások",
"TITLE_NUMBER" => "Asja meg a címzett(ek)et!",
"TITLE_PAY" => "A fax kifizetése",
...
"TITLE_SELECT_COVER" => "Válasszon fed?lapot!",
...
"TXT_BUY_PAMFAXCREDIT" => "PamFax kredit vásárlása",
"TXT_BYFAX_ABOUT" => "About [apptitle]",
"TXT_CAD" => "Kanadai dollár",
...
"TXT_COUNTRY_AE" => "Egyesült Arab Emírségek",
"TXT_COUNTRY_AF" => "Afganisztán",
"TXT_COUNTRY_AG" => "Antigua és Barbuda",
"TXT_COUNTRY_AI" => "Anguilla",
"TXT_COUNTRY_AL" => "Albánia",
"TXT_COUNTRY_AM" => "Örményország",
"TXT_COUNTRY_AN" => "Holland Antillák",
"TXT_COUNTRY_AO" => "Angola",
"TXT_COUNTRY_AQ" => "Antarktisz",
"TXT_COUNTRY_AR" => "Argentína",
"TXT_COUNTRY_AS" => "Amerikai Szamoa",
"TXT_COUNTRY_AT" => "Ausztria",
"TXT_COUNTRY_AU" => "Ausztrália",
"TXT_COUNTRY_AW" => "Aruba",
"TXT_COUNTRY_AX" => "Aland Islands",
"TXT_COUNTRY_AZ" => "Azerbajdzsán",
"TXT_COUNTRY_BA" => "Bosznia-Hercegovina",
"TXT_COUNTRY_BB" => "Barbados",
"TXT_COUNTRY_BD" => "Banglades",
...
"TXT_COUNTRY_BR" => "Brazília",
"TXT_COUNTRY_BS" => "Bahama-szigetek",
"TXT_COUNTRY_BT" => "Bhután",
"TXT_COUNTRY_BV" => "Bouvet-sziget",
"TXT_COUNTRY_BW" => "Botswana",
"TXT_COUNTRY_BY" => "Fehéroroszország",
"TXT_COUNTRY_BZ" => "Belize",
"TXT_COUNTRY_CA" => "Kanada",
"TXT_COUNTRY_CC" => "Cocos-szigetek (Keeling-szigetek)",
"TXT_COUNTRY_CD" => "Kongói Demokratikus Köztársaság",
"TXT_COUNTRY_CF" => "Közép-afrikai Köztársaság",
"TXT_COUNTRY_CG" => "Kongó",
"TXT_COUNTRY_CH" => "Svájc",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "Elefántcsontpart",
"TXT_COUNTRY_CK" => "Cook-szigetek",
...
"TXT_COUNTRY_CU" => "Kuba",
"TXT_COUNTRY_CV" => "Zöldfoki-szigetek",
"TXT_COUNTRY_CW" => "Curaçao",
"TXT_COUNTRY_CX" => "Karácsony-sziget",
"TXT_COUNTRY_CY" => "Ciprus",
"TXT_COUNTRY_CZ" => "Cseh Köztársaság",
"TXT_COUNTRY_DE" => "Németország",
"TXT_COUNTRY_DJ" => "Dzsibuti",
"TXT_COUNTRY_DK" => "Dánia",
"TXT_COUNTRY_DM" => "Dominika",
"TXT_COUNTRY_DO" => "Dominikai Köztársaság",
"TXT_COUNTRY_DZ" => "Algéria",
"TXT_COUNTRY_EC" => "Ecuador",
"TXT_COUNTRY_EE" => "Észtország",
"TXT_COUNTRY_EG" => "Egyiptom",
"TXT_COUNTRY_EH" => "Nyugat-Szahara",
"TXT_COUNTRY_ER" => "Eritrea",
"TXT_COUNTRY_ES" => "Spanyolország",
"TXT_COUNTRY_ET" => "Etiópia",
"TXT_COUNTRY_FI" => "Finnország",
"TXT_COUNTRY_FJ" => "Fidzsi",
"TXT_COUNTRY_FK" => "Falkland-szigetek (Malvin-szigetek)",
"TXT_COUNTRY_FM" => "Mikronéziai Szövetségi Államok",
"TXT_COUNTRY_FO" => "Feröer-szigetek",
"TXT_COUNTRY_FR" => "Franciaország",
"TXT_COUNTRY_GA" => "Gabon",
"TXT_COUNTRY_GB" => "Egyesült Királyság",
"TXT_COUNTRY_GD" => "Grenada",
"TXT_COUNTRY_GE" => "Grúzia",
"TXT_COUNTRY_GF" => "Francia Guyana",
"TXT_COUNTRY_GG" => "Guernsey",
"TXT_COUNTRY_GH" => "Ghána",
"TXT_COUNTRY_GI" => "Gibraltár",
"TXT_COUNTRY_GL" => "Grönland",
"TXT_COUNTRY_GM" => "Gambia",
"TXT_COUNTRY_GN" => "Guinea",
"TXT_COUNTRY_GP" => "Guadeloupe",
"TXT_COUNTRY_GQ" => "Egyenlítői Guinea",
"TXT_COUNTRY_GR" => "Görögország",
"TXT_COUNTRY_GS" => "Dél-Georgia és a Dél-Sandwich-szigetek",
"TXT_COUNTRY_GT" => "Guatemala",
"TXT_COUNTRY_GU" => "Guam",
"TXT_COUNTRY_GW" => "Guinea-Bissau",
"TXT_COUNTRY_GY" => "Guyana",
"TXT_COUNTRY_HK" => "Hongkong",
"TXT_COUNTRY_HM" => "Heard- és McDonald-szigetek",
"TXT_COUNTRY_HN" => "Honduras",
"TXT_COUNTRY_HR" => "Horvátország",
"TXT_COUNTRY_HT" => "Haiti",
"TXT_COUNTRY_HU" => "Magyarország",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "Indonézia",
"TXT_COUNTRY_IE" => "Írország",
"TXT_COUNTRY_IL" => "Izrael",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "India",
"TXT_COUNTRY_IO" => "Brit Indiai-óceáni Terület",
"TXT_COUNTRY_IQ" => "Irak",
"TXT_COUNTRY_IR" => "Irán",
"TXT_COUNTRY_IS" => "Izland",
"TXT_COUNTRY_IT" => "Olaszország",
"TXT_COUNTRY_IX" => "Inmarsat SNAC",
"TXT_COUNTRY_JE" => "Jersey",
"TXT_COUNTRY_JM" => "Jamaica",
"TXT_COUNTRY_JO" => "Jordánia",
"TXT_COUNTRY_JP" => "Japán",
"TXT_COUNTRY_KE" => "Kenya",
"TXT_COUNTRY_KG" => "Kirgizisztán",
"TXT_COUNTRY_KH" => "Kambodzsa",
"TXT_COUNTRY_KI" => "Kiribati",
"TXT_COUNTRY_KM" => "Comore-szigetek",
"TXT_COUNTRY_KN" => "Saint Kitts és Nevis",
"TXT_COUNTRY_KP" => "Észak-Korea",
"TXT_COUNTRY_KR" => "Dél-Korea",
"TXT_COUNTRY_KW" => "Kuvait",
"TXT_COUNTRY_KY" => "Kajmán-szigetek",
"TXT_COUNTRY_KZ" => "Kazahsztán",
"TXT_COUNTRY_LA" => "Laosz",
"TXT_COUNTRY_LB" => "Libanon",
"TXT_COUNTRY_LC" => "Saint Lucia",
"TXT_COUNTRY_LI" => "Liechtenstein",
"TXT_COUNTRY_LK" => "Srí Lanka",
"TXT_COUNTRY_LR" => "Libéria",
"TXT_COUNTRY_LS" => "Lesotho",
"TXT_COUNTRY_LT" => "Litvánia",
"TXT_COUNTRY_LU" => "Luxemburg",
"TXT_COUNTRY_LV" => "Lettország",
"TXT_COUNTRY_LY" => "Líbia",
"TXT_COUNTRY_MA" => "Marokkó",
"TXT_COUNTRY_MC" => "Monaco",
"TXT_COUNTRY_MD" => "Moldova",
"TXT_COUNTRY_ME" => "Montenegró",
"TXT_COUNTRY_MF" => "Saint Martin",
"TXT_COUNTRY_MG" => "Madagaszkár",
"TXT_COUNTRY_MH" => "Marshall-szigetek",
"TXT_COUNTRY_MK" => "Macedónia",
"TXT_COUNTRY_ML" => "Mali",
"TXT_COUNTRY_MM" => "Myanmar",
"TXT_COUNTRY_MN" => "Mongólia",
"TXT_COUNTRY_MO" => "Makaó",
"TXT_COUNTRY_MP" => "Északi-Mariana-szigetek",
"TXT_COUNTRY_MQ" => "Martinique",
"TXT_COUNTRY_MR" => "Mauritánia",
"TXT_COUNTRY_MS" => "Montserrat",
"TXT_COUNTRY_MT" => "Málta",
"TXT_COUNTRY_MU" => "Mauritius",
"TXT_COUNTRY_MV" => "Maldív-szigetek",
"TXT_COUNTRY_MW" => "Malawi",
"TXT_COUNTRY_MX" => "Mexikó",
"TXT_COUNTRY_MY" => "Malajzia",
"TXT_COUNTRY_MZ" => "Mozambik",
"TXT_COUNTRY_NA" => "Namíbia",
"TXT_COUNTRY_NC" => "Új-Kaledónia",
"TXT_COUNTRY_NE" => "Niger",
"TXT_COUNTRY_NF" => "Norfolk-sziget",
"TXT_COUNTRY_NG" => "Nigéria",
"TXT_COUNTRY_NI" => "Nicaragua",
"TXT_COUNTRY_NL" => "Hollandia",
"TXT_COUNTRY_NO" => "Norvégia",
"TXT_COUNTRY_NP" => "Nepál",
"TXT_COUNTRY_NR" => "Nauru",
"TXT_COUNTRY_NU" => "Niue",
"TXT_COUNTRY_NZ" => "Új-Zéland",
"TXT_COUNTRY_OM" => "Omán",
"TXT_COUNTRY_PA" => "Panama",
"TXT_COUNTRY_PE" => "Peru",
"TXT_COUNTRY_PF" => "Francia Polinézia",
"TXT_COUNTRY_PG" => "Pápua Új-Guinea",
"TXT_COUNTRY_PH" => "Fülöp-szigetek",
"TXT_COUNTRY_PK" => "Pakisztán",
"TXT_COUNTRY_PL" => "Lengyelország",
"TXT_COUNTRY_PM" => "Saint Pierre és Miquelon",
"TXT_COUNTRY_PN" => "Pitcairn",
"TXT_COUNTRY_PR" => "Puerto Rico",
"TXT_COUNTRY_PS" => "Palesztin Területek",
"TXT_COUNTRY_PT" => "Portugália",
...
"TXT_COUNTRY_RO" => "Románia",
"TXT_COUNTRY_RS" => "Szerbia",
"TXT_COUNTRY_RU" => "Oroszország",
"TXT_COUNTRY_RW" => "Ruanda",
"TXT_COUNTRY_SA" => "Szaúd-Arábia",
"TXT_COUNTRY_SB" => "Salamon-szigetek",
"TXT_COUNTRY_SC" => "Seychelle-szigetek",
"TXT_COUNTRY_SD" => "Szudán",
"TXT_COUNTRY_SE" => "Svédország",
"TXT_COUNTRY_SG" => "Szingapúr",
"TXT_COUNTRY_SH" => "Szent Ilona",
"TXT_COUNTRY_SI" => "Szlovénia",
"TXT_COUNTRY_SJ" => "Svalbard és Jan Mayen",
"TXT_COUNTRY_SK" => "Szlovákia",
"TXT_COUNTRY_SL" => "Sierra Leone",
"TXT_COUNTRY_SM" => "San Marino",
"TXT_COUNTRY_SN" => "Szenegál",
"TXT_COUNTRY_SO" => "Szomália",
"TXT_COUNTRY_SR" => "Suriname",
"TXT_COUNTRY_SS" => "South Sudan",
"TXT_COUNTRY_ST" => "Sao Tome és Principe",
"TXT_COUNTRY_SV" => "El Salvador",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Szíria",
"TXT_COUNTRY_SZ" => "Szváziföld",
"TXT_COUNTRY_TC" => "Turks- és Caicos-szigetek",
"TXT_COUNTRY_TD" => "Csád",
"TXT_COUNTRY_TF" => "Francia Déli Területek",
"TXT_COUNTRY_TG" => "Togo",
"TXT_COUNTRY_TH" => "Thaiföld",
"TXT_COUNTRY_TJ" => "Tádzsikisztán",
"TXT_COUNTRY_TK" => "Tokelau",
"TXT_COUNTRY_TL" => "Timor-Leste",
"TXT_COUNTRY_TM" => "Türkmenisztán",
"TXT_COUNTRY_TN" => "Tunézia",
"TXT_COUNTRY_TO" => "Tonga",
"TXT_COUNTRY_TR" => "Törökország",
"TXT_COUNTRY_TT" => "Trinidad és Tobago",
"TXT_COUNTRY_TV" => "Tuvalu",
"TXT_COUNTRY_TW" => "Tajvan",
"TXT_COUNTRY_TZ" => "Tanzánia",
"TXT_COUNTRY_UA" => "Ukrajna",
"TXT_COUNTRY_UG" => "Uganda",
"TXT_COUNTRY_UK" => "United Kingdom",
"TXT_COUNTRY_UM" => "United States Minor Outlying Islands",
"TXT_COUNTRY_US" => "Egyesült Államok",
"TXT_COUNTRY_US-AL" => "Alaska",
"TXT_COUNTRY_US-HI" => "Hawaii",
"TXT_COUNTRY_UY" => "Uruguay",
"TXT_COUNTRY_UZ" => "Üzbegisztán",
"TXT_COUNTRY_VA" => "Vatikán",
"TXT_COUNTRY_VC" => "Saint Vincent és Grenadines",
"TXT_COUNTRY_VE" => "Venezuela",
"TXT_COUNTRY_VG" => "Brit Virgin-szigetek",
"TXT_COUNTRY_VI" => "U.S. Virgin Islands",
"TXT_COUNTRY_VN" => "Vietnam",
"TXT_COUNTRY_VU" => "Vanuatu",
"TXT_COUNTRY_WF" => "Wallis és Futuna",
"TXT_COUNTRY_WS" => "Szamoa",
"TXT_COUNTRY_YE" => "Jemen",
"TXT_COUNTRY_YT" => "Mayotte",
"TXT_COUNTRY_ZA" => "Dél-Afrika",
"TXT_COUNTRY_ZM" => "Zambia",
"TXT_COUNTRY_ZW" => "Zimbabwe",
"TXT_COVER" => "Faxfed?lap",
...
"TXT_COVERPAGE_TEXT" => "A fed?lap szövege",
"TXT_COVERS_RESTORED" => "Default PamFax covers have been restored",
"TXT_COVERTEXT_1" => "Adja meg a kijelölt fed?lap szövegét!",
...
"TXT_COVER_TEMPLATE" => "Fed?lapsablon",
"TXT_CREATED" => "Created",
...
"TXT_EMAIL_RECIPIENT" => "Az Ön e-mail címe",
"TXT_EMAIL_SUBJECT" => "PamFax állapotadatok",
...
"TXT_FAILED" => "Sikertelen.",
"TXT_FAILED_RECIPIENTS" => "({failed_recipients} recipients invalid)",
"TXT_FAILUREMESSAGE_EMAIL" => "Kedves {username}!{crlf}{crlf}A(z) {fax_recipient} számára küldött faxot nem sikerült továbbítani. A hiba oka: {fail_reason}.{crlf}{crlf}Üdvözlettel:{crlf}a PamFax szolgáltatás",
"TXT_FAILUREMESSAGE_SMS" => "Kedves {username}!{crlf}A(z) {fax_recipient} számára küldött faxot nem sikerült továbbítani. A hiba oka: {fail_reason}.",
...
"TXT_FAXPRICE" => "A fax ára: <b>{price}</b>.",
...
"TXT_FAX_DETAILS" => "A fax részletei",
...
"TXT_FILTER" => "Search...",
"TXT_FILTER_ALL" => "Támogatott fájltípusok",
...
"TXT_FINISHED_1" => "<b>A küldés folyamatban van.</b><br><br>A folyamatot a {link_portal} ellen?rizheti.<br><br>Szeretne újabb faxot küldeni?<br>Használja a lenit gombokat!<br><br>Köszönjük, hogy a PamFaxot használja!",
...
"TXT_GBP" => "angol font",
"TXT_GENERAL" => "Általános",
"TXT_GENERALNOTIFICATIONSETTINGS" => "Manage Recipients",
"TXT_GENERAL_SETTINGS" => "Általános beállítások",
...
"TXT_MAP_TITLE" => "A címzettek helye a Google Map térképen",
...
"TXT_NOTIFICATION_SETTINGS" => "Értesítési beállítások",
...
"TXT_NOTIFICATION_SETTINGS_UPDATED_OK" => "Az értesítési beállításokat elmentettük.",
...
"TXT_NO_EMAIL_RECIPIENT" => "Kérjük, adjon meg egy valód e-mail címet!",
...
"TXT_NO_SMS_RECIPIENT" => "Kérjük, adjon meg egy valós SMS-számot!",
"TXT_NO_UPDATE_AVAILABLE" => "No update available",
"TXT_NUMBER_1" => "Egy címzett",
"TXT_NUMBER_2" => "Faxszám:",
"TXT_NUMBER_3" => "Ország választása",
"TXT_NUMBER_4" => "A címzett neve:",
"TXT_NUMBER_5" => "Több címzett",
"TXT_NUMBER_6" => "(Soronként egy faxszámot adjon meg!)",
"TXT_NUMBER_8" => "Kinek szeretné küldeni a faxot?",
...
"TXT_PAY_SUMMARY" => "A fax ára: <b>{price}</b>.",
...
"TXT_PRINT" => "Print",
"TXT_PRIVACY" => "Biztonsági beállítások",
...
"TXT_PROFILE_SAVED" => "A beállításokat elmentettük.",
...
"TXT_RATE" => "Ár",
"TXT_RATES" => "Árak",
"TXT_RATES_PER_PAGE" => "Az árak oldalanként értend?ek.",
...
"TXT_RECIPIENT_NAME" => "A címzett neve",
...
"TXT_RESTART_HINT" => "A frissítés nem fejezhet? be, mert a fájlokat nem lehet lecserélni. A telepítés befejezéséhez, kérjük, indítsa újra a számítógépet!",
"TXT_RESTOFWORLD" => "A világ többi része",
...
"TXT_SAVE_AS_DEFAULT" => "Mentés alapértelmezettként",
...
"TXT_SECONDS" => "Seconds",
"TXT_SEK" => "svéd korona",
"TXT_SELECTCOVER_1" => "Válasszon fed?lapot! A következ? lépésben egy üzenetet is írhat a fed?lapra.<br><br>",
"TXT_SELECTCOVER_2" => "<br>(El?nézet: duplakattintás a képre)",
...
"TXT_SELECTFILE_4" => "Fájlválasztás...",
...
"TXT_SENDER_COMPANY" => "Cégnév",
"TXT_SENDER_DETAILS" => "A feladó adatai",
"TXT_SENDER_FAX" => "Faxszám",
...
"TXT_SEND_EMAIL_STATUS" => "A fax állapotadatainak küldése e-mailben",
"TXT_SEND_FAX" => "Send a fax",
"TXT_SEND_FAX_NOW" => "Send fax now",
"TXT_SEND_MAILS_TO" => "Send emails to",
"TXT_SEND_SKYPECHAT_STATUS" => "A fax állapotadatainak küldése Skype-üzenetváltásban",
"TXT_SEND_SMS_STATUS" => "Értesítés a kézbesítés sikerességér?l SMS-ben ({cost}/SMS)",
...
"TXT_STATE_ACCEPTED" => "Elfogadva",
"TXT_STATE_BUSY" => "Foglalt",
"TXT_STATE_CANCELLED" => "Megszakítva",
"TXT_STATE_CANCEL_PENDING" => "Cancel pending",
"TXT_STATE_CLEANED_UP" => "Cleaned Up",
"TXT_STATE_CONVERTING" => "Átalakítás",
...
"TXT_STATE_FAILURE" => "Hiba",
"TXT_STATE_HOLD" => "Tartás",
"TXT_STATE_INVALIDATED" => "Nincs engedélyezve",
"TXT_STATE_IN_QUEUE" => "In queue",
"TXT_STATE_ONRETRY" => "Új próbálkozás folyamatban",
"TXT_STATE_READY" => "Kész",
"TXT_STATE_SENDING" => "In progress",
"TXT_STATE_SUBMITTED" => "Elküldve",
"TXT_STATE_SUCCESS" => "Sikeres",
"TXT_STATE_UNKNOWN" => "Folyamatban",
...
"TXT_STATUS" => "Állapot",
"TXT_STATUS_DETAILS" => "Állapotadatok",
...
"TXT_SUCCESSFUL_FAXES" => "Sikeres faxok",
"TXT_SUCCESSMESSAGE_EMAIL" => "Kedves {username}!{crlf}{crlf}A(z) {fax_recipient} számára küldött faxot sikeresen továbbítottuk.{crlf}{crlf}Üdvözlettel:{crlf}a PamFax szolgáltatás",
"TXT_SUCCESSMESSAGE_SMS" => "Kedves {username}!{crlf}A(z) {fax_recipient} számára küldött faxot sikeresen továbbítottuk.",
"TXT_SUGGESTED_FOR_YOU" => "Recommended Download",
"TXT_SUPPORT" => "Support",
"TXT_SUPPORT_TICKET" => "Support-Ticket",
"TXT_TAB_DASHBOARD" => "Portal",
"TXT_TAB_FAXRATES" => "Árak",
...
"TXT_TASK" => "Task",
"TXT_TERMS" => "Felhasználási feltételek",
...
"TXT_UPDATE_DATA" => "Frissítési adatok",
...
"TXT_UPDATE_HINT" => "Minden fájl le van töltve. Szeretné most telepíteni a frissítéseket?",
...
"WINDOW_TITLE" => "PamFax - A világ bármely faxszámára küldhet faxot",
