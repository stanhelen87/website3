...
"TXT_COUNTRY_AE" => "Spojené arabské emiráty",
"TXT_COUNTRY_AF" => "Afghánistán",
"TXT_COUNTRY_AG" => "Antigua a Barbuda",
"TXT_COUNTRY_AI" => "Anguilla",
"TXT_COUNTRY_AL" => "Albánie",
"TXT_COUNTRY_AM" => "Arménie",
"TXT_COUNTRY_AN" => "Nizozemské Antily",
"TXT_COUNTRY_AO" => "Angola",
"TXT_COUNTRY_AQ" => "Antarktida",
"TXT_COUNTRY_AR" => "Argentina",
"TXT_COUNTRY_AS" => "Americká Samoa",
"TXT_COUNTRY_AT" => "Rakousko",
"TXT_COUNTRY_AU" => "Austrálie",
"TXT_COUNTRY_AW" => "Aruba",
"TXT_COUNTRY_AX" => "Aland Islands",
"TXT_COUNTRY_AZ" => "Ázerbájdžán",
"TXT_COUNTRY_BA" => "Bosna a Hercegovina",
"TXT_COUNTRY_BB" => "Barbados",
"TXT_COUNTRY_BD" => "Bangladéš",
"TXT_COUNTRY_BE" => "Belgie",
"TXT_COUNTRY_BF" => "Burkina Faso",
"TXT_COUNTRY_BG" => "Bulharsko",
"TXT_COUNTRY_BH" => "Bahrajn",
"TXT_COUNTRY_BI" => "Burundi",
"TXT_COUNTRY_BJ" => "Benin",
"TXT_COUNTRY_BM" => "Bermudy",
"TXT_COUNTRY_BN" => "Brunej",
"TXT_COUNTRY_BO" => "Bolívie",
"TXT_COUNTRY_BQ" => "Bonaire, Saint Eustatius and Saba",
"TXT_COUNTRY_BR" => "Brazílie",
"TXT_COUNTRY_BS" => "Bahamy",
"TXT_COUNTRY_BT" => "Bhútán",
"TXT_COUNTRY_BV" => "Bouvetův ostrov",
"TXT_COUNTRY_BW" => "Botswana",
"TXT_COUNTRY_BY" => "Bělorusko",
"TXT_COUNTRY_BZ" => "Belize",
"TXT_COUNTRY_CA" => "Kanada",
"TXT_COUNTRY_CC" => "Kokosové (Keelingovy) ostrovy",
"TXT_COUNTRY_CD" => "Kongo, Demokratická republika",
"TXT_COUNTRY_CF" => "Středoafrická republika",
"TXT_COUNTRY_CG" => "Kongo",
"TXT_COUNTRY_CH" => "Švýcarsko",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "Pobřeží slonoviny",
"TXT_COUNTRY_CK" => "Cookovy ostrovy",
"TXT_COUNTRY_CL" => "Chile",
"TXT_COUNTRY_CM" => "Kamerun",
"TXT_COUNTRY_CN" => "Čína",
"TXT_COUNTRY_CO" => "Kolumbie",
"TXT_COUNTRY_CODE_NUMBER" => "Country, code and number",
"TXT_COUNTRY_CR" => "Kostarika",
"TXT_COUNTRY_CS" => "Serbia and Montenegro",
"TXT_COUNTRY_CU" => "Kuba",
"TXT_COUNTRY_CV" => "Kapverdy",
"TXT_COUNTRY_CW" => "Curaçao",
"TXT_COUNTRY_CX" => "Vánoční ostrov",
"TXT_COUNTRY_CY" => "Kypr",
"TXT_COUNTRY_CZ" => "Česká republika",
"TXT_COUNTRY_DE" => "Německo",
"TXT_COUNTRY_DJ" => "Džibuti",
"TXT_COUNTRY_DK" => "Dánsko",
"TXT_COUNTRY_DM" => "Dominika",
"TXT_COUNTRY_DO" => "Dominikánská republika",
"TXT_COUNTRY_DZ" => "Alžírsko",
"TXT_COUNTRY_EC" => "Ekvádor",
"TXT_COUNTRY_EE" => "Estonsko",
"TXT_COUNTRY_EG" => "Egypt",
"TXT_COUNTRY_EH" => "Západní Sahara",
"TXT_COUNTRY_ER" => "Eritrea",
"TXT_COUNTRY_ES" => "Španělsko",
"TXT_COUNTRY_ET" => "Etiopie",
"TXT_COUNTRY_FI" => "Finsko",
"TXT_COUNTRY_FJ" => "Fidži",
"TXT_COUNTRY_FK" => "Falklandské ostrovy (Malvíny)",
"TXT_COUNTRY_FM" => "Mikronésie, Federativní státy",
"TXT_COUNTRY_FO" => "Faerské ostrovy",
"TXT_COUNTRY_FR" => "Francie",
"TXT_COUNTRY_GA" => "Gabun",
"TXT_COUNTRY_GB" => "Velká Británie",
"TXT_COUNTRY_GD" => "Grenada",
"TXT_COUNTRY_GE" => "Gruzie",
"TXT_COUNTRY_GF" => "Francouzská Guayana",
"TXT_COUNTRY_GG" => "Guernsey",
"TXT_COUNTRY_GH" => "Ghana",
"TXT_COUNTRY_GI" => "Gibraltar",
"TXT_COUNTRY_GL" => "Grónsko",
"TXT_COUNTRY_GM" => "Gambie",
"TXT_COUNTRY_GN" => "Guinea",
"TXT_COUNTRY_GP" => "Guadaloupe",
"TXT_COUNTRY_GQ" => "Rovníková Guinea",
"TXT_COUNTRY_GR" => "Řecko",
"TXT_COUNTRY_GS" => "Jižní Georgia a Jižní Sandwichovy ostrovy",
"TXT_COUNTRY_GT" => "Guatemala",
"TXT_COUNTRY_GU" => "Guam",
"TXT_COUNTRY_GW" => "Guinea-Bissau",
"TXT_COUNTRY_GY" => "Guayana",
"TXT_COUNTRY_HK" => "Hongkong",
"TXT_COUNTRY_HM" => "Heardův ostrov a McDonaldovy ostrovy",
"TXT_COUNTRY_HN" => "Honduras",
"TXT_COUNTRY_HR" => "Chorvatsko",
"TXT_COUNTRY_HT" => "Haiti",
"TXT_COUNTRY_HU" => "Maďarsko",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "Indonésie",
"TXT_COUNTRY_IE" => "Irsko",
"TXT_COUNTRY_IL" => "Izrael",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "Indie",
"TXT_COUNTRY_IO" => "Britské území v Indickém oceánu",
"TXT_COUNTRY_IQ" => "Irák",
"TXT_COUNTRY_IR" => "Írán",
"TXT_COUNTRY_IS" => "Island",
"TXT_COUNTRY_IT" => "Itálie",
"TXT_COUNTRY_IX" => "Inmarsat SNAC",
"TXT_COUNTRY_JE" => "Jersey",
"TXT_COUNTRY_JM" => "Jamajka",
"TXT_COUNTRY_JO" => "Jordánsko",
"TXT_COUNTRY_JP" => "Japonsko",
"TXT_COUNTRY_KE" => "Keňa",
"TXT_COUNTRY_KG" => "Kyrgyzstán",
"TXT_COUNTRY_KH" => "Kambodža",
"TXT_COUNTRY_KI" => "Kiribati",
"TXT_COUNTRY_KM" => "Komory",
"TXT_COUNTRY_KN" => "Svatý Kryštof a Nevis",
"TXT_COUNTRY_KP" => "Korea, Severní",
"TXT_COUNTRY_KR" => "Korea, Jižní",
"TXT_COUNTRY_KW" => "Kuvajt",
"TXT_COUNTRY_KY" => "Kajmanské ostrovy",
"TXT_COUNTRY_KZ" => "Kazachstán",
"TXT_COUNTRY_LA" => "Laos",
"TXT_COUNTRY_LB" => "Libanon",
"TXT_COUNTRY_LC" => "Svatá Lucie",
"TXT_COUNTRY_LI" => "Lichtenštejnsko",
"TXT_COUNTRY_LK" => "Srí Lanka",
"TXT_COUNTRY_LR" => "Libérie",
"TXT_COUNTRY_LS" => "Lesotho",
"TXT_COUNTRY_LT" => "Litva",
"TXT_COUNTRY_LU" => "Lucembursko",
"TXT_COUNTRY_LV" => "Lotyšsko",
"TXT_COUNTRY_LY" => "Libye",
"TXT_COUNTRY_MA" => "Maroko",
"TXT_COUNTRY_MC" => "Monako",
"TXT_COUNTRY_MD" => "Moldavsko",
"TXT_COUNTRY_ME" => "Černá Hora",
"TXT_COUNTRY_MF" => "Saint Martin",
"TXT_COUNTRY_MG" => "Madagaskar",
"TXT_COUNTRY_MH" => "Marshallovy ostrovy",
"TXT_COUNTRY_MK" => "Makedonie",
"TXT_COUNTRY_ML" => "Mali",
"TXT_COUNTRY_MM" => "Myanmar",
"TXT_COUNTRY_MN" => "Mongolsko",
"TXT_COUNTRY_MO" => "Macao",
"TXT_COUNTRY_MP" => "Severní Mariany",
"TXT_COUNTRY_MQ" => "Martinik",
"TXT_COUNTRY_MR" => "Mauretánie",
"TXT_COUNTRY_MS" => "Montserrat",
"TXT_COUNTRY_MT" => "Malta",
"TXT_COUNTRY_MU" => "Mauricius",
"TXT_COUNTRY_MV" => "Maledivy",
"TXT_COUNTRY_MW" => "Malawi",
"TXT_COUNTRY_MX" => "Mexiko",
"TXT_COUNTRY_MY" => "Malajsie",
"TXT_COUNTRY_MZ" => "Mosambik",
"TXT_COUNTRY_NA" => "Namibie",
"TXT_COUNTRY_NC" => "Nová Kaledonie",
"TXT_COUNTRY_NE" => "Niger",
"TXT_COUNTRY_NF" => "Norfolk",
"TXT_COUNTRY_NG" => "Nigérie",
"TXT_COUNTRY_NI" => "Nikaragua",
"TXT_COUNTRY_NL" => "Nizozemsko",
"TXT_COUNTRY_NO" => "Norsko",
"TXT_COUNTRY_NP" => "Nepál",
"TXT_COUNTRY_NR" => "Nauru",
"TXT_COUNTRY_NU" => "Niue",
"TXT_COUNTRY_NZ" => "Nový Zéland",
"TXT_COUNTRY_OM" => "Omán",
"TXT_COUNTRY_PA" => "Panama",
"TXT_COUNTRY_PE" => "Peru",
"TXT_COUNTRY_PF" => "Francouzská Polynésie",
"TXT_COUNTRY_PG" => "Papua Nová Guinea",
"TXT_COUNTRY_PH" => "Filipíny",
"TXT_COUNTRY_PK" => "Pákistán",
"TXT_COUNTRY_PL" => "Polsko",
"TXT_COUNTRY_PM" => "Svatý Pierre a Miquelon",
"TXT_COUNTRY_PN" => "Pitcairn",
"TXT_COUNTRY_PR" => "Portoriko",
"TXT_COUNTRY_PS" => "Území Palestiny",
"TXT_COUNTRY_PT" => "Portugalsko",
...
"TXT_COUNTRY_RO" => "Rumunsko",
"TXT_COUNTRY_RS" => "Srbsko",
"TXT_COUNTRY_RU" => "Rusko",
"TXT_COUNTRY_RW" => "Rwanda",
"TXT_COUNTRY_SA" => "Saúdská Arábie",
"TXT_COUNTRY_SB" => "Šalamounovy ostrovy",
"TXT_COUNTRY_SC" => "Seychely",
"TXT_COUNTRY_SD" => "Súdán",
"TXT_COUNTRY_SE" => "Švédsko",
"TXT_COUNTRY_SG" => "Singapur",
"TXT_COUNTRY_SH" => "Svatá Helena",
"TXT_COUNTRY_SI" => "Slovinsko",
"TXT_COUNTRY_SJ" => "Svalbard a Jan Mayen",
"TXT_COUNTRY_SK" => "Slovensko",
"TXT_COUNTRY_SL" => "Sierra Leone",
"TXT_COUNTRY_SM" => "San Marino",
"TXT_COUNTRY_SN" => "Senegal",
"TXT_COUNTRY_SO" => "Somálsko",
"TXT_COUNTRY_SR" => "Surinam",
"TXT_COUNTRY_SS" => "South Sudan",
"TXT_COUNTRY_ST" => "Svatý Tomáš a Princův ostrov",
"TXT_COUNTRY_SV" => "Salvador",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Sýrie",
"TXT_COUNTRY_SZ" => "Svazijsko",
"TXT_COUNTRY_TC" => "Ostrovy Turks a Caicos",
"TXT_COUNTRY_TD" => "Čad",
"TXT_COUNTRY_TF" => "Francouzská jižní území",
"TXT_COUNTRY_TG" => "Togo",
"TXT_COUNTRY_TH" => "Thajsko",
"TXT_COUNTRY_TJ" => "Tádžikistán",
"TXT_COUNTRY_TK" => "Tokelau",
"TXT_COUNTRY_TL" => "Timor-Leste",
"TXT_COUNTRY_TM" => "Turkmenistán",
"TXT_COUNTRY_TN" => "Tunisko",
"TXT_COUNTRY_TO" => "Tonga",
"TXT_COUNTRY_TR" => "Turecko",
"TXT_COUNTRY_TT" => "Trinidad a Tobago",
"TXT_COUNTRY_TV" => "Tuvalu",
"TXT_COUNTRY_TW" => "Tchaj-wan",
"TXT_COUNTRY_TZ" => "Tanzanie",
"TXT_COUNTRY_UA" => "Ukrajina",
"TXT_COUNTRY_UG" => "Uganda",
"TXT_COUNTRY_UK" => "United Kingdom",
"TXT_COUNTRY_UM" => "United States Minor Outlying Islands",
"TXT_COUNTRY_US" => "Spojené státy americké",
"TXT_COUNTRY_US-AL" => "Alaska",
"TXT_COUNTRY_US-HI" => "Hawaii",
"TXT_COUNTRY_UY" => "Uruguay",
"TXT_COUNTRY_UZ" => "Uzbekistán",
"TXT_COUNTRY_VA" => "Vatikánský městský stát (Svatý stolec)",
"TXT_COUNTRY_VC" => "Svatý Vincent a Grenadiny",
"TXT_COUNTRY_VE" => "Venezuela",
"TXT_COUNTRY_VG" => "Britské Panenské ostrovy",
"TXT_COUNTRY_VI" => "U.S. Virgin Islands",
"TXT_COUNTRY_VN" => "Vietnam",
"TXT_COUNTRY_VU" => "Vanuatu",
"TXT_COUNTRY_WF" => "Wallis a Futuna",
"TXT_COUNTRY_WS" => "Samoa",
"TXT_COUNTRY_YE" => "Jemen",
"TXT_COUNTRY_YT" => "Mayotte",
"TXT_COUNTRY_ZA" => "Jižní Afrika",
