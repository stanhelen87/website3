...
"TXT_COUNTRY_AE" => "Arabiemiirikuntien liitto",
...
"TXT_COUNTRY_AN" => "Alankomaiden Antillit",
"TXT_COUNTRY_AO" => "Angola",
"TXT_COUNTRY_AQ" => "Antarktika",
"TXT_COUNTRY_AR" => "Argentiina",
"TXT_COUNTRY_AS" => "Amerikan Samoa",
"TXT_COUNTRY_AT" => "Itävalta",
"TXT_COUNTRY_AU" => "Australia",
"TXT_COUNTRY_AW" => "Aruba",
"TXT_COUNTRY_AX" => "Aland Islands",
"TXT_COUNTRY_AZ" => "Azerbaijan",
"TXT_COUNTRY_BA" => "Bosnia ja Herzegovina",
...
"TXT_COUNTRY_BR" => "Brasilia",
"TXT_COUNTRY_BS" => "Bahama",
"TXT_COUNTRY_BT" => "Bhutan",
"TXT_COUNTRY_BV" => "Bouvet'n saari",
"TXT_COUNTRY_BW" => "Botswana",
"TXT_COUNTRY_BY" => "Valko-Venäjä",
"TXT_COUNTRY_BZ" => "Belize",
"TXT_COUNTRY_CA" => "Kanada",
"TXT_COUNTRY_CC" => "Kookossaaret (Keelingsaaret)",
"TXT_COUNTRY_CD" => "Kongon demokraattinen tasavalta",
"TXT_COUNTRY_CF" => "Keski-Afrikan tasavalta",
"TXT_COUNTRY_CG" => "Kongo",
"TXT_COUNTRY_CH" => "Sveitsi",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "Norsunluurannikko",
"TXT_COUNTRY_CK" => "Cooksaaret",
"TXT_COUNTRY_CL" => "Chile",
"TXT_COUNTRY_CM" => "Kamerun",
"TXT_COUNTRY_CN" => "Kiina",
...
"TXT_COUNTRY_CX" => "Joulusaari",
"TXT_COUNTRY_CY" => "Kypros",
"TXT_COUNTRY_CZ" => "Tšekin tasavalta",
"TXT_COUNTRY_DE" => "Saksa",
"TXT_COUNTRY_DJ" => "Djibouti",
"TXT_COUNTRY_DK" => "Tanska",
"TXT_COUNTRY_DM" => "Dominica",
"TXT_COUNTRY_DO" => "Dominikaaninen tasavalta",
"TXT_COUNTRY_DZ" => "Algeria",
"TXT_COUNTRY_EC" => "Ecuador",
"TXT_COUNTRY_EE" => "Eesti",
"TXT_COUNTRY_EG" => "Egypti",
"TXT_COUNTRY_EH" => "Länsi-Sahara",
"TXT_COUNTRY_ER" => "Eritrea",
"TXT_COUNTRY_ES" => "Espanja",
"TXT_COUNTRY_ET" => "Etiopia",
"TXT_COUNTRY_FI" => "Suomi",
"TXT_COUNTRY_FJ" => "Fidzi",
"TXT_COUNTRY_FK" => "Falklandin saaret (Malvinas)",
"TXT_COUNTRY_FM" => "Mikronesia",
"TXT_COUNTRY_FO" => "Färsaaret",
"TXT_COUNTRY_FR" => "Ranska",
"TXT_COUNTRY_GA" => "Gabon",
"TXT_COUNTRY_GB" => "Yhdistynyt kuningaskunta",
"TXT_COUNTRY_GD" => "Grenada",
"TXT_COUNTRY_GE" => "Georgia",
"TXT_COUNTRY_GF" => "Ranskan Guyana",
"TXT_COUNTRY_GG" => "Guernsey",
"TXT_COUNTRY_GH" => "Ghana",
"TXT_COUNTRY_GI" => "Gibraltar",
"TXT_COUNTRY_GL" => "Grönlanti",
"TXT_COUNTRY_GM" => "Gambia",
"TXT_COUNTRY_GN" => "Guinea",
"TXT_COUNTRY_GP" => "Guadeloupe",
"TXT_COUNTRY_GQ" => "Päiväntasaajan Guinea",
"TXT_COUNTRY_GR" => "Kreikka",
"TXT_COUNTRY_GS" => "Etelä-Georgia ja Etelä-Sandwichsaaret",
"TXT_COUNTRY_GT" => "Guatemala",
"TXT_COUNTRY_GU" => "Guam",
"TXT_COUNTRY_GW" => "Guinea-Bissau",
"TXT_COUNTRY_GY" => "Guyana",
"TXT_COUNTRY_HK" => "Hongkong",
"TXT_COUNTRY_HM" => "Heardsaari ja McDonaldsaaret",
"TXT_COUNTRY_HN" => "Honduras",
"TXT_COUNTRY_HR" => "Kroatia",
"TXT_COUNTRY_HT" => "Haiti",
"TXT_COUNTRY_HU" => "Unkari",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "Indonesia",
"TXT_COUNTRY_IE" => "Irlanti",
"TXT_COUNTRY_IL" => "Israel",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "Intia",
"TXT_COUNTRY_IO" => "Brittiläinen Intian valtameren alue",
"TXT_COUNTRY_IQ" => "Irak",
"TXT_COUNTRY_IR" => "Iran",
"TXT_COUNTRY_IS" => "Islanti",
"TXT_COUNTRY_IT" => "Italia",
"TXT_COUNTRY_IX" => "Inmarsat SNAC",
"TXT_COUNTRY_JE" => "Jersey",
"TXT_COUNTRY_JM" => "Jamaika",
"TXT_COUNTRY_JO" => "Jordania",
"TXT_COUNTRY_JP" => "Japani",
"TXT_COUNTRY_KE" => "Kenia",
"TXT_COUNTRY_KG" => "Kirgistan",
"TXT_COUNTRY_KH" => "Kambodša",
"TXT_COUNTRY_KI" => "Kiribati",
"TXT_COUNTRY_KM" => "Komorit",
"TXT_COUNTRY_KN" => "Saint Kitts ja Nevis",
"TXT_COUNTRY_KP" => "Korea, Pohjois-",
"TXT_COUNTRY_KR" => "Korea, Etelä-",
"TXT_COUNTRY_KW" => "Kuwait",
"TXT_COUNTRY_KY" => "Caymansaaret",
...
"TXT_COUNTRY_RU" => "Venäjä",
"TXT_COUNTRY_RW" => "Ruanda",
"TXT_COUNTRY_SA" => "Saudi-Arabia",
"TXT_COUNTRY_SB" => "Salomonsaaret",
"TXT_COUNTRY_SC" => "Seychellit",
"TXT_COUNTRY_SD" => "Sudan",
"TXT_COUNTRY_SE" => "Ruotsi",
...
"TXT_COUNTRY_ST" => "Sao Tome ja Principe",
"TXT_COUNTRY_SV" => "El Salvador",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Syyria",
"TXT_COUNTRY_SZ" => "Swasimaa",
"TXT_COUNTRY_TC" => "Turks- ja Caicossaaret",
"TXT_COUNTRY_TD" => "Tšad",
"TXT_COUNTRY_TF" => "Ranskan Eteläiset alueet",
"TXT_COUNTRY_TG" => "Togo",
"TXT_COUNTRY_TH" => "Thaimaa",
"TXT_COUNTRY_TJ" => "Tadzikistan",
"TXT_COUNTRY_TK" => "Tokelau",
"TXT_COUNTRY_TL" => "Timor-Leste",
"TXT_COUNTRY_TM" => "Turkmenistan",
"TXT_COUNTRY_TN" => "Tunisia",
"TXT_COUNTRY_TO" => "Tonga",
"TXT_COUNTRY_TR" => "Turkki",
...
"TXT_COUNTRY_US" => "Yhdysvallat",
"TXT_COUNTRY_US-AL" => "Alaska",
"TXT_COUNTRY_US-HI" => "Hawaii",
"TXT_COUNTRY_UY" => "Uruguay",
"TXT_COUNTRY_UZ" => "Uzbekistan",
"TXT_COUNTRY_VA" => "Vatikaanivaltio (Kirkkovaltio)",
"TXT_COUNTRY_VC" => "Saint Vincent ja Grenadiinit",
"TXT_COUNTRY_VE" => "Venezuela",
"TXT_COUNTRY_VG" => "Brittiläiset Neitsytsaaret",
...
"TXT_RATE" => "Rate",
"TXT_RATES" => "Rates",
"TXT_RATES_PER_PAGE" => "Kaikki hinnat ovat per sivu.",
