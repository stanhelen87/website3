...
"BTN_PAY_N_SEND" => "Maksāt un sūtīt",
"BTN_PLAN" => "Plan",
"BTN_PORTAL" => "Portal",
...
"BTN_SEND" => "Sūtīt faksu",
"BTN_SENDASFAX" => "Send as fax",
"BTN_SEND_ANOTHER" => "Sūtīt citu faksu",
...
"BTN_SHARE" => "Share",
"BTN_SHOW_GOOGLE_MAP" => "Rādīt saņēmēju atrašanās vietu iekš {img_google} Maps",
...
"BTN_START_UPDATE" => "Jā, sākt atjaunināšanu",
...
"BTN_UP" => "Up",
"BTN_UPDATE_LATER" => "Nē, atjaunoties vēlāk",
...
"ERR_BAD_FILE" => "Faila formāts, kuru Tu vēlies nosūtīt, netiek atbalstīts. Lūdzu, saglabā to atbalstītā formātā un mēģini vēlreiz.<br>Apmeklē {link_faq_1} priekš pārejām detaļām.",
...
"ERR_FAX_10024" => "Nav atbildes",
"ERR_FAX_10025" => "Nav atrasts faksa aparāts",
"ERR_FAX_23073" => "Balss atbilde",
"ERR_FAX_23441" => "Neatrodams numurs",
"ERR_FAX_23443" => "Galamērķis nesasniedzams",
"ERR_FAX_23468" => "Nederīgs numura formāts",
...
"LNGFAILUREMESSAGE_CHAT" => "Tavu PamFax sūtījumu {fax_recipient} neizdevās nosūtīt",
...
"LNGPROGRESSMESSAGE_CHAT" => "Sveiks {username},{crlf}tavs PamFax sūtījums {fax_recipient} tagad tiek apstrādāts",
...
"LNGSUCCESSMESSAGE_CHAT" => "Tavs PamFax sūtījums {fax_recipient} veiksmīgi nosūtīts",
...
"MSG_COVERTEXT_REQUIRED" => "Ja tu sūti tikai vāka lapu tev jāieraksta ziņa",
...
"MSG_CREDITS_RESTORED" => "Kredīts atjaunots",
...
"MSG_DUPS_REMOVED" => "Šis saraksts satur atkārtotus numurus.<br>Tie tiks automātiski izdzēsti, lai samazinātu sūtījuma izmaksu.",
...
"MSG_FAXNUMBER_MISSING" => "Ieraksti faksa numuru",
...
"MSG_GENERATING_FAX" => "Your fax is being generated.<br>\nPlease stand by...",
...
"MSG_MAILRECIPIENT_MISSING" => "Ieraksti e-pasta saņemēju",
...
"MSG_MULFAXNUMBERS_MISSING" => "Ieraksti vismaz vienu faksa numuru",
"MSG_NEW_INBOX_FAXES" => "You have {faxes_cnt} new faxes",
"MSG_NOCREDITS_RESTORED" => "Atvaino, bet netika atjaunots kredīts.",
"MSG_NO_DEVICE_CONTACTS" => "No contacts found on device",
"MSG_NO_RECIPIENT" => "Nav atrasti derīgi saņemēji",
...
"MSG_PREPARE_PREVIEW" => "Sagatavoju priekš skatu...",
...
"MSG_SMSRECIPIENT_MISSING" => "Ieraksti īsziņas saņēmēju",
"MSG_SOME_INVALID_NUMBERS" => "Daži no šiem faksa numuriem nav derīgi!",
"MSG_SOME_UNPAID_FAXES_SENT" => "Some unpaid faxes were sent, the others remain unpaid due to insufficient credit.",
"MSG_STORING_CREDIT" => "Saglabā kredīta informāciju",
...
"MSG_UPLOAD" => "Augšupielādē informāciju...",
...
"MSG_WAIT_DEFAULT" => "Lūdzu uzgaidi...",
...
"TITLE_COVER_TEXT" => "Ieraksti ziņu",
...
"TITLE_NOTIFY" => "Paziņojumu uzstādījumi",
"TITLE_NUMBER" => "Ieraksti saņēmēju(s)",
"TITLE_PAY" => "Samaksāt par  faksa sūtījumu",
...
"TITLE_SELECT_COVER" => "Izvēlies vāka lapu",
...
"TXT_CLICKTOCLOSE" => "Nospied, lai aizvērtu",
...
"TXT_CNY" => "Ķīniešu juaņi/renminbi",
...
"TXT_COUNTRY_AE" => "Apvienotie Arābu Emirāti",
"TXT_COUNTRY_AF" => "Afganistāna",
"TXT_COUNTRY_AG" => "Antigva un Barbuda",
"TXT_COUNTRY_AI" => "Angilja",
"TXT_COUNTRY_AL" => "Albānija",
"TXT_COUNTRY_AM" => "Armēnija",
"TXT_COUNTRY_AN" => "Nīderlandes Antiļas",
"TXT_COUNTRY_AO" => "Angola",
"TXT_COUNTRY_AQ" => "Antarktika",
"TXT_COUNTRY_AR" => "Argentīna",
"TXT_COUNTRY_AS" => "ASV Samoa",
"TXT_COUNTRY_AT" => "Austrija",
"TXT_COUNTRY_AU" => "Austrālija",
"TXT_COUNTRY_AW" => "Aruba",
"TXT_COUNTRY_AX" => "Aland Islands",
"TXT_COUNTRY_AZ" => "Azerbaidžāna",
"TXT_COUNTRY_BA" => "Bosnija un Hercegovina",
"TXT_COUNTRY_BB" => "Barbadosa",
"TXT_COUNTRY_BD" => "Bangladeša",
"TXT_COUNTRY_BE" => "Beļģija",
"TXT_COUNTRY_BF" => "Burkina Faso",
"TXT_COUNTRY_BG" => "Bulgārija",
"TXT_COUNTRY_BH" => "Bahreina",
"TXT_COUNTRY_BI" => "Burundi",
"TXT_COUNTRY_BJ" => "Benina",
"TXT_COUNTRY_BM" => "Bermudu salas",
"TXT_COUNTRY_BN" => "Bruneja",
"TXT_COUNTRY_BO" => "Bolīvija",
"TXT_COUNTRY_BQ" => "Bonaire, Saint Eustatius and Saba",
"TXT_COUNTRY_BR" => "Brazīlija",
"TXT_COUNTRY_BS" => "Bahamu salas",
"TXT_COUNTRY_BT" => "Butāna",
"TXT_COUNTRY_BV" => "Buvē sala",
"TXT_COUNTRY_BW" => "Botsvana",
"TXT_COUNTRY_BY" => "Baltkrievija",
"TXT_COUNTRY_BZ" => "Beliza",
"TXT_COUNTRY_CA" => "Kanāda",
"TXT_COUNTRY_CC" => "Kokosu (Kīlinga) salas",
"TXT_COUNTRY_CD" => "Kongo Demokrātiskā Republika",
"TXT_COUNTRY_CF" => "Centrālāfrikas Republika",
"TXT_COUNTRY_CG" => "Kongo",
"TXT_COUNTRY_CH" => "Šveice",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "Kotdivuāra",
"TXT_COUNTRY_CK" => "Kuka salas",
"TXT_COUNTRY_CL" => "Čīle",
"TXT_COUNTRY_CM" => "Kamerūna",
"TXT_COUNTRY_CN" => "Ķīna",
"TXT_COUNTRY_CO" => "Kolumbija",
"TXT_COUNTRY_CODE_NUMBER" => "Country, code and number",
"TXT_COUNTRY_CR" => "Kostarika",
"TXT_COUNTRY_CS" => "Serbia and Montenegro",
"TXT_COUNTRY_CU" => "Kuba",
"TXT_COUNTRY_CV" => "Kaboverde",
"TXT_COUNTRY_CW" => "Curaçao",
"TXT_COUNTRY_CX" => "Ziemsvētku sala",
"TXT_COUNTRY_CY" => "Kipra",
"TXT_COUNTRY_CZ" => "Čehijas Republika",
"TXT_COUNTRY_DE" => "Vācija",
"TXT_COUNTRY_DJ" => "Džibuti",
"TXT_COUNTRY_DK" => "Dānija",
"TXT_COUNTRY_DM" => "Dominika",
"TXT_COUNTRY_DO" => "Dominikānas Republika",
"TXT_COUNTRY_DZ" => "Alžīrija",
"TXT_COUNTRY_EC" => "Ekvadora",
"TXT_COUNTRY_EE" => "Igaunija",
"TXT_COUNTRY_EG" => "Ēģipte",
"TXT_COUNTRY_EH" => "Rietumsahāra",
"TXT_COUNTRY_ER" => "Eritreja",
"TXT_COUNTRY_ES" => "Spānija",
"TXT_COUNTRY_ET" => "Etiopija",
"TXT_COUNTRY_FI" => "Somija",
"TXT_COUNTRY_FJ" => "Fidži",
"TXT_COUNTRY_FK" => "Folklendu (Malvinu) salas",
"TXT_COUNTRY_FM" => "Mikronēzijas Valstu Federācija",
"TXT_COUNTRY_FO" => "Farēru salas",
"TXT_COUNTRY_FR" => "Francija",
"TXT_COUNTRY_GA" => "Gabona",
"TXT_COUNTRY_GB" => "Apvienotā Karaliste",
"TXT_COUNTRY_GD" => "Grenada",
"TXT_COUNTRY_GE" => "Džordžija",
"TXT_COUNTRY_GF" => "Franču Gviāna",
"TXT_COUNTRY_GG" => "Guernsey",
"TXT_COUNTRY_GH" => "Gana",
"TXT_COUNTRY_GI" => "Gibraltārs",
"TXT_COUNTRY_GL" => "Grenlande",
"TXT_COUNTRY_GM" => "Gambija",
"TXT_COUNTRY_GN" => "Gvineja",
"TXT_COUNTRY_GP" => "Gvadelupa",
"TXT_COUNTRY_GQ" => "Ekvatoriālā Gvineja",
"TXT_COUNTRY_GR" => "Grieķija",
"TXT_COUNTRY_GS" => "Dienviddžordžija un Dienvidsendviču salas",
"TXT_COUNTRY_GT" => "Gvatemala",
"TXT_COUNTRY_GU" => "Guama",
"TXT_COUNTRY_GW" => "Gvineja-Bisava",
"TXT_COUNTRY_GY" => "Gajana",
"TXT_COUNTRY_HK" => "Honkongas",
"TXT_COUNTRY_HM" => "Hērda un Makdonalda salas",
"TXT_COUNTRY_HN" => "Hondurasa",
"TXT_COUNTRY_HR" => "Horvātija",
"TXT_COUNTRY_HT" => "Haiti",
"TXT_COUNTRY_HU" => "Ungārija",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "Indonēzija",
"TXT_COUNTRY_IE" => "Īrija",
"TXT_COUNTRY_IL" => "Izraēla",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "Indija",
"TXT_COUNTRY_IO" => "Britu Indijas okeāna teritorija",
"TXT_COUNTRY_IQ" => "Irāka",
"TXT_COUNTRY_IR" => "Irāna",
"TXT_COUNTRY_IS" => "Islande",
"TXT_COUNTRY_IT" => "Itālija",
"TXT_COUNTRY_IX" => "Inmarsat SNAC",
"TXT_COUNTRY_JE" => "Jersey",
"TXT_COUNTRY_JM" => "Jamaika",
"TXT_COUNTRY_JO" => "Jordānija",
"TXT_COUNTRY_JP" => "Japāna",
"TXT_COUNTRY_KE" => "Kenija",
"TXT_COUNTRY_KG" => "Kirgīzija",
"TXT_COUNTRY_KH" => "Kambodža",
"TXT_COUNTRY_KI" => "Kiribati",
"TXT_COUNTRY_KM" => "Komoru salas",
"TXT_COUNTRY_KN" => "Sentkitsa un Nevisa",
"TXT_COUNTRY_KP" => "Ziemeļkoreja",
"TXT_COUNTRY_KR" => "Dienvidkoreja",
"TXT_COUNTRY_KW" => "Kuveita",
"TXT_COUNTRY_KY" => "Kaimanu salas",
"TXT_COUNTRY_KZ" => "Kazahstāna",
"TXT_COUNTRY_LA" => "Laosa",
"TXT_COUNTRY_LB" => "Libāna",
"TXT_COUNTRY_LC" => "Sentlūsija",
"TXT_COUNTRY_LI" => "Lihtenšteina",
"TXT_COUNTRY_LK" => "Šrilanka",
"TXT_COUNTRY_LR" => "Libērija",
"TXT_COUNTRY_LS" => "Lesoto",
"TXT_COUNTRY_LT" => "Lietuva",
"TXT_COUNTRY_LU" => "Luksemburga",
"TXT_COUNTRY_LV" => "Latvija",
"TXT_COUNTRY_LY" => "Lībija",
"TXT_COUNTRY_MA" => "Maroka",
"TXT_COUNTRY_MC" => "Monako",
"TXT_COUNTRY_MD" => "Moldova",
"TXT_COUNTRY_ME" => "Melnkalne",
"TXT_COUNTRY_MF" => "Saint Martin",
"TXT_COUNTRY_MG" => "Madagaskara",
"TXT_COUNTRY_MH" => "Māršala salas",
"TXT_COUNTRY_MK" => "Maķedonija",
"TXT_COUNTRY_ML" => "Mali",
"TXT_COUNTRY_MM" => "Mjanma",
"TXT_COUNTRY_MN" => "Mongolija",
"TXT_COUNTRY_MO" => "Makao",
"TXT_COUNTRY_MP" => "Ziemeļu Marianas salas",
"TXT_COUNTRY_MQ" => "Martinika",
"TXT_COUNTRY_MR" => "Mauritānija",
"TXT_COUNTRY_MS" => "Montserrata",
"TXT_COUNTRY_MT" => "Malta",
"TXT_COUNTRY_MU" => "Maurīcija",
"TXT_COUNTRY_MV" => "Maldivija",
"TXT_COUNTRY_MW" => "Malāvija",
"TXT_COUNTRY_MX" => "Meksika",
"TXT_COUNTRY_MY" => "Malaizija",
"TXT_COUNTRY_MZ" => "Mozambika",
"TXT_COUNTRY_NA" => "Namībija",
"TXT_COUNTRY_NC" => "Jaunkaledonija",
"TXT_COUNTRY_NE" => "Nigēra",
"TXT_COUNTRY_NF" => "Norfolkas sala",
"TXT_COUNTRY_NG" => "Nigērija",
"TXT_COUNTRY_NI" => "Nikaragva",
"TXT_COUNTRY_NL" => "Nīderlande",
"TXT_COUNTRY_NO" => "Norvēģija",
"TXT_COUNTRY_NP" => "Nepāla",
"TXT_COUNTRY_NR" => "Nauru",
"TXT_COUNTRY_NU" => "Niue",
"TXT_COUNTRY_NZ" => "Jaunzēlande",
"TXT_COUNTRY_OM" => "Omāna",
"TXT_COUNTRY_PA" => "Panama",
"TXT_COUNTRY_PE" => "Peru",
"TXT_COUNTRY_PF" => "Franču Polinēzija",
"TXT_COUNTRY_PG" => "Papua-Jaungvineja",
"TXT_COUNTRY_PH" => "Filipīnas",
"TXT_COUNTRY_PK" => "Pakistāna",
"TXT_COUNTRY_PL" => "Polija",
"TXT_COUNTRY_PM" => "Senpjēra un Mikelona",
"TXT_COUNTRY_PN" => "Pitkērna",
"TXT_COUNTRY_PR" => "Puertoriko",
"TXT_COUNTRY_PS" => "Palestīnas teritorija",
"TXT_COUNTRY_PT" => "Portugāle",
"TXT_COUNTRY_PT-AZ" => "Azores",
"TXT_COUNTRY_PT-MA" => "Madeira",
"TXT_COUNTRY_PW" => "Palau",
"TXT_COUNTRY_PY" => "Paragvaja",
"TXT_COUNTRY_QA" => "Katara",
"TXT_COUNTRY_RE" => "Reinjona",
"TXT_COUNTRY_RO" => "Rumānija",
"TXT_COUNTRY_RS" => "Serbija",
"TXT_COUNTRY_RU" => "Krievija",
"TXT_COUNTRY_RW" => "Ruanda",
"TXT_COUNTRY_SA" => "Saūda Arābija",
"TXT_COUNTRY_SB" => "Zālamana salas",
"TXT_COUNTRY_SC" => "Seišeļu salas",
"TXT_COUNTRY_SD" => "Sudāna",
"TXT_COUNTRY_SE" => "Zviedrija",
"TXT_COUNTRY_SG" => "Singapūra",
"TXT_COUNTRY_SH" => "Svētās Helēnas sala",
"TXT_COUNTRY_SI" => "Slovēnija",
"TXT_COUNTRY_SJ" => "Svalbāra un Jana Majena salas",
"TXT_COUNTRY_SK" => "Slovākija",
"TXT_COUNTRY_SL" => "Sjerraleone",
"TXT_COUNTRY_SM" => "Sanmarīno",
"TXT_COUNTRY_SN" => "Senegāla",
"TXT_COUNTRY_SO" => "Somālija",
"TXT_COUNTRY_SR" => "Surinama",
"TXT_COUNTRY_SS" => "South Sudan",
"TXT_COUNTRY_ST" => "Santome un Prinsipi",
"TXT_COUNTRY_SV" => "Salvadora",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Sīrija",
"TXT_COUNTRY_SZ" => "Svazilenda",
"TXT_COUNTRY_TC" => "Tērksas un Kaikosas salas",
"TXT_COUNTRY_TD" => "Čada",
"TXT_COUNTRY_TF" => "Franču Dienvidu teritorijas",
"TXT_COUNTRY_TG" => "Togo",
"TXT_COUNTRY_TH" => "Taizeme",
"TXT_COUNTRY_TJ" => "Tadžikistāna",
"TXT_COUNTRY_TK" => "Tokelau",
"TXT_COUNTRY_TL" => "Timora-Leste",
"TXT_COUNTRY_TM" => "Turkmenistāna",
"TXT_COUNTRY_TN" => "Tunisija",
"TXT_COUNTRY_TO" => "Tonga",
"TXT_COUNTRY_TR" => "Turcija",
"TXT_COUNTRY_TT" => "Trinidāda un Tobāgo",
"TXT_COUNTRY_TV" => "Tuvalu",
"TXT_COUNTRY_TW" => "Taivāna",
"TXT_COUNTRY_TZ" => "Tanzānija",
...
"TXT_COUNTRY_US" => "Amerikas Savienotās Valstis",
"TXT_COUNTRY_US-AL" => "Alaska",
"TXT_COUNTRY_US-HI" => "Hawaii",
"TXT_COUNTRY_UY" => "Urugvaja",
"TXT_COUNTRY_UZ" => "Uzbekistāna",
"TXT_COUNTRY_VA" => "Vatikāns",
"TXT_COUNTRY_VC" => "Sentvinsenta un Grenadīnas",
"TXT_COUNTRY_VE" => "Venecuēla",
"TXT_COUNTRY_VG" => "Britu Virdžīnas",
"TXT_COUNTRY_VI" => "U.S. Virgin Islands",
"TXT_COUNTRY_VN" => "Vjetnama",
"TXT_COUNTRY_VU" => "Vanuatu",
"TXT_COUNTRY_WF" => "Volisa un Futuna",
"TXT_COUNTRY_WS" => "Samoa",
"TXT_COUNTRY_YE" => "Jemena",
"TXT_COUNTRY_YT" => "Majota",
"TXT_COUNTRY_ZA" => "Dienvidāfrika",
"TXT_COUNTRY_ZM" => "Zambija",
"TXT_COUNTRY_ZW" => "Zimbabve",
"TXT_COVER" => "Faksa vāks",
...
"TXT_COVERPAGE_TEXT" => "Vāka lapas teksts",
"TXT_COVERS_RESTORED" => "Default PamFax covers have been restored",
"TXT_COVERTEXT_1" => "Ievadi tekstu izvēlētajam vākam.",
...
"TXT_COVER_TEMPLATE" => "Vāka sagatave",
"TXT_CREATED" => "Created",
...
"TXT_EMAIL_RECIPIENT" => "Tava e-pasta adrese",
"TXT_EMAIL_SUBJECT" => "PamFax statusa paziņojumi",
...
"TXT_FAILED" => "Neizdevās",
"TXT_FAILED_RECIPIENTS" => "({failed_recipients} recipients invalid)",
"TXT_FAILUREMESSAGE_EMAIL" => "Sveiks {username}.{crlf}{crlf}Tavu PamFax sūtījumu priekš {fax_recipient} nevar nosūtīt: {fail_reason}.{crlf}{crlf}PamFax pakalpojumi",
"TXT_FAILUREMESSAGE_SMS" => "Sveiks {username}.{crlf}Tavu PamFax sūtījumu priekš {fax_recipient} nevar nosūtīt: {fail_reason}.",
...
"TXT_FAXINGRATES" => "Faksa sūtīšanas tarifi",
...
"TXT_FAXPRICE" => "Šis faksa sūtījums maksā <b>{price}</b>.",
...
"TXT_FINISHED_1" => "<b>Tavs faksa ziņojums tagad tiek sūtīts.</b><br><br>Tu vari pārbaudīt progresu <a href=\"javascript:OpenPortal()\"><b>kontroles panelī</b></a>.<br><br>Vēlies sūtīt vēl vienu faksa ziņojumu?<br>Izmanto apakšā esošās pogas, lai nosūtītu citu faksa ziņojumu.<br><br>Paldies, ka lieto PamFax.",
...
"TXT_GBP" => "Lielbritānijas mārciņas",
"TXT_GENERAL" => "Galvenie",
"TXT_GENERALNOTIFICATIONSETTINGS" => "Manage Recipients",
"TXT_GENERAL_SETTINGS" => "Galvenie uzstādījumi",
...
"TXT_MAP_TITLE" => "Saņēmēja atrašanās iekš Google Maps",
...
"TXT_NOTIFICATION_SETTINGS" => "Paziņojumu uzstādījumi",
...
"TXT_NOTIFICATION_SETTINGS_UPDATED_OK" => "Paziņojumu uzstādījumi veiksmīgi izmainīti!",
...
"TXT_NO_EMAIL_RECIPIENT" => "Lūdzu ievadi derīgu e-pasta adresi.",
...
"TXT_NO_SMS_RECIPIENT" => "Lūdzu ievadi derīgu īsziņas saņēmēja numuru.",
"TXT_NO_UPDATE_AVAILABLE" => "No update available",
"TXT_NUMBER_1" => "Tikai viens saņēmējs",
"TXT_NUMBER_2" => "Faksa numurs:",
"TXT_NUMBER_3" => "Izvēlies valsti",
"TXT_NUMBER_4" => "Saņēmēja vārds",
"TXT_NUMBER_5" => "Vairāki saņēmēji",
"TXT_NUMBER_6" => "(Ieraksti vienu faksa numuru rindā)",
"TXT_NUMBER_8" => "Kam vēlies nosūtīt faksa ziņojumu?",
...
"TXT_PAY_SUMMARY" => "Šis faksa sūtījums maksā <b>{price}</b>.",
...
"TXT_PLN" => "Polijas zloti",
"TXT_PORTAL" => "Kontroles panelis",
...
"TXT_PRINT" => "Print",
"TXT_PRIVACY" => "Privātuma nosacījumi",
...
"TXT_PROFILE_SAVED" => "Uzstādījumi saglabāti",
...
"TXT_RATE" => "Tarifs",
"TXT_RATES" => "Tarifi",
"TXT_RATES_PER_PAGE" => "Visi tarifi ir par vienu lapu.",
...
"TXT_RECIPIENT_NAME" => "Saņēmēja vārds",
...
"TXT_RESTART_HINT" => "Atjaunināšanu nevarēja veikt, jo nevarēja izmainīt failus. Lūdzu pārstartē savu datoru, lai pabeigtu instalāciju.",
"TXT_RESTOFWORLD" => "Pārējā pasaule",
"TXT_RESTORE_CONNECTION" => "Server is unreachable.<br />\n\nRestoring connection to server...",
"TXT_ROTATE" => "Rotate",
"TXT_RUB" => "Krievijas rubļi",
...
"TXT_SAVE_AS_DEFAULT" => "Saglabāt kā noklusējumu",
...
"TXT_SECONDS" => "Seconds",
"TXT_SEK" => "Zviedrijas kronas",
"TXT_SELECTCOVER_1" => "Izvēlies vāka lapu priekš tava faksa ziņojuma. Tu varēsi pievienot tekstu vāka lapa nākošajā solī.<br><br>",
"TXT_SELECTCOVER_2" => "<br>(Dubultklikšķis, lai apskatītu bildi)",
...
"TXT_SELECTFILE_4" => "Izvēlies failu...",
...
"TXT_SENDER_COMPANY" => "Kompānijas nosaukums",
"TXT_SENDER_DETAILS" => "Sūtītāja informācija",
"TXT_SENDER_FAX" => "Faksa numurs",
"TXT_SENDER_GMAPS" => "Show sender's location in {img_google} Maps",
"TXT_SENDER_NAME" => "Vārds",
...
"TXT_SEND_EMAIL_STATUS" => "Sūtīt faksa statusa informāciju caur e-pastu",
"TXT_SEND_FAX" => "Send a fax",
"TXT_SEND_FAX_NOW" => "Send fax now",
"TXT_SEND_MAILS_TO" => "Send emails to",
"TXT_SEND_SKYPECHAT_STATUS" => "Sūtīt faksa statusa informāciju caur Skype saraksti",
"TXT_SEND_SMS_STATUS" => "Sūtīt izdevušos/neveiksmīgos paziņojumus caur īsziņu ({cost} par vienu īsziņu)",
...
"TXT_SMS_RECIPIENT" => "Mobilā telefona numurs",
...
"TXT_STATE_ACCEPTED" => "Apstiprināt",
"TXT_STATE_BUSY" => "Aizņemts",
"TXT_STATE_CANCELLED" => "Atcelts",
"TXT_STATE_CANCEL_PENDING" => "Cancel pending",
"TXT_STATE_CLEANED_UP" => "Cleaned Up",
"TXT_STATE_CONVERTING" => "Konvertē",
...
"TXT_STATE_FAILURE" => "Neveiksme",
"TXT_STATE_HOLD" => "Aizturēt",
"TXT_STATE_INVALIDATED" => "Nav apstiprināts",
"TXT_STATE_IN_QUEUE" => "In queue",
"TXT_STATE_ONRETRY" => "Mēģinājumā",
"TXT_STATE_READY" => "Gatavs",
"TXT_STATE_SENDING" => "In progress",
"TXT_STATE_SUBMITTED" => "Nosūtīts",
"TXT_STATE_SUCCESS" => "Veiksmīgi",
"TXT_STATE_UNKNOWN" => "Darbībā",
...
"TXT_STATUS" => "Statuss",
"TXT_STATUS_DETAILS" => "Statusa detaļas",
...
"TXT_SUCCESSFUL_FAXES" => "Veiksmīgi faksa sūtījumi",
"TXT_SUCCESSMESSAGE_EMAIL" => "Sveiks {username}.{crlf}{crlf}Tavs PamFax sūtījums priekš {fax_recipient} ir veiksmīgi nosūtīts.{crlf}{crlf}PamFax pakalpojumi",
"TXT_SUCCESSMESSAGE_SMS" => "Sveiks {username}.{crlf}Tavs PamFax sūtījums priekš {fax_recipient} ir veiksmīgi nosūtīts.",
"TXT_SUGGESTED_FOR_YOU" => "Recommended Download",
"TXT_SUPPORT" => "Support",
"TXT_SUPPORT_TICKET" => "Support-Ticket",
"TXT_TAB_DASHBOARD" => "Portal",
"TXT_TAB_FAXRATES" => "Tarifi",
...
"TXT_TASK" => "Task",
"TXT_TERMS" => "Lietošanas noteikumi",
...
"WINDOW_TITLE" => "PamFax - Sūti faksa ziņojumu uz jebkuru numuru visā pasaulē",
