...
"BTN_SHARE" => "Share",
"BTN_SHOW_GOOGLE_MAP" => "Vis hvor mottakeren oppholder seg i {img_google} Kart",
...
"BTN_START_UPDATE" => "Ja. start oppdatering",
...
"BTN_UP" => "Up",
"BTN_UPDATE_LATER" => "Nei, oppdater senere",
...
"ERR_BAD_FILE" => "Filformatet du prøvde å sende støttes ikke av PamFax. Vennligst gjør det om til støttende format og prøv igjen.<br>Besøk vår {link_faq_1} for detaljer.",
...
"ERR_FAX_10024" => "Ingen svar",
"ERR_FAX_10025" => "Ikke en Fax-maskin",
"ERR_FAX_23073" => "Tale svar",
"ERR_FAX_23441" => "Ulokalisert nummer",
"ERR_FAX_23443" => "Utilgjengelig området",
"ERR_FAX_23468" => "Feil nummerformat",
"ERR_FAX_BADLINE" => "Dårlig Fax linje.",
"ERR_FAX_BADLINE_HINT" => "Vennligst prøv å send Fax'en på nytt etter noen få minutter.",
"ERR_FAX_BUSY" => "Nummeret er stadig opptatt.",
"ERR_FAX_BUSY_HINT" => "Vennligst sjekk faxnummeret og send Fax'en på nytt om noen få minutter.",
...
"ERR_FAX_DESTUNREACHABLE" => "Område kan ikke nås.",
"ERR_FAX_DESTUNREACHABLE_HINT" => "Vennligst sjekk at faxnummeret er rett.",
"ERR_FAX_DEST_DOESNT_SUPPORT_FAX" => "Destination does not support fax",
"ERR_FAX_DIALING" => "Anrop feilet.",
"ERR_FAX_DIALING_HINT" => "Kunne ikke ringe nummeret. Vennligst sjekk faxnummeret og send Fax'en på nytt om noen få minutter.",
"ERR_FAX_DRIVERPROBLEM" => "Problem med Fax driveren",
"ERR_FAX_DRIVERPROBLEM_HINT" => "Dette er et server problem. Vennligst prøv å send Fax'en på nytt etter noen få minutter.",
...
"ERR_FAX_HUNGUP" => "Linjen ble avsluttet (lagt på).",
"ERR_FAX_HUNGUP_HINT" => "Linjen ble brytt under overføringen. Vennligst send Fax'en på nytt om noen få minutter.",
"ERR_FAX_INVALIDNUMBER" => "Feil nummerformat.",
"ERR_FAX_INVALIDNUMBER_EX" => "The number is not in a valid international number format.",
"ERR_FAX_INVALIDNUMBER_HINT" => "Faxnummeret er av feil format. Vennligst prøv å send Fax'en på nytt etter noen få minutter.",
"ERR_FAX_IN_FETCH_EXTEND_DATA" => "Error fetching number extend data",
"ERR_FAX_NOANSWER" => "Ingen svar.",
"ERR_FAX_NOANSWER_HINT" => "Vennligst sjekk faxnummeret og send Fax'en på nytt om noen få minutter.",
"ERR_FAX_NOFAX" => "Ingen Fax maskin.",
"ERR_FAX_NOFAX_HINT" => "Vennligst sjekk faxnummeret og send Fax'en på nytt om noen få minutter.",
...
"ERR_FAX_TRANSMISSION" => "Feil under Fax overføringen.",
"ERR_FAX_TRANSMISSION_HINT" => "Vennligst send Fax'en på nytt om noene få minutter.",
"ERR_FAX_UNALLOCATEDNUMBER" => "Utilgjengelig nummer.",
"ERR_FAX_UNALLOCATEDNUMBER_HINT" => "Vennligst sjekk faxnummeret og send Fax'en på nytt om noen få minutter.",
"ERR_FAX_UNKNOWN" => "Ukjent feil: (code).",
"ERR_FAX_UNKNOWN_HINT" => "Vennligst send Fax'en på nytt om noen få minutter.",
"ERR_FAX_VOICEANSWER" => "Tale svar.",
"ERR_FAX_VOICEANSWER_HINT" => "Vennligst sjekk faxnummeret og send ny Fax om noen få minutter.",
...
"LNGFAILUREMESSAGE_CHAT" => "Hei {username}, din PamFax til {fax_recipient} ble ikke sendt. Mer informasjon er tilgjengelig i portalen (trykk på Portal fra PamFax klienten).",
...
"LNGPROGRESSMESSAGE_CHAT" => "Hei {username},din PamFax til {fax_recipient} blir behandlet nå. Du vil motta en ny direktemelding når Fax'en er blitt sendt eller hvis det oppstår feil.",
...
"LNGSUCCESSMESSAGE_CHAT" => "PamFax status: Din PamFax til {fax_recipient} ble vellykket sendt. Mer informasjon er tilgjengelig i portalen (trykk Portal fra PamFax klienten).",
...
"MSG_COVERTEXT_REQUIRED" => "Når du bare sender en frontside, må du skrive inn en melding",
...
"MSG_CREDITS_RESTORED" => "Kontoen er tilbakestilt",
...
"MSG_DUPS_REMOVED" => "Listen inneholder flere like nummere.<br>Disse fjernes automatisk for å ungå tillegskostnader.",
...
"MSG_FAXNUMBER_MISSING" => "Angi et faxnummer",
...
"MSG_GENERATING_FAX" => "Din Fax genereres. Vennligst vent...",
...
"MSG_MAILRECIPIENT_MISSING" => "Angi e-post mottaker",
...
"MSG_MULFAXNUMBERS_MISSING" => "Angi minst ett faxnummer",
"MSG_NEW_INBOX_FAXES" => "You have {faxes_cnt} new faxes",
"MSG_NOCREDITS_RESTORED" => "Beklager, ingen kredit er blitt tilbakeført",
"MSG_NO_DEVICE_CONTACTS" => "No contacts found on device",
"MSG_NO_RECIPIENT" => "Fant ingen godkjent mottaker",
...
"MSG_PREPARE_PREVIEW" => "Forbereder forhåndsvisning...",
...
"MSG_SMSRECIPIENT_MISSING" => "Angi SMS-mottaker",
"MSG_SOME_INVALID_NUMBERS" => "Noen av disse faxnummerene er ugyldige",
"MSG_SOME_UNPAID_FAXES_SENT" => "Some unpaid faxes were sent, the others remain unpaid due to insufficient credit.",
"MSG_STORING_CREDIT" => "Lagrer kreditinformasjon...",
...
"MSG_WAIT_DEFAULT" => "Vennligst vent...",
...
"TITLE_COVER_TEXT" => "Skriv en melding",
...
"TITLE_NOTIFY" => "Meldingsinnstillinger",
"TITLE_NUMBER" => "Oppgi mottaker(e)",
"TITLE_PAY" => "Betal og send Fax",
...
"TITLE_SELECT_COVER" => "Velg en frontside",
...
"TXT_BUY_PAMFAXCREDIT" => "Kjøp PamFax kredit",
"TXT_BYFAX_ABOUT" => "About [apptitle]",
"TXT_CAD" => "Kanadiske dollar",
...
"TXT_CLICKTOCLOSE" => "Klikk for å lukke",
...
"TXT_CNY" => "Kinesiske yuan renminbi",
...
"TXT_COUNTRY_BV" => "Bouvetøya",
"TXT_COUNTRY_BW" => "Botswana",
"TXT_COUNTRY_BY" => "Hviterussland",
"TXT_COUNTRY_BZ" => "Belize",
"TXT_COUNTRY_CA" => "Canada",
"TXT_COUNTRY_CC" => "Kokosøyene (Keeling)",
"TXT_COUNTRY_CD" => "Kongo, den demokratiske republikken",
"TXT_COUNTRY_CF" => "Den sentralafrikanske republikk",
"TXT_COUNTRY_CG" => "Kongo",
"TXT_COUNTRY_CH" => "Sveits",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "Elfenbenskysten",
"TXT_COUNTRY_CK" => "Cookøyene",
...
"TXT_COUNTRY_IO" => "Det britiske territoriet i Indiahavet",
"TXT_COUNTRY_IQ" => "Irak",
"TXT_COUNTRY_IR" => "Iran",
...
"TXT_COUNTRY_KH" => "Kambodsja",
"TXT_COUNTRY_KI" => "Kiribati",
"TXT_COUNTRY_KM" => "Komorene",
"TXT_COUNTRY_KN" => "St. Kitts og Nevis",
"TXT_COUNTRY_KP" => "Nord-Korea",
"TXT_COUNTRY_KR" => "Sør-Korea",
"TXT_COUNTRY_KW" => "Kuwait",
"TXT_COUNTRY_KY" => "Caymanøyene",
"TXT_COUNTRY_KZ" => "Kasakhstan",
"TXT_COUNTRY_LA" => "Laos",
...
"TXT_COUNTRY_PE" => "Peru",
"TXT_COUNTRY_PF" => "Fransk Polynesia",
"TXT_COUNTRY_PG" => "Papua Ny-Guinea",
"TXT_COUNTRY_PH" => "Filippinene",
"TXT_COUNTRY_PK" => "Pakistan",
"TXT_COUNTRY_PL" => "Polen",
"TXT_COUNTRY_PM" => "St. Pierre og Miquelon",
"TXT_COUNTRY_PN" => "Pitcairn",
"TXT_COUNTRY_PR" => "Puerto Rico",
"TXT_COUNTRY_PS" => "Det palestinske området",
...
"TXT_COUNTRY_ST" => "Sao Tome og Principe",
"TXT_COUNTRY_SV" => "El Salvador",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Syria",
"TXT_COUNTRY_SZ" => "Swaziland",
"TXT_COUNTRY_TC" => "Turks- og Caicosøyene",
"TXT_COUNTRY_TD" => "Tsjad",
"TXT_COUNTRY_TF" => "Franske sørlige territorier",
"TXT_COUNTRY_TG" => "Togo",
"TXT_COUNTRY_TH" => "Thailand",
"TXT_COUNTRY_TJ" => "Tadsjikistan",
"TXT_COUNTRY_TK" => "Tokelau",
"TXT_COUNTRY_TL" => "Øst-Timor",
"TXT_COUNTRY_TM" => "Turkmenistan",
"TXT_COUNTRY_TN" => "Tunisia",
"TXT_COUNTRY_TO" => "Tonga",
"TXT_COUNTRY_TR" => "Tyrkia",
"TXT_COUNTRY_TT" => "Trinidad og Tobago",
...
"TXT_COVERPAGE_TEXT" => "Tekst i frontside",
"TXT_COVERS_RESTORED" => "Default PamFax covers have been restored",
"TXT_COVERTEXT_1" => "Skriv inn teksten for valgt frontside",
...
"TXT_COVER_TEMPLATE" => "Mal for frontside",
"TXT_CREATED" => "Created",
...
"TXT_DELETEFAXQUESTION" => "Vil du virkelig slette denne Faxen?\nDette kan ikke gjøres om igjen.",
...
"TXT_EMAIL_RECIPIENT" => "Din e-post adresse",
...
"TXT_FAILUREMESSAGE_EMAIL" => "Hei {username}.{crlf}Din PamFax til {fax_recipient} ble ikke sendt: {fail_reason}.{crlf}{crlf}Hilsen,{crlf}PamFax tjenesten",
"TXT_FAILUREMESSAGE_SMS" => "Hei {username}.{crlf}Din PamFax til {fax_recipient} ble ikke sendt: {fail_reason}.",
...
"TXT_FAXPRICE" => "Denne Fax'en vil koste <b>{price}</b>.",
...
"TXT_FINISHED_1" => "<b>Din Fax er nå sendt.</b><br><br>Du kan sjekke utførelsen i {link_portal}.<br><br>Vil du sende en ny Fax?<br>Bruk knappen under send ny Fax.<br><br>Takk for at du bruker PamFax.",
...
"TXT_MAP_TITLE" => "Mottakers område i Google Kart",
...
"TXT_NOTIFICATION_SETTINGS" => "Meldingsinnstillinger",
...
"TXT_NOTIFICATION_SETTINGS_UPDATED_OK" => "Meldingsinnstillingene ble vellykket oppdatert",
...
"TXT_NO_EMAIL_RECIPIENT" => "Vennligst skriv inn en gyldig e-post-mottaker",
...
"TXT_NO_SMS_RECIPIENT" => "Vennligst angi en gylig SMS-mottaker",
"TXT_NO_UPDATE_AVAILABLE" => "No update available",
"TXT_NUMBER_1" => "Enkel mottaker",
"TXT_NUMBER_2" => "Faxnummer:",
"TXT_NUMBER_3" => "Velg land",
"TXT_NUMBER_4" => "Mottaker navn:",
"TXT_NUMBER_5" => "Flere mottakere:",
"TXT_NUMBER_6" => "(angi ett faxnummer per linje)",
"TXT_NUMBER_8" => "Hvem vil du sende Fax'en til?",
...
"TXT_PAY_SUMMARY" => "Denne Fax'en vil koste <b>{price}</b>.",
...
"TXT_PROFILE_SAVED" => "Innstillingene er blitt lagret.",
...
"TXT_RATE" => "Takst",
"TXT_RATES" => "Takster",
"TXT_RATES_PER_PAGE" => "Alle takster er per.side",
...
"TXT_RECIPIENT_NAME" => "Mottakernavn",
...
"TXT_REFRESH" => "Oppdater",
"TXT_REFUND" => "Refund",
"TXT_REFUNDED" => "tilbakeført: %1",
"TXT_REFUNDED_ALL" => "{price} er blitt tilbakesendt.",
"TXT_REFUNDED_NONE" => "Ingen tilbakesendinger tilgjengelig.",
"TXT_REFUNDED_PART" => "{refunded_value} av {price} er blitt tilbakesendt.",
"TXT_REGION" => "Region",
...
"TXT_RESTART_HINT" => "Oppdateringen kunne ikke fullføres, kunne ikke erstatte filene. Vennligst restart din datamaskin for å fullføre installasjonen.",
"TXT_RESTOFWORLD" => "Resten av verden",
"TXT_RESTORE_CONNECTION" => "Server is unreachable.<br />\n\nRestoring connection to server...",
"TXT_ROTATE" => "Rotate",
"TXT_RUB" => "Russiske rubler",
...
"TXT_SAVE_AS_DEFAULT" => "Lagre som standard",
...
"TXT_SECONDS" => "Seconds",
"TXT_SEK" => "Svenske kroner",
"TXT_SELECTCOVER_1" => "Velg en frontside for din Fax. Du kan legge til en melding til frontsiden i neste trinn.<br><br>",
"TXT_SELECTCOVER_2" => "<br>(Dobbelttrykk bilde for forhåndsvisning)",
...
"TXT_SENDER_COMPANY" => "Firmanavn",
"TXT_SENDER_DETAILS" => "Sender informasjon",
"TXT_SENDER_FAX" => "Faxnummer",
"TXT_SENDER_GMAPS" => "Show sender's location in {img_google} Maps",
"TXT_SENDER_NAME" => "Navn",
...
"TXT_SEND_EMAIL_STATUS" => "Send Fax statusinformasjon via e-post",
"TXT_SEND_FAX" => "Send a fax",
"TXT_SEND_FAX_NOW" => "Send fax now",
"TXT_SEND_MAILS_TO" => "Send emails to",
"TXT_SEND_SKYPECHAT_STATUS" => "Send Fax informasjonstatus via Skype chat",
"TXT_SEND_SMS_STATUS" => "Send melding om vellykket/feil-forsendelse via SMS ({cost} per SMS)",
...
"TXT_SKYPECHAT" => "Skype tekstsamtale",
...
"TXT_SMS_RECIPIENT" => "Mobiltelefonnummer",
...
"TXT_STATE_ACCEPTED" => "Godtatt",
"TXT_STATE_BUSY" => "Opptatt",
"TXT_STATE_CANCELLED" => "Avbryt",
"TXT_STATE_CANCEL_PENDING" => "Cancel pending",
"TXT_STATE_CLEANED_UP" => "Cleaned Up",
"TXT_STATE_CONVERTING" => "Konverterer",
"TXT_STATE_DELAYED" => "Delayed",
"TXT_STATE_DELETED" => "Slettet av bruker",
"TXT_STATE_DELIVERING" => "In progress",
"TXT_STATE_DELIVERY_ERROR" => "Delivery error",
"TXT_STATE_FAILURE" => "Feilet",
"TXT_STATE_HOLD" => "Parkert",
"TXT_STATE_INVALIDATED" => "Ikke godtatt",
"TXT_STATE_IN_QUEUE" => "In queue",
"TXT_STATE_ONRETRY" => "Forsøker igjen",
"TXT_STATE_READY" => "Klar",
"TXT_STATE_SENDING" => "In progress",
"TXT_STATE_SUBMITTED" => "Sendt",
"TXT_STATE_SUCCESS" => "Vellykket",
"TXT_STATE_UNKNOWN" => "Utfører",
"TXT_STATE_UNPAID" => "Unpaid",
"TXT_STATE_UNPAYED" => "Waiting for payment",
"TXT_STATE_USER_CANCELLED" => "Avbryt av bruker",
...
"TXT_STATUS" => "Status",
"TXT_STATUS_DETAILS" => "Statusdetaljer",
...
"TXT_SUCCESSFUL_FAXES" => "Vellykket Fax",
"TXT_SUCCESSMESSAGE_EMAIL" => "Hei {username}.{crlf}{crlf}Din PamFax til {fax_recipient} ble vellykket sendt.{crlf}{crlf}Du kan vise din Fax historikk fra Portalen (Trykk Portal i PamFax){crlf}{crlf}Takk for at du brukte vår tjeneste.{crlf}{crlf}Hilsen,{crlf}PamFax tjenesten",
"TXT_SUCCESSMESSAGE_SMS" => "Hei {username}.{crlf}Din PamFax til {fax_recipient} ble vellykket sendt.",
"TXT_SUGGESTED_FOR_YOU" => "Recommended Download",
"TXT_SUPPORT" => "Support",
"TXT_SUPPORT_TICKET" => "Support-Ticket",
"TXT_TAB_DASHBOARD" => "Portal",
"TXT_TAB_FAXRATES" => "Takster",
...
"TXT_TASK" => "Task",
"TXT_TERMS" => "Rettningslinjer for bruk",
...
"TXT_THANKYOU" => "Takk for din betaling med Amazon Payments.<br>\n<br>\nVennligst lukk din netleser nå og fortsett i PamFax.",
"TXT_THANKYOU_TITLE" => "Takk",
"TXT_TIME" => "Time",
...
"TXT_UPDATE_HINT" => "Alle filer er blitt nedlastet. Vil du installere oppdateringen nå?",
...
"WINDOW_TITLE" => "PamFax - Send en Fax til et hvilket som helst faxnummer i verden",
