...
"BTN_CLONE" => "Clone",
"BTN_CLOSE" => "Затвори PamFax",
"BTN_CONFIRM" => "Потвърди",
"BTN_CONTACTS_DELGROUP" => "Delete group",
"BTN_CONTINUE" => "Continue",
"BTN_COVER" => "Cover",
"BTN_COVERPAGES" => "Корици",
"BTN_DELETE" => "Изтрий",
"BTN_DELETEFAX" => "Изтрий",
...
"BTN_INBOX" => "Inbox",
"BTN_INVITE" => "Покани потребител",
"BTN_INVITE_SUBMIT" => "Изпрати покана",
...
"BTN_SELECT_ANOTHER_FILE" => "Избери друг файл",
"BTN_SELECT_FILE" => "Document(s)",
"BTN_SELECT_FILE_2" => "Select file",
"BTN_SEND" => "Изпрати факса",
"BTN_SENDASFAX" => "Send as fax",
"BTN_SEND_ANOTHER" => "Изпрати друг",
...
"BTN_SHARE" => "Share",
"BTN_SHOW_GOOGLE_MAP" => "Местоположение на получателя в {img_google} карти",
...
"BTN_START_UPDATE" => "Да, обнови сега",
"BTN_TAB_BCP" => "Офисен контролен панел",
"BTN_TAB_CONTACTS" => "Contacts",
"BTN_TAB_DASHBOARD" => "Portal",
"BTN_TAB_HISTORY" => "Хронология",
"BTN_TAB_INBOX" => "Inbox",
...
"BTN_TEXT_ONLY" => "Изпрати само корицата",
...
"BTN_UP" => "Up",
"BTN_UPDATE_LATER" => "Не, обнови по-късно",
...
"ERR_BAD_FILE" => "Обработване на файла, който опитвате да изпратите е невъзможно. Моля, запишете го в един от поддържаните формати и опитайте отново.<br>Посетете {link_faq_1} за допълнителни сведения.",
...
"ERR_CONVERSION" => "Грешка при преобразуване на файл: %1.<br><br>Моля, запишете документа в друг формат и опитайте отново.",
"ERR_CONVERSION_CALCPAGES" => "Невъзможно отброяване на брой страници.<br>\nМоля, отворете файла в подходящото приложение и го отпечайте с принтера „PamFax“.",
"ERR_CONVERSION_COMPILEFAX" => "Изключение при подготовка на факс.",
"ERR_CONVERSION_CONVERT" => "Невъзможно преобразуване на файл. Моля, запишете документа в друг формат и опитайте отново.",
"ERR_CONVERSION_COVER" => "Невъзможно създаване на корица.",
...
"ERR_FAX_10024" => "Няма отговор.",
"ERR_FAX_10025" => "Не е факс машина.",
"ERR_FAX_23073" => "Гласов секретар.",
"ERR_FAX_23441" => "Неосвободен номер.",
"ERR_FAX_23443" => "Недостижим адресат.",
"ERR_FAX_23468" => "Недействителен формат на номера.",
"ERR_FAX_BADLINE" => "Лоша факс линия.",
"ERR_FAX_BADLINE_HINT" => "Моля, опитайте да изпратите отново факса след няколко минути.",
"ERR_FAX_BUSY" => "Постоянно зает номер.",
"ERR_FAX_BUSY_HINT" => "Моля, проверете факс номера и изпратете отново факса след няколко минути.",
...
"ERR_FAX_DESTOUTOFORDER" => "Повреден адресат.",
"ERR_FAX_DESTUNREACHABLE" => "Недостижим адресат.",
"ERR_FAX_DESTUNREACHABLE_HINT" => "Моля, уверете се, че факс номерът е правилен.",
"ERR_FAX_DEST_DOESNT_SUPPORT_FAX" => "Неподдържащ факс адресат.",
"ERR_FAX_DIALING" => "Грешка при избиране.",
"ERR_FAX_DIALING_HINT" => "Избиране на номера е невъзможно. Моля, проверете факс номера и изпратете отново факса след няколко минути.",
"ERR_FAX_DRIVERPROBLEM" => "Проблем с факс драйвера.",
"ERR_FAX_DRIVERPROBLEM_HINT" => "Причината е в сървъра. Моля, изпратете отново факса след няколко минути.",
"ERR_FAX_EXISTS" => "Fax exists",
"ERR_FAX_FAXCONN_NOT_SUCCESSFUL" => "Неуспешно свързване.",
"ERR_FAX_FILES_EXISTING" => "Some file(s) already exist in fax",
"ERR_FAX_HUNGUP" => "Линията бе затворена.",
"ERR_FAX_HUNGUP_HINT" => "Линията се разпадна при предаването. Моля, изпратете отново факса след няколко минути.",
"ERR_FAX_INVALIDNUMBER" => "Недействителен формат на номера.",
"ERR_FAX_INVALIDNUMBER_EX" => "The number is not in a valid international number format.",
"ERR_FAX_INVALIDNUMBER_HINT" => "Въведеният факс номер е с неправилен формат. Моля, проверете факс номера и изпратете отново факса след няколко минути.",
"ERR_FAX_IN_FETCH_EXTEND_DATA" => "Error fetching number extend data",
"ERR_FAX_NOANSWER" => "Няма отговор.",
"ERR_FAX_NOANSWER_HINT" => "Моля, проверете факс номера и изпратете отново факса след няколко минути.",
"ERR_FAX_NOFAX" => "Не е факс машина.",
"ERR_FAX_NOFAX_HINT" => "Моля, проверете факс номера и изпратете отново факса след няколко минути.",
"ERR_FAX_NOT_FOUND" => "Fax not found",
"ERR_FAX_NOT_READY" => "Fax is not ready",
"ERR_FAX_PHONE_NET_OUTOFORDER" => "Неизправна телефонна мрежа",
"ERR_FAX_QUIET" => "Липсва сигнал.",
"ERR_FAX_REMOVED" => "This fax has been deleted completely, a detailed view isn't possible anymore.",
"ERR_FAX_TRANSMISSION" => "Грешка при предаване.",
"ERR_FAX_TRANSMISSION_HINT" => "Моля, изпратете отново факса след няколко минути.",
"ERR_FAX_UNALLOCATEDNUMBER" => "Неосвободен номер.",
"ERR_FAX_UNALLOCATEDNUMBER_HINT" => "Моля, проверете факс номера и изпратете отново факса след няколко минути.",
"ERR_FAX_UNKNOWN" => "Неизвестна грешка: {code}.",
"ERR_FAX_UNKNOWN_HINT" => "Моля, изпратете отново факса след няколко минути.",
"ERR_FAX_VOICEANSWER" => "Гласов секретар.",
"ERR_FAX_VOICEANSWER_HINT" => "Моля, проверете факс номера и изпратете отново факса след няколко минути.",
...
"ERR_INVALIDNUMBER" => "Недействителен номер. Моля, въведете действителен номер за международно избиране.",
...
"ERR_INVITING_USER" => "Изпращане на покана до потребителя е невъзможно.",
"ERR_INVITING_USER_ISMEMBER" => "Изпращане на покана до потребителя е невъзможно: {username} вече е член на групата или вече е бил поканен.",
"ERR_INVITING_USER_ISOWNER" => "Изпращане на покана до потребителя е невъзможно: това е вашето Скайп име. Не можете да поканите себе си.",
"ERR_INVITING_USER_NOTFOUND" => "Изпращане на покана до потребителя е невъзможно: Скайп името не е намерено. Можете да поканите само потребители, които вече са потребители на PamFax.",
...
"ERR_LOCK_001" => "От съображения за сигурност вашият профил в PamFax е временно заключен. <br />Моля, свържете се с {supportmail} за отключване на профила.",
...
"ERR_MISSING_REGENTRIES" => "Инсталирането не е завършено: липсват регистърни записи.\nМоля, инсталирайте повторно софтуера от сайта.",
"ERR_MISSING_REQUIRED" => "Please fill in all required fields",
"ERR_MISSING_RIGHT_MESSAGING" => "User may not receive any messages",
"ERR_MISSING_VALUE" => "Моля, въведете стойност.",
...
"ERR_NEGATIVE_NUMBER" => "Въвеждането на отрицателна стойност не е позволено.",
...
"ERR_NOT_A_NUMBER" => "Въведената стойност не е действително число.",
"ERR_NOT_ENOUGH_CREDIT" => "Не разполагате с достатъчно Памфакс кредит. <a href=\"{portal_url}payment/buycredit/\">Купете още Памфакс кредит</a>.",
...
"ERR_NO_CONTACT_SELECTED" => "Моля, изберете поне един получател.",
...
"ERR_PASSWORDS_DONT_MATCH" => "Паролите не съвпадат.",
"ERR_PASSWORD_EMPTY" => "Няма въведена парола.",
...
"ERR_PAYMENT_TOOLOW" => "Минималната сума е {minpayment}. Моля, изберете друг начин на плащане за въпросната сума.",
...
"ERR_SATELLITE_NUMBER" => "Опитвате да изпратите факс до сателитен номер. Изпращането на факс до такива номера не се поддържа от PamFax. Моля въведете друг факс номер и опитайте отново.",
...
"ERR_VOUCHER_EXPIRED" => "Изтекъл код „{voucher}“ на ваучера.",
"ERR_VOUCHER_INVALID" => "Недействителен код на ваучера.",
...
"INVOICE_VAT" => "{TAX}% VAT",
"INVOICE_VAT_ID" => "Номер по ДДС (в ЕС): {VAT_ID}",
"ITEM_ABOUT" => "За PamFax...",
"ITEM_COPY" => "Copy",
...
"ITEM_PORTAL" => "Портал",
"ITEM_RELOAD" => "Reload",
"ITEM_SKYPECREDIT" => "Скайп кредит",
"ITEM_SKYPE_CONTATCS" => "Skype Contacts",
"ITEM_VOUCHER" => "Осребряване на ваучер",
"ITEM_WEBSHOP" => "Е-пазаруване",
"ITEM_WEB_CONTACTS" => "Import email addresses",
"LNGFAILUREMESSAGE_CHAT" => "Здравейте, {username}, изпращането на вашия факс до {fax_recipient} чрез PamFax СЕ ПРОВАЛИ. Причина: {fail_reason}. Повече сведения ще намерите в портала (щракнете по „Портал“ от PamFax).",
...
"LNGPROGRESSMESSAGE_CHAT" => "Здравейте, {username}, вашият факс до {fax_recipient} чрез PamFax СЕ ОБРАБОТВА в момента... Ще получите друго съобщение веднага след изпращане на факса, или при възникване на грешка.",
...
"LNGSUCCESSMESSAGE_CHAT" => "Състояние на PamFax: вашият факс до {fax_recipient} чрез PamFax бе ИЗПРАТЕН УСПЕШНО. Повече сведения ще намерите в портала (щракнете по „Портал“ от клиента PamFax).\n\nИскате ли да спестите при следващото изпращане? Погледнете нашите нови предложения на www.pamfax.biz/shop.",
...
"MSG_BCP_DELETE_USER" => "Наистина ли искате да премахнете потребителя?",
...
"MSG_CHECKING_NUMBER" => "Проверка на факс номера...",
"MSG_CHECKING_NUMBERS" => "Проверка на факс номерата...",
...
"MSG_COVERTEXT_REQUIRED" => "Независимо че изпращате само корица трябва да въведете и съобщение.",
...
"MSG_CREDITS_RESTORED" => "Кредитът бе възстановен.",
"MSG_CREDIT_EXPIRATION_RESET_SUBJECT" => "PamFax Credit has been reactivated",
"MSG_CREDIT_EXPIRATION_WARNING" => "Здравейте {username}!{crlf}През последните {inactivity} дни не сте изпращал факс. Вашият кредит за факс в размер на {credit} изтича след {days_to_expiration} дни (на {expiration_date}).{crlf}Удължете периода, като изпратите факс в следващите {days_to_expiration} дни.",
...
"MSG_DOWNLOADING_UPDATE" => "Изтегляне на обновяване...",
"MSG_DUPS_REMOVED" => "Списъкът съдържа дублирани номера.<br>Същите са премахнати автоматично за избягване на допълнително оскъпяване.",
...
"MSG_FAXNUMBER_MISSING" => "Въведете факс номер",
...
"MSG_FOREIGN_COUNTRY" => "Изпращате факс до {target_country}.",
...
"MSG_GENERATING_FAX" => "Създаване на вашия факс.<br>\nМоля, изчакайте...",
...
"MSG_INVITATION_CHATPREVIEW" => "Избраните абонати ще получат следното съобщение по чата:<br><br>",
"MSG_INVITATION_CHATPREVIEW_NOTE" => "<br><br>Забележка: Съообщението се изпраща на говоримия език на абоната.",
"MSG_INVITATION_CHATTOSENDER" => "благодарим, че препоръчахте PamFax на вашите абонати: {recom_contacts}. За всеки пет, които започнат да използват PamFax, ние автоматично ще ви поощрим с кредит от {bonus} вашия профил в PamFax. Така че продължавайте да пращате факсове и да препоръчвате!",
...
"MSG_MAILRECIPIENT_MISSING" => "Въведете е-поща на получателя",
"MSG_MEMBERSHIP_ACCEPTED" => "Здравейте, {username}! {crlf}{member} прие поканата за вашия офисен контролен панел.",
"MSG_MEMBERSHIP_COMPANY_DELETED" => "Здравейте, {username}! {crlf}{owner} изтри група {group}, с което прекрати вашето членство.",
"MSG_MEMBERSHIP_DECLINED" => "Здравейте, {username}! {crlf}{member} отклони поканата за вашия офисен контролен панел.",
"MSG_MEMBERSHIP_DELETED" => "Здравейте, {username}! {crlf}{owner} прекрати членството ви в група {group}.",
"MSG_MEMBERSHIP_OWN_COMPANY" => "Здравейте, {username}! {crlf}{owner} създаде собствена група, с което прекрати членството си във вашата група.",
"MSG_MEMBERSHIP_QUIT" => "Здравейте, {username}! {crlf}{member} напусна вашия офисен контролен панел.",
"MSG_MESSAGE_FROM_PAMFAX" => "Message from PamFax",
"MSG_MULFAXNUMBERS_MISSING" => "Въведете поне един факс номер",
"MSG_NEW_INBOX_FAXES" => "You have {faxes_cnt} new faxes",
"MSG_NOCREDITS_RESTORED" => "За съжаление кредитът не бе възстановен.",
"MSG_NO_DEVICE_CONTACTS" => "No contacts found on device",
"MSG_NO_RECIPIENT" => "Няма действителни получатели",
...
"MSG_PACK_PURCHASED" => "Благодарим, че закупихте пакет за PamFax. Сумата от {creditamount} бе добавена към вашия ПамФакс профил.",
"MSG_PACK_PURCHASED_SUBJECT" => "Confirmation of your PamFax Credit purchase (Order #{order_id})",
"MSG_PACK_REFUNDED" => "Вашата покупка на пакет за PamFax Pack е изпълнена. Сумата от {creditamount} бе приспадната от вашия ПамФакс профил.",
...
"MSG_PREPARE_PREVIEW" => "Подготвяне на преглед...",
"MSG_PROPLAN_EXTENDED" => "Thank you for extending your PamFax Professional Plan with the following fax number:\n\n<b>{number}</b>\n\nfor the next {months} months. This number will expire on {expiredate}.",
"MSG_PROPLAN_PURCHASED" => "Благодарим, че закупихте професионален план за PamFax за следващите {months} месеца. Вашият абонамент изтича на {expiredate}.",
"MSG_PROPLAN_REFUNDED" => "Вашата поръчка професионален план за PamFax за {months} месеца е изпълнена. Вашият абонамент изтича на {expiredate}.",
...
"MSG_RECOMMEND_SENT" => "Поканите са изпратени успешно. Благодарим, че препоръчвате PamFax на своите абонати.",
"MSG_RECOVERY_SENT" => "Recovery instructions have been sent. Please check your email and/or Skype Chat.",
"MSG_REMINDER_1" => "Здравейте, {username}! Преди пет дни с инсталирането на PamFax получихте право да изпратите безплатен факс. Макар че досега не сте възползвал, за да опитате PamFax, моля, не забравяйте да го сторите, преди безплатната страница да изтече. И проверете за нашите абонаментни планове с отстъпки на www.pamfax.biz/shop. Благодарим!",
...
"MSG_SMSRECIPIENT_MISSING" => "Въведете получател на КС",
"MSG_SOME_INVALID_NUMBERS" => "Някои от факс номерата са недействителни.",
"MSG_SOME_UNPAID_FAXES_SENT" => "Some unpaid faxes were sent, the others remain unpaid due to insufficient credit.",
"MSG_STORING_CREDIT" => "Съхраняване на сведения за кредита...",
...
"MSG_VOUCHER_REDEEMED" => "Ваучерът с код „{voucher}“ е осребрен успешно. Сумата от {amount} е добавена ком баланса на вашия профил.",
"MSG_WAIT_DEFAULT" => "Моля, изчакайте...",
...
"SETUP_CUSTOM_AskSkypePromo" => "Благодарим, че инсталирахте {#AppName}!%n%nОт Skype редовно се предлагат изгодни промоции. Интересуват ли ви последните предложения на Skype?",
...
"SETUP_CUSTOM_openportallink" => "Портал на {#AppName}",
...
"SETUP_CUSTOM_sendfaxlink" => "Изпращане на факс от PamFax",
"SETUP_CUSTOM_sendtolink" => "Получател на {#AppName}",
"SETUP_CUSTOM_slogan" => "Изпращане на факс до всяка факс машина по света.",
...
"SETUP_CUSTOM_taskdesktopicons" => "Добави икони на работния плот",
"SETUP_CUSTOM_TASKGADGET" => "Install Windows Gadget",
"SETUP_CUSTOM_taskofficeaddin" => "Инсталирай лента с бутон в  Microsoft Office",
"SETUP_CUSTOM_TASKOUTLOOKADDIN" => "Install PamFax for Outlook",
"SETUP_CUSTOM_TASKPAMFAXZIMLET" => "Install PamFax Zimlet",
"SETUP_CUSTOM_taskprinterdriver" => "Инсталирай драйвер за печат на{#AppName}",
...
"SETUP_ENCODING" => "cp1251",
"SETUP_StatusRunProgram" => "Завършване на исталирането. Моля, изчакайте, ще отнеме няколко минути...",
...
"TITLE_BCP_DELETE" => "Изтриване на офисен контролен панел",
...
"TITLE_CONFIRMATION" => "Задължително потвърждение",
...
"TITLE_COVERPAGES" => "Корици",
"TITLE_COVER_TEXT" => "Въвеждане на съобщение",
...
"TITLE_FORMAT_ERROR" => "Грешен тип на файл",
...
"TITLE_NOTIFY" => "Настройки на уведомяване",
"TITLE_NUMBER" => "Избор на получател",
"TITLE_PAY" => "Плащане и изпращане",
...
"TITLE_PRICEWARNING" => "Обновена цена за изпращане",
"TITLE_PROFILE" => "Profile",
"TITLE_PURCHASES" => "Purchases",
"TITLE_RECOMMEND" => "Препоръчване на PamFax",
...
"TITLE_SELECT_COVER" => "Избор на корица",
...
"TXT_ACCOUNT_SAVED" => "Настройките на профила са записани успешно.",
...
"TXT_ASKVOUCHER" => "Въведете кода на ваучера",
...
"TXT_BCP_1" => "Офисният контролен панел (ОКП) на PamFax позволява да създадете групов профил и да поканите потребители в групата. Можете да разпределите Памфакс кредит и да виждате списъка с изпратените факсове. Освен това можете да зададете автоматично презареждане с кредит за всеки потребител, за да е сигурно, че всеки разполага с достатъчно кредит.",
"TXT_BCP_ACCEPT_TERMS" => "Упълномощен съм да действам от името на фирмата и приемам {link_terms} от името на фирмата и от мое име.",
"TXT_BCP_ACCOUNT_DETAILS" => "Сведения за профил",
"TXT_BCP_ADDCREDIT" => "Добавяне на Памфакс кредит",
"TXT_BCP_ADDCREDIT_1" => "Можете да заделите Памфакс кредит за потребителя. Имайте предвид, че прехвърленият кредит не може да бъде възстановен в профила на групата! Свържете се с {link_pamfax_support} в случай, че трябва да отмените прехвърлянето.",
"TXT_BCP_AUTOCREDIT" => "Auto Top-up PamFax Credit",
"TXT_BCP_COMPANY_CITY" => "п.к./град",
"TXT_BCP_COMPANY_COUTRY" => "Държава",
"TXT_BCP_COMPANY_NAME" => "Фирма",
"TXT_BCP_COMPANY_STREET" => "Адрес",
"TXT_BCP_COMPANY_VAT" => "Номер по ДДС (в ЕС)",
"TXT_BCP_CREATE" => "Създаване...",
"TXT_BCP_CREATED" => "Вашият профил с офисен контролен панел е създаден.",
"TXT_BCP_CREDIT" => "Credit",
"TXT_BCP_DELETE" => "Изтриване на ОКП...",
"TXT_BCP_FIELDS_MISSING" => "Има липсващи стойности. Моля, попълнете всички полета и се уверете, че приемате нашите условия за ползване.",
"TXT_BCP_GOTO" => "Моят ОКП",
"TXT_BCP_INVITATION_DELETED" => "The invitation to your company has been deleted",
"TXT_BCP_INVITE_1" => "Моля, въведете действително Скайп име на добавяния потребител.След добавяне на потребителя, PamFax ще изпрати съобщение с молба за потвърждение. Едва след получаване на потвърждение, потребителят ще бъде добавен към групата.",
"TXT_BCP_INVITE_USER" => "Покана на потребител",
"TXT_BCP_JOURNAL" => "Дневник",
...
"TXT_BCP_NOT_ACCEPTED" => "Изчакваща покана.",
"TXT_BCP_OWNER_FIRSTNAME" => "Име",
...
"TXT_BCP_TRANSACTIONS" => "Моите покупки",
"TXT_BCP_USERS" => "Потребители",
"TXT_BCP_USER_AUTOCREDIT" => "Автоматичен кредит",
"TXT_BCP_USER_AUTOCREDIT_MAXIMUM" => "Месечен лимит",
"TXT_BCP_USER_AUTOCREDIT_VALUE" => "Стойност на автоматичния кредит",
"TXT_BCP_USER_CREDIT" => "Памфакс кредит",
"TXT_BCP_USER_DELETED" => "Потребителят е премахнат от групата.",
"TXT_BCP_USER_DETAILS" => "Сведения за потребител",
"TXT_BCP_USER_INBOX_ACCESS" => "Inbox Access",
"TXT_BCP_USER_NAME" => "Скайп име",
"TXT_BCP_USER_STATUS" => "Състояние",
...
"TXT_BUY_IN_SHOP" => "Е-пазаруване",
"TXT_BUY_PAMFAXCREDIT" => "Купете Памфакс кредит",
...
"TXT_CANCELFAXQUESTION" => "Наистина ли искате да отмените изпращането на факса?<br />\n<br />\nФаксът няма да бъде изпратен.",
...
"TXT_CLICKTOCLOSE" => "Щракнете за затваряне",
...
"TXT_COUNTRY_CI" => "Кот Д`Ивоар",
"TXT_COUNTRY_CK" => "Острови Кук",
"TXT_COUNTRY_CL" => "Чили",
...
"TXT_COUNTRY_CU" => "Куба",
"TXT_COUNTRY_CV" => "Кабо Верде",
"TXT_COUNTRY_CW" => "Curaçao",
"TXT_COUNTRY_CX" => "Остров Рождество",
"TXT_COUNTRY_CY" => "Кипър",
"TXT_COUNTRY_CZ" => "Чехия",
"TXT_COUNTRY_DE" => "Германия",
"TXT_COUNTRY_DJ" => "Джибути",
"TXT_COUNTRY_DK" => "Дания",
"TXT_COUNTRY_DM" => "Доминика",
"TXT_COUNTRY_DO" => "Доминиканска република",
"TXT_COUNTRY_DZ" => "Алжир",
"TXT_COUNTRY_EC" => "Еквадор",
"TXT_COUNTRY_EE" => "Естония",
"TXT_COUNTRY_EG" => "Египет",
"TXT_COUNTRY_EH" => "Западна Сахара",
"TXT_COUNTRY_ER" => "Еритрея",
"TXT_COUNTRY_ES" => "Испания",
"TXT_COUNTRY_ET" => "Етиопия",
"TXT_COUNTRY_FI" => "Финландия",
"TXT_COUNTRY_FJ" => "Фиджи",
"TXT_COUNTRY_FK" => "Фолкландски острови (Малвини)",
"TXT_COUNTRY_FM" => "Федерални микронезийски щати",
"TXT_COUNTRY_FO" => "Фарьорски острови",
"TXT_COUNTRY_FR" => "Франция",
"TXT_COUNTRY_GA" => "Габон",
"TXT_COUNTRY_GB" => "Обединено кралство",
"TXT_COUNTRY_GD" => "Гренада",
"TXT_COUNTRY_GE" => "Грузия",
"TXT_COUNTRY_GF" => "Френска Гвиана",
...
"TXT_COUNTRY_GQ" => "Екваториална Гвинея",
"TXT_COUNTRY_GR" => "Гърция",
"TXT_COUNTRY_GS" => "Южна Джорджия и Южни Сандвичеви острови",
"TXT_COUNTRY_GT" => "Гватемала",
"TXT_COUNTRY_GU" => "Гуам",
"TXT_COUNTRY_GW" => "Гвинея-Бисау",
"TXT_COUNTRY_GY" => "Гаяна",
"TXT_COUNTRY_HK" => "Хонконг",
"TXT_COUNTRY_HM" => "Хърд и Макдоналд",
"TXT_COUNTRY_HN" => "Хондурас",
"TXT_COUNTRY_HR" => "Хърватия",
"TXT_COUNTRY_HT" => "Хаити",
"TXT_COUNTRY_HU" => "Унгария",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "Индонезия",
"TXT_COUNTRY_IE" => "Ирландия",
"TXT_COUNTRY_IL" => "Израел",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "Индия",
"TXT_COUNTRY_IO" => "Британска Индийска океанска територия",
"TXT_COUNTRY_IQ" => "Ирак",
"TXT_COUNTRY_IR" => "Иран",
...
"TXT_COUNTRY_JO" => "Йордания",
"TXT_COUNTRY_JP" => "Япония",
"TXT_COUNTRY_KE" => "Кения",
"TXT_COUNTRY_KG" => "Киргизстан",
"TXT_COUNTRY_KH" => "Камбоджа",
"TXT_COUNTRY_KI" => "Кирибати",
"TXT_COUNTRY_KM" => "Комори",
"TXT_COUNTRY_KN" => "Сейнт Китс и Нейвис",
"TXT_COUNTRY_KP" => "Северна Корея",
"TXT_COUNTRY_KR" => "Южна Корея",
"TXT_COUNTRY_KW" => "Кувейт",
"TXT_COUNTRY_KY" => "Кайманови острови",
"TXT_COUNTRY_KZ" => "Казахстан",
"TXT_COUNTRY_LA" => "Лаос",
"TXT_COUNTRY_LB" => "Ливан",
"TXT_COUNTRY_LC" => "Санта Лусия",
"TXT_COUNTRY_LI" => "Лихтенщайн",
...
"TXT_COUNTRY_LY" => "Либия",
"TXT_COUNTRY_MA" => "Мароко",
"TXT_COUNTRY_MC" => "Монако",
"TXT_COUNTRY_MD" => "Молдова",
"TXT_COUNTRY_ME" => "Черна гора",
"TXT_COUNTRY_MF" => "Saint Martin",
"TXT_COUNTRY_MG" => "Мадагаскар",
"TXT_COUNTRY_MH" => "Маршалови острови",
"TXT_COUNTRY_MK" => "Бивша югославска република Македония",
"TXT_COUNTRY_ML" => "Мали",
"TXT_COUNTRY_MM" => "Мианмар",
"TXT_COUNTRY_MN" => "Монголия",
"TXT_COUNTRY_MO" => "Макао",
"TXT_COUNTRY_MP" => "Северни Мариански острови",
"TXT_COUNTRY_MQ" => "Мартиника",
"TXT_COUNTRY_MR" => "Мавритания",
"TXT_COUNTRY_MS" => "Монтсерат",
"TXT_COUNTRY_MT" => "Малта",
"TXT_COUNTRY_MU" => "Мавриций",
"TXT_COUNTRY_MV" => "Малдиви",
"TXT_COUNTRY_MW" => "Малави",
"TXT_COUNTRY_MX" => "Мексико",
"TXT_COUNTRY_MY" => "Малайзия",
"TXT_COUNTRY_MZ" => "Мозамбик",
"TXT_COUNTRY_NA" => "Намибия",
"TXT_COUNTRY_NC" => "Нова Каледония",
"TXT_COUNTRY_NE" => "Нигер",
"TXT_COUNTRY_NF" => "Норфолк, остров",
"TXT_COUNTRY_NG" => "Нигерия",
"TXT_COUNTRY_NI" => "Никарагуа",
"TXT_COUNTRY_NL" => "Холандия",
"TXT_COUNTRY_NO" => "Норвегия",
"TXT_COUNTRY_NP" => "Непал",
"TXT_COUNTRY_NR" => "Науру",
"TXT_COUNTRY_NU" => "Ниуе",
"TXT_COUNTRY_NZ" => "Нова Зеландия",
"TXT_COUNTRY_OM" => "Оман",
"TXT_COUNTRY_PA" => "Панама",
"TXT_COUNTRY_PE" => "Перу",
"TXT_COUNTRY_PF" => "Френска Полинезия",
"TXT_COUNTRY_PG" => "Папуа-Нова Гвинея",
"TXT_COUNTRY_PH" => "Филипини",
"TXT_COUNTRY_PK" => "Пакистан",
"TXT_COUNTRY_PL" => "Полша",
"TXT_COUNTRY_PM" => "Сен Пиер и Микелон",
"TXT_COUNTRY_PN" => "Питкерн",
"TXT_COUNTRY_PR" => "Пуерто Рико",
"TXT_COUNTRY_PS" => "Палестинска територия",
...
"TXT_COUNTRY_RE" => "Реюнион",
"TXT_COUNTRY_RO" => "Румъния",
"TXT_COUNTRY_RS" => "Сърбия",
"TXT_COUNTRY_RU" => "Русия",
"TXT_COUNTRY_RW" => "Руанда",
"TXT_COUNTRY_SA" => "Саудитска Арабия",
"TXT_COUNTRY_SB" => "Соломонови острови",
"TXT_COUNTRY_SC" => "Сейшелски острови",
"TXT_COUNTRY_SD" => "Судан",
"TXT_COUNTRY_SE" => "Швеция",
"TXT_COUNTRY_SG" => "Сингапур",
"TXT_COUNTRY_SH" => "Света Елена",
"TXT_COUNTRY_SI" => "Словения",
"TXT_COUNTRY_SJ" => "Свалбард и Ян Майен",
"TXT_COUNTRY_SK" => "Словакия",
"TXT_COUNTRY_SL" => "Сиера Леоне",
"TXT_COUNTRY_SM" => "Сан Марино",
"TXT_COUNTRY_SN" => "Сенегал",
"TXT_COUNTRY_SO" => "Сомалия",
"TXT_COUNTRY_SR" => "Суринам",
"TXT_COUNTRY_SS" => "South Sudan",
"TXT_COUNTRY_ST" => "Сао Томе и Принсипи",
"TXT_COUNTRY_SV" => "Ел Салвадор",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Сирия",
"TXT_COUNTRY_SZ" => "Суазиланд",
"TXT_COUNTRY_TC" => "Търкс и Кайкос",
"TXT_COUNTRY_TD" => "Чад",
"TXT_COUNTRY_TF" => "Френски южни територии",
"TXT_COUNTRY_TG" => "Того",
"TXT_COUNTRY_TH" => "Тайланд",
"TXT_COUNTRY_TJ" => "Таджикистан",
"TXT_COUNTRY_TK" => "Токелау",
"TXT_COUNTRY_TL" => "Източен Тимор",
...
"TXT_COUNTRY_TW" => "Тайван",
"TXT_COUNTRY_TZ" => "Танзания",
"TXT_COUNTRY_UA" => "Украйна",
"TXT_COUNTRY_UG" => "Уганда",
"TXT_COUNTRY_UK" => "United Kingdom",
"TXT_COUNTRY_UM" => "United States Minor Outlying Islands",
"TXT_COUNTRY_US" => "Съединени щати",
"TXT_COUNTRY_US-AL" => "Alaska",
"TXT_COUNTRY_US-HI" => "Hawaii",
"TXT_COUNTRY_UY" => "Уругвай",
"TXT_COUNTRY_UZ" => "Узбекистан",
"TXT_COUNTRY_VA" => "Държава град Ватикан (Светия престол)",
"TXT_COUNTRY_VC" => "Сейнт Винсент и Гренадини",
"TXT_COUNTRY_VE" => "Венецуела",
"TXT_COUNTRY_VG" => "Вирджински острови (Великобритания)",
"TXT_COUNTRY_VI" => "U.S. Virgin Islands",
"TXT_COUNTRY_VN" => "Виетнам",
"TXT_COUNTRY_VU" => "Вануату",
"TXT_COUNTRY_WF" => "Острови Уолис и Футуна",
"TXT_COUNTRY_WS" => "Западни Самоа",
"TXT_COUNTRY_YE" => "Йемен",
"TXT_COUNTRY_YT" => "Майота",
"TXT_COUNTRY_ZA" => "Южноафриканска република",
"TXT_COUNTRY_ZM" => "Замбия",
"TXT_COUNTRY_ZW" => "Зимбабве",
"TXT_COVER" => "Корица на факс",
...
"TXT_COVERPAGE_TEXT" => "Текст на корицата",
"TXT_COVERS_RESTORED" => "Default PamFax covers have been restored",
"TXT_COVERTEXT_1" => "Въведете текст към избраната корица.",
"TXT_COVER_ADDED" => "Cover has been added",
"TXT_COVER_BASIC" => "Basic",
"TXT_COVER_CLICK_PREVIEW" => "(Щракнете по картина за преглед)",
...
"TXT_COVER_NONE" => "Без корица",
"TXT_COVER_SIMPLE" => "Simple",
"TXT_COVER_TEMPLATE" => "Шаблон за корица",
"TXT_CREATED" => "Created",
...
"TXT_CREDIT_ADDED" => "Кредитът е добавен успешно.",
...
"TXT_CREDIT_TITLE" => "ПамФакс кредит",
...
"TXT_EMAIL_RECIPIENT" => "Е-поща",
"TXT_EMAIL_SUBJECT" => "Известие за състоянието на PamFax",
...
"TXT_FACEBOOK_1" => "Приложението се инсталира във вашия профил във Facebook и при свързване със системата на портала на PamFax показва хронологията на факсовете във Facebook. Инсталирането е съвсем лесно – с едно натискане на препратката „Инсталиране“ по-долу. След инсталирането ще видите следващите стъпки във Facebook; просто добавяте приложение и сте готов. Във Facebook ще видите препратка към списъка с вашите приложения, с които можете да достъпвате хронологията на факсовете. Тя се чете направо от вашата страница в портала. В страницата ще виждате подробности за факсовете; ще изпращате нови и ще имате достъп до цялата страница в портала, както е показано по-долу.",
"TXT_FACEBOOK_2" => "Продължаваме да работим по подобряване на интегрирането и ще оценим високо вашия отзив в нашия {link_forum_direct}.",
"TXT_FACEBOOK_ADD" => "Инсталиране",
"TXT_FACEBOOK_INTRO" => "Тук можете да видите списък с вашите последни факсове.",
"TXT_FACEBOOK_WINDOW_TITLE" => "PamFax on Facebook",
"TXT_FAILED" => "Провалени",
"TXT_FAILED_RECIPIENTS" => "({failed_recipients} recipients invalid)",
"TXT_FAILUREMESSAGE_EMAIL" => "Здравейте, {username},{crlf}изпращането на вашия факс до {fax_recipient} чрез PamFax е невъзможно: {fail_reason}.{crlf}{crlf}С уважение,{crlf}Услугата PamFax",
"TXT_FAILUREMESSAGE_SMS" => "Здравейте {username},{crlf}изпращането на вашия факс до {fax_recipient} чрез PamFax е невъзможно: {fail_reason}.",
...
"TXT_FAXPRICE" => "Факсът се състои от <b>{pages} {pagename}</b> и ще струва <b>{price}</b>.",
...
"TXT_FAX_CANCEL_PENDING" => "Факсът ще бъде прекратен.",
"TXT_FAX_DELETED" => "Your fax was successfully deleted.",
"TXT_FAX_DETAILS" => "Сведения за факс",
...
"TXT_FAX_NOT_FOUND" => "Намиране на факс с това ИД {fax_id} в хронологията е невъзможно.",
"TXT_FAX_NUMBER" => "Факс номер",
...
"TXT_FILTER" => "Search...",
"TXT_FILTER_ALL" => "Всеки поддържан тип",
"TXT_FILTER_CAD" => "Документ на CAD",
"TXT_FILTER_COUNTRY" => "Filter country",
"TXT_FILTER_GENERIC" => "Вътрешно поддържан документ",
"TXT_FILTER_IMAGE" => "Картина",
"TXT_FILTER_PREFIX" => "Filter prefix",
"TXT_FILTER_PRESENTATION" => "Презентация",
"TXT_FILTER_SPREADSHEET" => "Работен лист",
"TXT_FILTER_TEXT" => "Текст",
"TXT_FILTER_WORD" => "Документ на Word",
...
"TXT_FINISHED_1" => "<b>Вашият факс се изпраща в момента.</b><br><br>Можете да проверите хода на изпълнение в {link_portal}.<br><br>Искате ли да изпратите друг факс?<br>Използвайте бутоните по-долу, за да го направите.<br><br>Благодарим ви, че използвате PamFax!",
...
"TXT_GENERAL_SETTINGS" => "Общи настройки",
"TXT_GET_IT" => "Get it on {appdirectory}",
"TXT_GOOGLESTORAGE" => "Google Drive",
"TXT_GROUP" => "Group",
"TXT_GROUPS_OVERVIEW" => "Вашето членство",
...
"TXT_INTEGRATION_BCP" => "Офисен контролен панел на PamFax",
"TXT_INTEGRATION_BCP_DESC" => "Офисният контролен панел (ОКП) на PamFax позволява да създадете групов профил и да поканите потребители в групата. Можете да разпределите Памфакс кредит и да виждате списъка с изпратените факсове. Освен това можете да зададете автоматично презареждане с кредит за всеки потребител, за да е сигурно, че всеки разполага с достатъчно кредит.",
"TXT_INTEGRATION_CLIENT" => "PamFax Application",
"TXT_INTEGRATION_FACEBOOK" => "Добавка за Facebook",
"TXT_INTEGRATION_FACEBOOK_DESC" => "Удобно интегрира портала на PamFax за достъп до хронологията на факсовете от Facebook. Можете да видите подробности за всеки факс само с едно щракване. Ако се наложи да изпратите факс, трябва само да натиснете „Изпрати факса“ и PamFax ще е в състояние да изпрати като факс всеки документ, който желаете.",
"TXT_INTEGRATION_OVERVIEW" => "Интегриране на PamFax",
"TXT_INTEGRATION_SALESFORCE" => "Добавка за Salesforce.com",
"TXT_INTEGRATION_SALESFORCE_DESC" => "Удобно интегрира портала на PamFax за достъп до хронологията на факсовете от Salesforce.com. Приложението добавя допълнителна преградка в Salesforce, от която можете да видите подробности за всеки факс. Ако се наложи да изпратите факс, трябва само да натиснете „Изпрати факса“ и PamFax ще е в състояние да изпрати като факс всеки документ, който желаете.<br>Идеално се комбинира с Лентата на Skype, поддържаща PamFax, защото ви позволява да посочите факс номер в страницата и да изпратите факс до посочения абонат.",
"TXT_INTEGRATION_SALESFORCE_GUIDELINK" => "Моля, следвайте наръчника за инсталиране.",
"TXT_INTEGRATION_SIDEBAR" => "Странична лента за Vista",
"TXT_INTEGRATION_SIDEBAR_DESC" => "Удобно интегрира портала на PamFax за достъп до хронологията на факсовете от лентата за Vista. Можете да видите подробности за всеки факс само с едно щракване. Ако се наложи да изпратите факс, трябва само да натиснете „Изпрати факса“ и PamFax ще е в състояние да изпрати като факс всеки документ, който желаете.",
...
"TXT_INVITATION_ACCEPT" => "Приеми",
"TXT_INVITATION_ACCEPT_CONFIRM" => "Приемането на поканата ще ви добави като потребител на въпросния офисен контролен панел.\n\nПриемате ли поканата?",
"TXT_INVITATION_DECLINE" => "Отклони",
"TXT_INVITATION_DECLINE_CONFIRM" => "Ако отклоните поканата, подателят ще бъде уведомен. Едва тогава ще може да ви изпрати нова покана. Наистина ли искате да отклоните поканата?",
"TXT_INVITATION_DELETE" => "Are you sure that you want to remove the invitation?",
"TXT_INVITATION_QUIT" => "Изход",
"TXT_INVITATION_QUIT_CONFIRM" => "Ако напуснете групата, ще изгубите всички предимства, които ви дава. Наистина ли искате да напуснете групата?",
...
"TXT_IS_MY_DATA_SAFE" => "Защо се изисква?",
...
"TXT_LOGIN_PASSWORD" => "Парола",
"TXT_LOGIN_STAYLOGGEDIN" => "Remember me",
"TXT_LOGIN_TITLE" => "Вписване в портала на PamFax",
"TXT_LOGIN_USERNAME" => "Скайп име",
...
"TXT_MAP_TITLE" => "Местоположение на получателя в Google карти",
"TXT_MEDIUM_PASS" => "Medium",
"TXT_MEMBER" => "Member",
"TXT_MEMBERSHIP_ACCEPTED" => "Вие приехте поканата.",
...
"TXT_MONTHLYFEE_CAPTION" => "Месечна такса:",
"TXT_MONTHS" => "Months",
...
"TXT_NOTIFICATION_SETTINGS" => "Настройки на уведомяване",
...
"TXT_NOTIFICATION_SETTINGS_UPDATED_OK" => "Настройките на уведомяване са обновени успешно!",
...
"TXT_NOVALIDFAXNUMBERLEFT" => "Всички въведени факс номера на получатели са недействителни. Моля, въведете поне един действиетелен факс номер.",
"TXT_NO_COVER" => "(изключено)",
...
"TXT_NO_DATA_FOUND" => "Няма данни за показване.",
"TXT_NO_DETAILS_FOR_OWNER" => "As this is the company owner, there are no member settings to edit.",
"TXT_NO_EMAIL_RECIPIENT" => "Моля, въведете действителен адрес за е-поща на получателя.",
...
"TXT_NO_NAME" => "No name",
"TXT_NO_PAMFAX_USER_1" => "PamFax ви позволява да изпратите факс до всяка факс машина по света на наистина ниски цени.\nИ да сте щастлив потребител на тази наистина удобна услуга!\n\nПросто инсталирайте клиента PamFax от {link_pamfax_direct} и ще можете да се присъедините към офисната група, в която сте поканен.",
"TXT_NO_PAMFAX_USER_TITLE" => "Липсва потребител на PamFax...",
"TXT_NO_REACTIVATION_REQUIRED" => "No reactivation required",
"TXT_NO_SMS_RECIPIENT" => "Моля, въведете действителен получател на КС.",
"TXT_NO_UPDATE_AVAILABLE" => "No update available",
"TXT_NUMBER_1" => "До един получател",
"TXT_NUMBER_2" => "Факс номер:",
"TXT_NUMBER_3" => "Избор на страна",
"TXT_NUMBER_4" => "Име на получател:",
"TXT_NUMBER_5" => "До множество получатели",
"TXT_NUMBER_6" => "(Въведете по един факсов номер на ред)",
"TXT_NUMBER_8" => "До кого искате да изпратите факс?",
"TXT_NUMBER_HINT" => "Въведете номер с национален или международен код",
...
"TXT_OPENWEBSHOP" => "Електронният магазин ще се зареди в нов прозорец на браузъра. Като приключите с пазаруването, съдържанието на прозореца ще се обнови веднага след обработване на вашето плащане.",
...
"TXT_PAYMENTCANCELLED" => "Вашето плащане бе отменено.<br>\n<br>\nМоля, затворете прозореца на браузъра и продължете от прозореца на факс клиента.",
"TXT_PAYMENTCANCELLED_TITLE" => "Отменено плащане",
"TXT_PAYMENT_PENDING" => "Вашето плащане е заявено. Веднага щом завърши, сумата ще се отрази във вашия Памфакс кредит.<br>\n<br>\nМожете да затворите прозореца.",
...
"TXT_PAY_3" => "Разполагате със запазен факс кредит от <b>{credit}</b>, така, че да не трябва допълнително да купувате Памфакс кредит, за да изпратите факса.<br>",
...
"TXT_PAY_SUMMARY" => "Факсът се състои от <b>{pages} {pagename}</b> и ще струва <b>{price}</b>.",
...
"TXT_PLAN_ONDEMAND" => "PamFax при поискване",
"TXT_PLAN_PRO" => "PamFax професионален",
...
"TXT_PORTAL_PASSWORD" => "Парола за портала",
...
"TXT_PORTAL_PASSWORD_REPEAT" => "Повторена парола",
...
"TXT_PRICE" => "Цена",
"TXT_PRICEWARNING_1" => "Въведените факс номера (или някои от тях) са разпознати като бавни, мобилни или като номера с добавена стойност. В случая вашият факс може да се оскъпи. Цените ще видите в долната таблица.<br /><br />\nАко все пак факсът бъде изпратен по-бързо, от предвиденото, разликата ше ви бъде възстановена.<br /><br />\nИзвиняваме се за неудобството. Натиснете „Приеми“, за да продължите.",
...
"TXT_PRICEWARNING_TAB2" => "Очаквана цена",
...
"TXT_PRINT" => "Print",
"TXT_PRIVACY" => "Изявление за поверителност",
...
"TXT_PROFILE_SAVED" => "Настройките са записани.",
...
"TXT_PROPLAN_HINT" => "<b>Потребител сте на професионален план за PamFax с преференциални цени за страница:</b> {pro_expiration}",
...
"TXT_RATE" => "Цена",
"TXT_RATES" => "Цени",
"TXT_RATES_PER_PAGE" => "Всички обявени цени са за една страница.",
...
"TXT_RECIPIENT_NAME" => "Име на получател",
"TXT_RECIPIENT_NEEDED" => "No fax number has been entered. Please enter a fax number and then click \"Send Fax\".",
"TXT_RECOMMEND" => "Препоръчайте",
"TXT_RECOMMEND_1" => "Изберете абонати. ПОказани са само тези, които още не използват PamFax.",
"TXT_RECOMMEND_2" => "Можете покана най-много до {recommend_max} абоната. От <b>{recommend_current}/{recommend_max}</b> са избрани.",
"TXT_RECOMMEND_3" => "Търсене на абонати:",
...
"TXT_REFRESH" => "Опресни",
"TXT_REFUND" => "Refund",
"TXT_REFUNDED" => "Възстановени: %1.",
"TXT_REFUNDED_ALL" => "{price} са възстановени.",
"TXT_REFUNDED_NONE" => "Няма сума за възтановяване.",
"TXT_REFUNDED_PART" => "{refunded_value} от {price} са възстановени.",
"TXT_REGION" => "Region",
...
"TXT_REGISTER_USERNAME" => "Скайп име",
...
"TXT_RESENDFAXQUESTION" => "Пускате PamFax с данните на тази заявка (файл, номер и пр.). Можете да ги смените от PamFax преди повторното изпращане на факса. Изпращане на факса?",
"TXT_RESENDING_FAX" => "Preparing to resend fax...",
"TXT_RESERVE_GENERAL" => "{img_info} <b>Изпращате факсове редовно? Купете Памфакс кредит за изпращане на факсове повече няма да се налага да плащате за всеки по отделно. Натиснете „Купете Памфакс кредит“ в горния десен ъгъл.</b>",
"TXT_RESETMESSAGE_ALREADY_SENT" => "Password reset message has already been sent.",
"TXT_RESTART_HINT" => "Обновяването не е в състояние да завърши, защото подменянето на файловете е невъзможно. Моля, пуснете повторно компютъра за завършване на инсталирането.",
"TXT_RESTOFWORLD" => "Останалият свят, мобилни, пейджъри и номера с добавена стойност.",
"TXT_RESTORE_CONNECTION" => "Server is unreachable.<br />\n\nRestoring connection to server...",
"TXT_ROTATE" => "Rotate",
"TXT_RUB" => "Russian Rubles",
"TXT_RUNTIME" => "Duration",
"TXT_SALESFORCE_1" => "Приложението се инсталира във вашия профил в Salesforce.com и при свързване със системата на портала на PamFax показва хронологията на факсовете в Salesforce.com. Инсталирането е съвсем лесно – с едно натискане на препратката „Инсталиране“ по-долу. След инсталирането ще видите следващите стъпки в Salesforce.com; просто добавяте приложение и сте готов. В Salesforce.com ще видите препратка към списъка с вашите приложения, с които можете да достъпвате хронологията на факсовете. Тя се чете направо от вашата страница в портала. В страницата ще виждате подробности за факсовете; ще изпращате нови и ще имате достъп до цялата страница в портала, както е показано по-долу.",
"TXT_SALESFORCE_ADD" => "Инсталиране",
"TXT_SALESFORCE_LOGIN" => "Вписване в Salesforce.com",
...
"TXT_SALESFORCE_TITLE" => "PamFax за SalesForce",
...
"TXT_SAVE_AS_DEFAULT" => "Запиши по подразбиране",
...
"TXT_SELECTCOVER_1" => "Изберете корица за вашия факс. Ще можете да добавите съобщение към корицата в следващата стъпка.<br><br>",
"TXT_SELECTCOVER_2" => "<br>(Щракнете двукратно за преглед)",
...
"TXT_SELECT_PLAN" => "Абонаментен план:",
...
"TXT_SENDER_COMPANY" => "Фирма",
"TXT_SENDER_DETAILS" => "Подател",
"TXT_SENDER_FAX" => "Факс номер",
"TXT_SENDER_GMAPS" => "Show sender's location in {img_google} Maps",
"TXT_SENDER_NAME" => "Име и фамилия",
...
"TXT_SEND_EMAIL_STATUS" => "Известявай за състоянието на факса по е-поща",
"TXT_SEND_FAX" => "Send a fax",
"TXT_SEND_FAX_NOW" => "Send fax now",
"TXT_SEND_MAILS_TO" => "Send emails to",
"TXT_SEND_SKYPECHAT_STATUS" => "Известявай за състоянието на факса по чата на Skype",
"TXT_SEND_SMS_STATUS" => "Известявай за успех/провал на факса в КС ({cost} за КС)",
...
"TXT_SIDEBAR_1" => "Приложението се инсталира като джаджа в лентата на Vista и се свързва със системата на портала на PamFax за показване хронологията на факсовете в преградката на PamFax. Инсталирането е съвсем лесно – с едно натискане на препратката „Инсталиране“ по-долу. След инсталирането ще видите следващите стъпки от джаджата в лентата на Vista; просто добавете приложението и сте готов. Джаджата дава обзор на изпратените факсове; можете да изпратите факс от лентата или да получите достъп до страницата на портала за допълнителни сведения.",
"TXT_SIDEBAR_2" => "Продължаваме да работим по подобряване на интегрирането и ще оценим високо вашия отзив в нашия {link_forum_direct}.",
"TXT_SIDEBAR_DOWNLOAD" => "Инсталиране",
"TXT_SIGNOUT" => "Отписване",
...
"TXT_SKYPECHAT" => "Чат по Skype",
"TXT_SKYPEDATACONNECT" => "Connecting to Skype...",
"TXT_SKYPEHANDLE" => "Skype Name:",
"TXT_SKYPELOGIN_INTRO" => "PamFax трябва да провери вашата самоличност, преди да покаже вашите данни. Моля, въведете данните си за вписване в Skype. PamFax ще ги използва еднократно само за проверка на вашата самоличност. Данните няма да бъдат съхранявани!",
"TXT_SKYPELOGIN_TITLE" => "Проверка на профил в Skype",
"TXT_SKYPELOGIN_USERNAME" => "Скайп име",
"TXT_SMS" => "Кратко съобщение (КС)",
"TXT_SMS_NOT_SENT" => "Not enough credit to send SMS to {recipient}. Text: {body}",
"TXT_SMS_PRICE" => "{sms_price} per SMS",
"TXT_SMS_RECIPIENT" => "Мобилен номер",
...
"TXT_SOURCE" => "Source",
"TXT_SPECIAL" => "Допълнителни",
"TXT_SPECIAL_OPENID" => "OpenID settings",
"TXT_SPECIAL_SETTINGS" => "Допълнителни настройки",
...
"TXT_STATE_ACCEPTED" => "Приет",
"TXT_STATE_BUSY" => "Зает",
"TXT_STATE_CANCELLED" => "Отменен",
"TXT_STATE_CANCEL_PENDING" => "Отмени изчакването",
"TXT_STATE_CLEANED_UP" => "Cleaned Up",
"TXT_STATE_CONVERTING" => "В преобразуване",
"TXT_STATE_DELAYED" => "Delayed",
"TXT_STATE_DELETED" => "Изтрит от потребителя",
"TXT_STATE_DELIVERING" => "In progress",
"TXT_STATE_DELIVERY_ERROR" => "Delivery error",
"TXT_STATE_FAILURE" => "Провален",
"TXT_STATE_HOLD" => "Задържан",
"TXT_STATE_INVALIDATED" => "Отхвърлен",
"TXT_STATE_IN_QUEUE" => "В ред за обработка",
"TXT_STATE_ONRETRY" => "В повторен опит",
"TXT_STATE_READY" => "В готовност",
"TXT_STATE_SENDING" => "В изпълнение",
"TXT_STATE_SUBMITTED" => "Предаден",
"TXT_STATE_SUCCESS" => "Изпратен",
"TXT_STATE_UNKNOWN" => "Обработван",
"TXT_STATE_UNPAID" => "Unpaid",
"TXT_STATE_UNPAYED" => "Waiting for payment",
"TXT_STATE_USER_CANCELLED" => "Прекратен от потребителя",
"TXT_STATE_USER_CANCELLED_HINT" => "Canceled by user",
"TXT_STATE_USER_CANCEL_PENDING" => "Cancel pending",
"TXT_STATE_USER_DELETED" => "Изтрит от потребителя",
"TXT_STATUS" => "Състояние",
"TXT_STATUS_DETAILS" => "Подробни сведения",
...
"TXT_SUCCESSFUL_FAXES" => "Изпратени факсове",
"TXT_SUCCESSMESSAGE_EMAIL" => "Здравейте {username},{crlf}{crlf}вашият факс до {fax_recipient} чрез PamFax бе успешно изпратен.{crlf}{crlf}Можете да прегледате хронологията на факсовете от Портал (щракнете по „Портал“ от PamFax).{crlf}{crlf}Ако искате да спестите още чрез PamFax, проверете новите ни цени на www.pamfax.biz/shop.{crlf}{crlf}Благодарим, че ползвахте услугата!{crlf}{crlf}С уважение,{crlf}Услугата PamFax",
"TXT_SUCCESSMESSAGE_SMS" => "Здравейте {username},{crlf}вашият факс до {fax_recipient} чрез PamFax бе успешно изпратен. Благодарим, че ползвахте услугата!",
"TXT_SUGGESTED_FOR_YOU" => "Recommended Download",
"TXT_SUPPORT" => "Support",
"TXT_SUPPORT_TICKET" => "Support-Ticket",
"TXT_TAB_DASHBOARD" => "Portal",
"TXT_TAB_FAXRATES" => "Цени",
"TXT_TAB_INTEGRATION" => "Инструменти",
"TXT_TAB_INTEGRATION_BCP" => "Контролен панел",
"TXT_TAB_INTEGRATION_CLIENT" => "PamFax Client",
"TXT_TAB_INTEGRATION_FACEBOOK" => "Добавка за Facebook",
"TXT_TAB_INTEGRATION_OVERVIEW" => "Обзор",
"TXT_TAB_INTEGRATION_SALESFORCE" => "Добавка за Salesforce.com",
"TXT_TAB_INTEGRATION_SIDEBAR" => "Лента за Vista",
"TXT_TAB_INVOICES" => "Print Invoice",
"TXT_TAB_MY_COMPANY" => "Settings",
"TXT_TASK" => "Task",
"TXT_TERMS" => "Условия за ползване",
...
"TXT_THANKYOU" => "Благодарим за направената поръчка!<br>\n<br>\nМоля, затворете прозореца и продължете работата си в прозореца на PamFax.",
"TXT_THANKYOU_TITLE" => "С благодарност",
"TXT_TIME" => "Time",
...
"TXT_UPDATE_DATA" => "Обнови настройките",
...
"TXT_UPDATE_HINT" => "Всички файлове са изтеглени. Желаете ли да инсталирате обновяването сега?",
...
"TXT_USER_INVITED" => "Потребителят {username} е поканен във вашия офисен контролен панел.",
"TXT_USER_NOT_FOUND" => "Няма намерен потребител.",
"TXT_USER_NOT_VALID" => "The user name you entered is not valid. Below are some suggestions for a PamFax user name:",
"TXT_USER_SAVED" => "Сведенията на потребителя са записани успешно.",
"TXT_VAT" => "VAT",
"TXT_VAT_HINT" => "+19% VAT",
"TXT_VIEW" => "Преглед",
...
"WINDOW_TITLE" => "PamFax — факс до всеки факс номер по света!",
