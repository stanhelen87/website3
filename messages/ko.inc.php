...
"TXT_COUNTRY_AD" => "안도라",
"TXT_COUNTRY_AE" => "아랍 에미리트 연방",
"TXT_COUNTRY_AF" => "아프가니스탄",
"TXT_COUNTRY_AG" => "앤티가바부다",
"TXT_COUNTRY_AI" => "앙길라",
"TXT_COUNTRY_AL" => "알바니아",
"TXT_COUNTRY_AM" => "아르메니아",
"TXT_COUNTRY_AN" => "네덜란드령 안틸레스",
"TXT_COUNTRY_AO" => "앙골라",
"TXT_COUNTRY_AQ" => "남극",
"TXT_COUNTRY_AR" => "아르헨티나",
"TXT_COUNTRY_AS" => "미국령 사모아",
"TXT_COUNTRY_AT" => "오스트리아",
"TXT_COUNTRY_AU" => "호주",
"TXT_COUNTRY_AW" => "아루바",
"TXT_COUNTRY_AX" => "Aland Islands",
"TXT_COUNTRY_AZ" => "아제르바이잔",
"TXT_COUNTRY_BA" => "보스니아 헤르체고비나",
"TXT_COUNTRY_BB" => "바베이도스",
"TXT_COUNTRY_BD" => "방글라데시",
"TXT_COUNTRY_BE" => "벨기에",
"TXT_COUNTRY_BF" => "부르키나 파소",
"TXT_COUNTRY_BG" => "불가리아",
"TXT_COUNTRY_BH" => "바레인",
"TXT_COUNTRY_BI" => "부룬디",
"TXT_COUNTRY_BJ" => "베냉",
...
"TXT_COUNTRY_BZ" => "벨리즈",
"TXT_COUNTRY_CA" => "캐나다",
"TXT_COUNTRY_CC" => "코코스 (킬링) 제도",
"TXT_COUNTRY_CD" => "콩고 민주 공화국",
"TXT_COUNTRY_CF" => "중앙아프리카공화국",
"TXT_COUNTRY_CG" => "콩고",
"TXT_COUNTRY_CH" => "스위스",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "코트디부와르",
"TXT_COUNTRY_CK" => "쿡 제도",
"TXT_COUNTRY_CL" => "칠레",
"TXT_COUNTRY_CM" => "카메룬",
"TXT_COUNTRY_CN" => "중국",
...
"TXT_COUNTRY_CR" => "코스타리카",
"TXT_COUNTRY_CS" => "Serbia and Montenegro",
"TXT_COUNTRY_CU" => "쿠바",
"TXT_COUNTRY_CV" => "카보베르데",
"TXT_COUNTRY_CW" => "Curaçao",
"TXT_COUNTRY_CX" => "크리스마스 섬",
"TXT_COUNTRY_CY" => "키프로스",
"TXT_COUNTRY_CZ" => "체코 공화국",
"TXT_COUNTRY_DE" => "독일",
"TXT_COUNTRY_DJ" => "지부티",
"TXT_COUNTRY_DK" => "덴마크",
"TXT_COUNTRY_DM" => "도미니카",
"TXT_COUNTRY_DO" => "도미니카 공화국",
"TXT_COUNTRY_DZ" => "알제리아",
"TXT_COUNTRY_EC" => "에쿠아도르",
"TXT_COUNTRY_EE" => "에스토니아",
"TXT_COUNTRY_EG" => "이집트",
"TXT_COUNTRY_EH" => "서부 사하라",
"TXT_COUNTRY_ER" => "에리트레아",
"TXT_COUNTRY_ES" => "스페인",
"TXT_COUNTRY_ET" => "에티오피아",
"TXT_COUNTRY_FI" => "핀란드",
"TXT_COUNTRY_FJ" => "피지",
"TXT_COUNTRY_FK" => "포크랜드 군도(말비나스)",
"TXT_COUNTRY_FM" => "마이크로네시아 연합국",
"TXT_COUNTRY_FO" => "페로우 군도",
"TXT_COUNTRY_FR" => "프랑스",
"TXT_COUNTRY_GA" => "가봉",
"TXT_COUNTRY_GB" => "영국",
"TXT_COUNTRY_GD" => "그레나다",
"TXT_COUNTRY_GE" => "조지아",
"TXT_COUNTRY_GF" => "프랑스령 가이아나",
...
"TXT_COUNTRY_GN" => "기니",
"TXT_COUNTRY_GP" => "과들루프",
"TXT_COUNTRY_GQ" => "적도 기니",
"TXT_COUNTRY_GR" => "그리스",
"TXT_COUNTRY_GS" => "사우스 조지아/사우스 샌드위치 제도",
"TXT_COUNTRY_GT" => "과테말라",
"TXT_COUNTRY_GU" => "괌",
"TXT_COUNTRY_GW" => "기니비사우",
"TXT_COUNTRY_GY" => "가이아나",
"TXT_COUNTRY_HK" => "홍콩",
"TXT_COUNTRY_HM" => "허드 및 맥도날드 군도",
"TXT_COUNTRY_HN" => "온두라스",
"TXT_COUNTRY_HR" => "크로아티아",
"TXT_COUNTRY_HT" => "하이티",
"TXT_COUNTRY_HU" => "헝가리",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "인도네시아",
"TXT_COUNTRY_IE" => "아일랜드",
"TXT_COUNTRY_IL" => "이스라엘",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "인도",
"TXT_COUNTRY_IO" => "영국령 인도양 식민지",
"TXT_COUNTRY_IQ" => "이라크",
"TXT_COUNTRY_IR" => "이란",
"TXT_COUNTRY_IS" => "아이슬란드",
"TXT_COUNTRY_IT" => "이탈리아",
...
"TXT_COUNTRY_KI" => "키리바시",
"TXT_COUNTRY_KM" => "코모로",
"TXT_COUNTRY_KN" => "세인트키츠네비스",
"TXT_COUNTRY_KP" => "북한",
"TXT_COUNTRY_KR" => "대한민국",
"TXT_COUNTRY_KW" => "쿠웨이트",
"TXT_COUNTRY_KY" => "케이맨 군도",
"TXT_COUNTRY_KZ" => "카자흐스탄",
"TXT_COUNTRY_LA" => "라오스",
"TXT_COUNTRY_LB" => "레바논",
"TXT_COUNTRY_LC" => "세인트 루치아",
"TXT_COUNTRY_LI" => "리히텐슈타인",
"TXT_COUNTRY_LK" => "스리랑카",
"TXT_COUNTRY_LR" => "라이베리아",
"TXT_COUNTRY_LS" => "레소토",
"TXT_COUNTRY_LT" => "리투아니아",
"TXT_COUNTRY_LU" => "룩셈부르크",
"TXT_COUNTRY_LV" => "라트비아",
"TXT_COUNTRY_LY" => "리비아",
"TXT_COUNTRY_MA" => "모로코",
"TXT_COUNTRY_MC" => "모나코",
"TXT_COUNTRY_MD" => "몰도바",
"TXT_COUNTRY_ME" => "몬테네그로",
"TXT_COUNTRY_MF" => "Saint Martin",
"TXT_COUNTRY_MG" => "마다가스카르",
"TXT_COUNTRY_MH" => "마셜 제도",
"TXT_COUNTRY_MK" => "마케도니아",
"TXT_COUNTRY_ML" => "말리",
"TXT_COUNTRY_MM" => "미얀마",
"TXT_COUNTRY_MN" => "몽골",
"TXT_COUNTRY_MO" => "마카오",
"TXT_COUNTRY_MP" => "북 마리아나 제도",
"TXT_COUNTRY_MQ" => "마르티니크",
"TXT_COUNTRY_MR" => "모리타니아",
"TXT_COUNTRY_MS" => "몬트세라트",
"TXT_COUNTRY_MT" => "몰타",
"TXT_COUNTRY_MU" => "모리셔스",
"TXT_COUNTRY_MV" => "몰디브",
"TXT_COUNTRY_MW" => "말라위",
"TXT_COUNTRY_MX" => "멕시코",
"TXT_COUNTRY_MY" => "말레이시아",
"TXT_COUNTRY_MZ" => "모잠비크",
"TXT_COUNTRY_NA" => "나미비아",
"TXT_COUNTRY_NC" => "뉴 칼레도니아",
"TXT_COUNTRY_NE" => "니제르",
"TXT_COUNTRY_NF" => "노퍽 제도",
"TXT_COUNTRY_NG" => "나이제리아",
"TXT_COUNTRY_NI" => "니카라과",
"TXT_COUNTRY_NL" => "네덜란드",
"TXT_COUNTRY_NO" => "노르웨이",
"TXT_COUNTRY_NP" => "네팔",
...
"TXT_COUNTRY_PA" => "파나마",
"TXT_COUNTRY_PE" => "페루",
"TXT_COUNTRY_PF" => "프랑스령 폴리네시아",
"TXT_COUNTRY_PG" => "파푸아뉴기니",
"TXT_COUNTRY_PH" => "필리핀",
"TXT_COUNTRY_PK" => "파키스탄",
"TXT_COUNTRY_PL" => "폴란드",
"TXT_COUNTRY_PM" => "성 피에르 및 미클롱",
"TXT_COUNTRY_PN" => "핏케언",
"TXT_COUNTRY_PR" => "푸에르토리코",
"TXT_COUNTRY_PS" => "팔레스타인 영토",
"TXT_COUNTRY_PT" => "포르투갈",
...
"TXT_COUNTRY_RU" => "러시아",
"TXT_COUNTRY_RW" => "르완다",
"TXT_COUNTRY_SA" => "사우디 아라비아",
"TXT_COUNTRY_SB" => "솔로몬 제도",
"TXT_COUNTRY_SC" => "세이셸",
"TXT_COUNTRY_SD" => "수단",
"TXT_COUNTRY_SE" => "스웨덴",
"TXT_COUNTRY_SG" => "싱가포르",
"TXT_COUNTRY_SH" => "세인트 헬레나",
"TXT_COUNTRY_SI" => "슬로베니아",
"TXT_COUNTRY_SJ" => "스발바드 및 얀마옌",
"TXT_COUNTRY_SK" => "슬로바키아",
"TXT_COUNTRY_SL" => "시에라리온",
"TXT_COUNTRY_SM" => "산마리노",
"TXT_COUNTRY_SN" => "세네갈",
"TXT_COUNTRY_SO" => "소말리아",
"TXT_COUNTRY_SR" => "수리남",
"TXT_COUNTRY_SS" => "South Sudan",
"TXT_COUNTRY_ST" => "상투메 프린시페",
"TXT_COUNTRY_SV" => "엘살바도르",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "시리아",
"TXT_COUNTRY_SZ" => "스와질란드",
"TXT_COUNTRY_TC" => "터크스 앤드 카이코스 제도",
"TXT_COUNTRY_TD" => "차드",
"TXT_COUNTRY_TF" => "프랑스령 남부 영토",
"TXT_COUNTRY_TG" => "토고",
"TXT_COUNTRY_TH" => "태국",
"TXT_COUNTRY_TJ" => "타지키스탄",
"TXT_COUNTRY_TK" => "토켈라우",
"TXT_COUNTRY_TL" => "티모르-레스테",
"TXT_COUNTRY_TM" => "투르크메니스탄",
"TXT_COUNTRY_TN" => "튀니지",
"TXT_COUNTRY_TO" => "통가",
"TXT_COUNTRY_TR" => "터키",
"TXT_COUNTRY_TT" => "트리니다드 토바고",
"TXT_COUNTRY_TV" => "투발루",
"TXT_COUNTRY_TW" => "대만",
"TXT_COUNTRY_TZ" => "탄자니아",
"TXT_COUNTRY_UA" => "우크라이나",
"TXT_COUNTRY_UG" => "우간다",
...
"TXT_COUNTRY_UY" => "우루과이",
"TXT_COUNTRY_UZ" => "우즈베키스탄",
"TXT_COUNTRY_VA" => "바티칸 시(교황청)",
"TXT_COUNTRY_VC" => "세인트 빈센트 그레나딘",
"TXT_COUNTRY_VE" => "베네수엘라",
"TXT_COUNTRY_VG" => "영국령 버진 제도",
"TXT_COUNTRY_VI" => "U.S. Virgin Islands",
"TXT_COUNTRY_VN" => "베트남",
"TXT_COUNTRY_VU" => "바누아투",
"TXT_COUNTRY_WF" => "월리스 푸투나",
"TXT_COUNTRY_WS" => "사모아",
"TXT_COUNTRY_YE" => "예멘",
"TXT_COUNTRY_YT" => "마요테",
"TXT_COUNTRY_ZA" => "남아프리카",
"TXT_COUNTRY_ZM" => "잠비아",
"TXT_COUNTRY_ZW" => "짐바브웨",
"TXT_COVER" => "Fax cover",
