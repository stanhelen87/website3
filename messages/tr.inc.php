...
"BTN_ACCEPT" => "Kabul Et",
"BTN_ACQUIRE" => "Belge tara",
"BTN_ACTIONS" => "Actions",
"BTN_ADD" => "Ekle",
"BTN_ADD_CONTACT" => "Add contact",
"BTN_ADD_CONTACTS_TO_GROUP" => "Add to group",
"BTN_ADD_CONTENT" => "Fax content",
"BTN_ADD_FAXNUMBER" => "Numara ekle",
"BTN_ADD_FILES" => "Add files...",
"BTN_ADD_MORE_FAX_FILES" => "Daha fazla dosya(lar) ekle",
"BTN_ADD_RECIPIENTS" => "Fax recipients",
"BTN_AUTHORIZE" => "Yetkilendir",
"BTN_BACK" => "Geri",
"BTN_BACKUP" => "Yedekle",
"BTN_BCP_CREATE" => "Şirket Hesabı Oluştur",
"BTN_BCP_TRANSFER" => "Transfer",
"BTN_BROWSE" => "Browse",
"BTN_BUY_CREDIT" => "Kontör Satın Al",
"BTN_BUY_CREDIT_PACK" => "{pack} Satın Al",
"BTN_BUY_EXTEND_NUMBER" => "Buy/Extend Number",
"BTN_BUY_FAX_IN_NOW" => "Hemen bir fax-in numarası satın al",
"BTN_BUY_INBOX" => "Bir faks numarası satın al",
"BTN_BUY_NOW" => "HEMEM SATIN AL",
"BTN_BUY_PAMFAX_CREDIT" => "Buy PamFax Credit",
"BTN_CANCEL" => "İptal et",
"BTN_CANCELFAX" => "Faksı iptal et",
"BTN_CANCELFAX_GROUP" => "Tümünü iptal et",
"BTN_CANCEL_UPLOADS" => "Tüm gönderimleri iptal et",
"BTN_CHANGE_LOGIN_USERNAME" => "Kullanıcı Adını Değiştir",
"BTN_CHANGE_NUMBER" => "Numarayı değiştir",
"BTN_CHANGE_PASSWORD" => "Parolayı Değiştir",
"BTN_CLONE" => "Çoğalt",
"BTN_CLOSE" => "PamFax'dan Çık",
"BTN_CONFIRM" => "Onayla",
"BTN_CONTACTS_DELGROUP" => "Delete group",
"BTN_CONTINUE" => "Devam et",
"BTN_COVER" => "Cover",
"BTN_COVERPAGES" => "Kapak sayfaları",
"BTN_DELETE" => "Sil",
"BTN_DELETEFAX" => "Sil",
"BTN_DELETEFAX_FROM_TRASH" => "Kalıcı olarak sil",
"BTN_DELETEFAX_GROUP" => "Tümünü sil",
"BTN_DELETE_PAMFAX_ACCOUNT" => "PamFax hesabını sil",
"BTN_DEL_CONTACTS" => "Delete",
"BTN_DEL_CONTACTS_FROM_GROUP" => "Remove from group",
"BTN_DEL_COVER" => "Delete",
"BTN_DOWNLOAD" => "İNDİR",
"BTN_DOWNLOAD_CLIENT" => "PamFax'ı indir",
"BTN_DROP_AUTH" => "Sağlayıcıyı kaldır",
"BTN_EDIT" => "Düzenle",
"BTN_EDIT_MESSAGE" => "Mesajı düzenle",
"BTN_EMAIL_EXAMPLE" => "Örnek e-posta",
"BTN_EMPTY_TRASH" => "Çöpü boşalt",
"BTN_EXAMPLE" => "Yazılı mesaj örneği",
"BTN_FAX_READY" => "Next",
"BTN_FAX_TO_CONTACTGROUP" => "Start fax to group",
"BTN_FAX_TO_CONTACTS" => "Send fax",
"BTN_FIT_SCREEN" => "Fit screen",
"BTN_FOLLOW" => "PamFax'ı takip et",
"BTN_FULL_SIZE" => "Full size",
"BTN_GADGET_SEND" => "Gönder",
"BTN_GET_A_FAXNUMBER" => "Bir faks numarası al",
"BTN_GET_STARTED_NOW" => "Get started now",
"BTN_IMPORT_CONTACTS" => "Import",
"BTN_INBOX" => "Gelen kutusu",
"BTN_INVITE" => "Bir kullanıcı davet et",
"BTN_INVITE_SUBMIT" => "Davetiye gönder",
"BTN_IRREVERSIBLE_DELETE_PAMFAX_ACCOUNT" => "PamFax hesabımı sil",
"BTN_LATER" => "Daha sonra",
"BTN_LIKE" => "PamFax'ı Beğen!",
"BTN_LOCALIZATION" => "Yerelleştir",
"BTN_LOGIN" => "Giriş",
"BTN_LOGINSETTINGS" => "Giriş",
"BTN_LOGIN_SUBMIT" => "Giriş",
"BTN_MANY_RECIPIENTS" => "Send a mass fax",
"BTN_MARK_AS_READ" => "Okundu olarak işaretle",
"BTN_MEMBERSHIPS" => "Üyelikler",
"BTN_MERGE_ACCOUNT" => "Hesapları birleştir",
"BTN_MORE_INFORMATION" => "Daha fazla bilgi göster",
"BTN_MY_COMPANY_ACCOUNT_DETAILS" => "Şirket Ayrıntıları",
"BTN_MY_COMPANY_CREATE" => "Bir Şirket hesabı oluştur",
"BTN_MY_COMPANY_EMPLOYEES" => "Çalışanlar",
"BTN_MY_COMPANY_JOURNAL" => "Günlük",
"BTN_MY_CONTACTS" => "Contacts",
"BTN_MY_ORDERS" => "Siparişler",
"BTN_MY_TRANSACTIONS" => "Transactions",
"BTN_NEVER" => "Asla",
"BTN_NEW_FAX" => "Yeni faks",
"BTN_NEXT" => "İleri",
"BTN_NO" => "Hayır",
"BTN_NOTIFICATIONS" => "Bildirimler",
"BTN_NOT_SPAM" => "Spam değil",
"BTN_OK" => "TAMAM",
"BTN_ONLINE_STORAGE" => "Çevrimiçi Belgeler",
"BTN_OPEN_CONTACTS" => "Show contacts",
"BTN_OPEN_PORTAL" => "Portalı Aç",
"BTN_OUTBOX" => "Giden kutusu",
"BTN_PAY" => "Ödemeyi başlat",
"BTN_PAY_EXACT" => "{price} Kontör Satın Al",
"BTN_PAY_LATER" => "Daha sonra öde",
"BTN_PAY_N_SEND" => "Öde & Gönder",
"BTN_PLAN" => "Plan",
"BTN_PORTAL" => "Portal",
...
"BTN_RATES" => "Fiyat listesi",
"BTN_RECOMMEND" => "Öner",
"BTN_RECOMMEND_SKIP" => "Devam et",
"BTN_RECOMMEND_SUBMIT" => "Öner",
"BTN_RECONNECT_AUTH" => "Reconnect",
"BTN_RECOVER" => "Recover",
"BTN_REDEEM_VOUCHER" => "Redeem voucher",
"BTN_REGISTER_SUBMIT" => "Hesap oluştur",
"BTN_REINVITE" => "Yeniden davet et",
"BTN_REPORT_AS_SPAM" => "Spam olarak bildir",
"BTN_REPORT_SPAM" => "Spam bildir",
"BTN_RESENDFAX" => "Tekrar gönder",
"BTN_RESTART" => "PamFax'ı yeniden başlat",
"BTN_RESTOREFAX" => "Faksı geri yükle",
"BTN_RESTORE_COVERS" => "Restore default covers",
"BTN_RETRY" => "Retry",
"BTN_SAVE" => "Kaydet",
"BTN_SCAN" => "Scan",
"BTN_SCHEDULE" => "Schedule",
"BTN_SELECT_ANOTHER_FILE" => "Başka bir dosya seç",
"BTN_SELECT_FILE" => "Belge(ler)",
"BTN_SELECT_FILE_2" => "Select file",
"BTN_SEND" => "Faks Gönder",
"BTN_SENDASFAX" => "Faks olarak gönder",
"BTN_SEND_ANOTHER" => "Başka bir faks gönder",
"BTN_SEND_CONFIRMATION_CHAT" => "Onaylama kodu gönder",
"BTN_SEND_DELAYED_NOW" => "Şimdi faks gönder",
"BTN_SEND_FAX" => "Hayır, sadece faks göndermek istiyorum",
"BTN_SEND_NOW" => "Send Now",
"BTN_SEND_UNPAID" => "Ödenmemiş faks(lar)ı şimdi gönder",
"BTN_SENT" => "Gönderildi",
"BTN_SETTINGS" => "Settings",
"BTN_SHARE" => "Share",
"BTN_SHOW_GOOGLE_MAP" => "Alıcının konumunu {img_google} Maps üzerinde göster",
"BTN_SIGNUP_NOW" => "HEMEN KAYIT OL",
"BTN_SIGN_UP" => "Kayıt ol",
"BTN_SIGN_UP_FOR_FAX_IN" => "Hemen 3 aylık ücretsiz deneme için kayıt ol",
"BTN_SIMPLE_RECIPIENTS" => "Enter recipients one by one",
"BTN_SKIP" => "Geç",
"BTN_SND_NOW" => "Ücretsiz faks gönder",
"BTN_START_EXPORT" => "Dışa aktarımı başlat",
"BTN_START_FIRST_FAX" => "Hemen ilk faksımı gönder",
"BTN_START_IMPORT" => "Import",
"BTN_START_NEW_FAX" => "Hemen bir faks gönder",
"BTN_START_NOW" => "Start Now",
"BTN_START_UPDATE" => "Güncellemeyi başlat",
"BTN_TAB_BCP" => "Şirket Yöneticisi",
"BTN_TAB_CONTACTS" => "Contacts",
"BTN_TAB_DASHBOARD" => "Gösterge Paneli",
"BTN_TAB_HISTORY" => "Fakslar",
"BTN_TAB_INBOX" => "Gelen kutusu",
"BTN_TAB_MY_ACCOUNT" => "Hesap",
"BTN_TAB_MY_COMPANY" => "Şirket Yöneticisi",
"BTN_TAB_MY_FAXES" => "Fakslar",
"BTN_TAB_PAYMENT" => "Ödeme",
"BTN_TAB_RATES" => "Ödeme",
"BTN_TAB_SEND" => "Faks Gönder",
"BTN_TAB_SETTINGS" => "Ayarlar",
"BTN_TEST_FAX_IN" => "Evet, faks almakta istiyorum",
"BTN_TEXT_ONLY" => "Bie Kapak Sayfası gönder",
"BTN_TRANSMISSION_REPORT" => "Aktarım Raporu",
"BTN_TRASH" => "Çöp",
"BTN_TWEET" => "Tweet",
"BTN_UNLINK" => "Unlink",
"BTN_UNPAID" => "Ödenmemiş",
"BTN_UNPUBLISH" => "Unpublish",
"BTN_UP" => "Up",
"BTN_UPDATE_LATER" => "Hayır, daha sonra güncelle",
"BTN_UPLOAD_FILES" => "Local file(s)",
"BTN_USE_COVER" => "Use as cover",
"BTN_VALIDATE" => "Doğrula",
"BTN_VERIFY" => "Onayla",
"BTN_VIEW" => "View",
"BTN_VIEW_FAX" => "View my fax",
"BTN_WEBSITE" => "Web sitesi",
"BTN_WEB_CONTACTS_SUBMIT" => "Sonraki",
"BTN_YES" => "Evet",
"BTN__PROPLAN_LANDING" => "Bir faks numarası sipariş et",
...
"ERR_ACCEPT_MEMBERSHIP" => "Üyeliğe kabul edeken hata oluştu",
"ERR_ACCEPT_TERMS" => "Lütfen kullanım koşullarını kabuledin",
"ERR_ACCESS_DENIED" => "Bu faks için yapmak istediğiniz şey reddedildi.",
"ERR_ADDRESS_FIELD_MISSING" => "Aşağıdaki alanlar eksik",
"ERR_ADDRESS_FIELD_TOO_BIG" => "Maximum length for address field is 60 symbols. Please shorten the address and try again.",
"ERR_ADDRESS_INVALID" => "Girdiğiniz adres, seçili faks numarasını etkinleştirmek için geçerli değil.\nYa seçili alan kodu/ülke için geçerli bir adres girin ya da başka bir faks numarası alan kodu/ülke seçin.",
"ERR_ADDRESS_NOT_VALID_FOR_ORDER" => "Yukarıda girilmiş kişisel adresiniz, seçili şehir/ülke'den bir faks numarası almak için geçersiz.\nLütfen satın almak istediğiniz numara ile eşleşen geçerli bir sokak adresi girin.<br>\nSeçili ülkenin yerel kanunları, numarayı etkinleştirmek için geçerli bir adres gerektiriyor.",
"ERR_ADDRESS_VALIDATION_ERROR" => "Adres doğrulama başarısız",
"ERR_ALREADY_HAVE_SKYPE_CONNECTED" => "Zaten PamFax profilinize bağlanmış bire Skype hesabınız var. Eğer bir başka hesabı kullanmak istiyorsanız, önce mevcut hesabınızı silmelisiniz.",
"ERR_AREA_CODE_EMPTY" => "Area code was not set. Please, select country and area code for Fax number",
"ERR_AUTHENTICATION_EXPIRED" => "Yetkilendirme süresi doldu. Lütfen hesabınızı PamFax'a yeniden bağlayın.",
"ERR_BAD_COVER_FILE" => "Invalid cover file. Please upload Word documents in docx format only.",
"ERR_BAD_CURRENCY" => "Geçersiz para birimi",
"ERR_BAD_EMAIL" => "E-posta bulunamadı",
"ERR_BAD_FILE" => "Göndermeye çalıştığınız dosya biçimi desteklenmiyor. Lütfen bu dosyayı desteklenen bir dosya biçiminde kaydedin ve tekrar deneyin. <br>Ayrıntılı bilgi için: {link_faq_1}",
"ERR_BAD_IDENTIFIER_TYPE" => "Kimlik-Türü desteklenmiyor",
"ERR_BAD_PARAM_GIVEN" => "Verilen değer geçersiz",
"ERR_BAD_PASSWORD" => "Geçersiz Parola: Parola 8 ile 20 karakter uzunluğunda olmalı, PamFax kullanıcı adınız olmamalı ve en az 2 özel karakter veya numara içermelidir.",
"ERR_BAD_PROPERTY" => "Özellik mevcut değil",
"ERR_BAD_RESPONSE" => "Error while processing provider response.",
"ERR_BAD_USERNAME" => "Hata: Kullanıcı adı eşsiz ve 6 ile 60 karakter uzunluğunda olmalı, özel karakterleri (ör: &%) içermemelidir.",
"ERR_BYFAX_BUSY" => "Busy",
...
"ERR_CHANGE_PASSWORD" => "Parolanız değiştirilemiyor. Lütfen tekrar deneyin.",
"ERR_CHANGE_USERNAME" => "Kullanıcı adınız değiştirilemiyor. Lütfen tekrar deneyin.",
"ERR_COMPANY_DATA_INCOMPLETE" => "Veri girişi tamamlanmadı: Lütfen tüm gerekli alanları doldurun",
"ERR_COMPANY_NOT_SAVED" => "Şirket hesabı oluşturma hatası",
...
"ERR_CONVERSION" => "Dosya dönüştürülürken hata oluştu: %1.<br><br>Lütfen belgeyi farklı bir biçimde kaydedin ve daha sonra tekrar deneyin.",
"ERR_CONVERSION_CALCPAGES" => "Lütfen bu dosyayı uygun uygulama ile açın ve PamFax yazıcısından çıktı alın.",
"ERR_CONVERSION_COMPILEFAX" => "Faks hazırlanırken bir hata oluştu. Lütfen tekrar deneyin.",
"ERR_CONVERSION_CONVERT" => "Dosya dönüştürülemiyor. Lütfen belgeyi farklı bir biçimde kaydedin ve daha sonra tekrar deneyin.",
"ERR_CONVERSION_COVER" => "Kapak dosyası oluşturulamıyor",
"ERR_COUNTRIES_NOT_FOUND" => "Countries not found",
"ERR_COUNTRY_HAS_NO_STATES" => "Bu ülkenin eyaleti yok",
"ERR_CREATING_PREVIEW" => "Önizleme oluşturma hatası",
"ERR_CREATING_USER" => "Kullanıcı oluşturma hatası",
"ERR_CURRENT_PASSWORD_REQUIRED" => "Mevcut parolanız gerekli",
"ERR_CURRENT_PASSWORD_WRONG" => "Girdiğiniz \"mevcut parola\" değeri hatalı",
"ERR_DATE_REQUIRED" => "Please select a date",
"ERR_DECLINE_MEMBERSHIP" => "Üyelik reddetme hatası",
"ERR_DELETE_ACCOUNT" => "Hesabınız silinemiyor: Lütfen tekrar deneyin",
"ERR_DELETE_MEMBERSHIP" => "Üyelik silme hatası",
...
"ERR_DOWNLOAD_FAILED" => "Dosya indirimi başarısız oldu.",
...
"ERR_EMAIL_CONFIRM_MISMATCH" => "E-posta adres doğrulaması başarısız. Lütfen e-posta adresini tekrar girin.",
"ERR_EMAIL_REQUIRED" => "E-posta adresi gerekli",
"ERR_EMPTY_SENDER" => "Bu fax, spam olarak bildirilemiyor çünkü gönderen bilinmiyor.",
"ERR_ENOUGH_CREDIT" => "Yeterli kontörünüz var. Faksınızı hemen gönderin.",
...
"ERR_FAX_10024" => "Yanıt yok",
"ERR_FAX_10025" => "Faks makinesi değil",
"ERR_FAX_23073" => "Sesli yanıt",
"ERR_FAX_23441" => "Ayrılmamış numara",
"ERR_FAX_23443" => "Erişilmez gönderim yeri",
"ERR_FAX_23468" => "Geçersiz numara biçimi",
"ERR_FAX_BADLINE" => "Bozuk faks hattı",
"ERR_FAX_BADLINE_HINT" => "Lütfen bir kaç dakika içinde faksı tekrar göndermeyi deneyin.",
"ERR_FAX_BUSY" => "Numara sürekli meşgul",
"ERR_FAX_BUSY_HINT" => "Lütfen faks numarasını kontrol edin ve bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_CONVERSION_FAILED" => "Belge dönüştürülürken hata oluştu",
"ERR_FAX_CONVERSION_FAILED_HINT" => "Belge dönüştürme başarısız oldu",
"ERR_FAX_DELIVERY_FAILED" => "Faks teslim hatası",
"ERR_FAX_DESTOUTOFORDER" => "Karşı taraf çalışmıyor",
"ERR_FAX_DESTUNREACHABLE" => "Varış yeri ulaşılmaz",
"ERR_FAX_DESTUNREACHABLE_HINT" => "Lütfen faks numarasının doğru olduğunu kontrol edin.",
"ERR_FAX_DEST_DOESNT_SUPPORT_FAX" => "Karşı tarafın faks desteği yok",
"ERR_FAX_DIALING" => "Faks aktarımında hata oluştu",
"ERR_FAX_DIALING_HINT" => "Numara aranamadı. Lütfen faks numarasını kontrol edin ve bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_DRIVERPROBLEM" => "Faks aktarımında hata oluştu",
"ERR_FAX_DRIVERPROBLEM_HINT" => "Bu bir sunucu sorunudur. Lütfen bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_EXISTS" => "Faks var",
"ERR_FAX_FAXCONN_NOT_SUCCESSFUL" => "Faks bağlantısı başarılı değil",
"ERR_FAX_FILES_EXISTING" => "Some file(s) already exist in fax",
"ERR_FAX_HUNGUP" => "Hat düştü",
"ERR_FAX_HUNGUP_HINT" => "Gönderim sırasında hat düştü. Lütfen bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_INVALIDNUMBER" => "Geçersiz numara biçimi",
"ERR_FAX_INVALIDNUMBER_EX" => "Numara, geçerli bir uluslararası numara biçiminde değil.",
"ERR_FAX_INVALIDNUMBER_HINT" => "Girilen faks numarası geçersiz bir biçimde. Lütfen faks numarasını kontrol edin ve bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_IN_FETCH_EXTEND_DATA" => "Error fetching number extend data",
"ERR_FAX_NOANSWER" => "Yanıt yok",
"ERR_FAX_NOANSWER_HINT" => "Lütfen faks numarasını kontrol edin ve bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_NOFAX" => "Bir faks cihazı değil",
"ERR_FAX_NOFAX_HINT" => "Lütfen faks numarasını kontrol edin ve bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_NOT_FOUND" => "Faks bulunamadı",
"ERR_FAX_NOT_READY" => "Faks hazır değil",
"ERR_FAX_PHONE_NET_OUTOFORDER" => "Telefon ağı çalışmıyor",
"ERR_FAX_QUIET" => "Sinyal yok.",
"ERR_FAX_REMOVED" => "Bu faks tamamen silindi, ayrıntılı görünüm artık mümkün değil.",
"ERR_FAX_TRANSMISSION" => "Faks aktarımında hata oluştu",
"ERR_FAX_TRANSMISSION_HINT" => "Lütfen bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_UNALLOCATEDNUMBER" => "Ayrılmamış numara",
"ERR_FAX_UNALLOCATEDNUMBER_HINT" => "Lütfen faks numarasını kontrol edin ve bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_UNKNOWN" => "Blinmeyen hata: {code}",
"ERR_FAX_UNKNOWN_HINT" => "Lütfen bir kaç dakika içinde faksı tekrar gönderin.",
"ERR_FAX_VOICEANSWER" => "Sesli yanıt",
"ERR_FAX_VOICEANSWER_HINT" => "Lütfen faks numarasını kontrol edin ve bir kaç dakika içinde faksı tekrar gönderin.",
...
"ERR_FIRSTNAME_REQUIRED" => "Ad gerekli",
"ERR_GENERATING_FAX" => "There was an error preparing your fax, please try again",
"ERR_GOOGLE_2STEP_ERROR" => "parola.",
"ERR_GROUP_NOT_FOUND" => "Group not found",
"ERR_HTML_403" => "Erişim reddedildi",
"ERR_HTML_404" => "Dosya bulunamadı",
"ERR_HTML_500" => "İçsel hata",
"ERR_IDENTIFIER_ALREADY_USED" => "Bu kullanıcı adı zaten bir başka PamFax hesabına bağlanmış.",
"ERR_IDENTIFIER_ERROR" => "Tanımlama oluşturma hatası",
"ERR_IDENTIFIER_NOT_FOUND" => "Kullanıcı adı bulunamadı",
"ERR_IMPORTING_CONTACTS_FAILED" => "Kişilerin alımı başarısız",
...
"ERR_INVALIDNUMBER" => "Geçersiz numara. Lütfen, geçerli bir uluslararası numara girin.",
"ERR_INVALID_COUNTRY_CODE" => "Geçersiz ülke kodu",
"ERR_INVALID_COUNTRY_CODE_2" => "Country code not found. Please try again, if issue still exists - please contact PamFax support",
"ERR_INVALID_COUNTRY_STATE" => "Bu ülkenin eyaleti var",
"ERR_INVALID_COVER" => "Geçersiz Kapak",
...
"ERR_INVALID_FAX_IN" => "Geçersiz faks numarası",
"ERR_INVALID_FAX_NUMBER" => "Geçersiz numara. Lütfen ülke kodu ile birlikte girin (ör: +1213985...)",
...
"ERR_INVALID_IP" => "Geçersiz IP-Adresi",
"ERR_INVALID_MOBILE_NUMBER" => "Geçersiz cep numarası",
"ERR_INVALID_NAME_CHARS" => "Ad, geçersiz karakter(ler) içeriyor. (Ör ,.:;+#, gibi) Lütfen girdiğiniz adı değiştirin ve tekrar deneyin.",
"ERR_INVALID_PROVIDER" => "Geçersiz sağlayıcı",
"ERR_INVALID_RECIPIENT" => "Geçersiz alıcı",
"ERR_INVALID_SPAMSCORE" => "Aktardığınız Spamscore geçersiz. Sadece -1, 0 veya 1 olabilir.",
"ERR_INVALID_TICKET" => "Geçersiz Bilet",
"ERR_INVALID_USER" => "Geçersiz Kullanıcı",
"ERR_INVALID_VERIFICATION_DOC" => "Geçersiz dosya. Lütfen bir png, jpg, doc, docx, pdf, jpeg, jpg, tiff, tif veya bmp dosyası yükleyin.",
"ERR_INVALID_ZONE" => "Geçersiz Zone ID'si",
"ERR_INVITING_USER" => "Kullanıcı davet edilemedi.",
"ERR_INVITING_USER_ISMEMBER" => "Could not invite user. {username} is already a member or has a pending Kullanıcı davet edilemedi. {username} zaten bir üye veya bekleyen bir davetiyesi var.",
"ERR_INVITING_USER_ISOWNER" => "Kullanıcı davet edilemedi: Bu sizin kendi kullanıcı adınız. Kendinizi davet edemezsiniz.",
"ERR_INVITING_USER_NOTFOUND" => "Kullanıcı davet edilemedi: PamFax kullanıcı adı bulunamadı. Sadece, halen PamFax kullananları davet edebilirsiniz.",
"ERR_INVOICE_NOT_FOUND" => "Bu fatura bulunamadı",
"ERR_LASTNAME_REQUIRED" => "Soyadı gerekli",
"ERR_LESS_THAN_ALLOWED_MINIMUM" => "Değer, müsade edilen en küçük değerden daha küçük",
"ERR_LOCK_001" => "Bu hesap kilitlendi. Artık faks gönderemezsiniz.<br>Lütfen bu hesabın kilidini kaldırmak için {supportmail} ile iletişim kurun.",
...
"ERR_MESSAGE_SEND_FAILED" => "Mesaj gönderimi başarısız oldu",
...
"ERR_MISSING_FIELDS" => "Lütfen tüm alanları doldurun",
...
"ERR_MISSING_REQUIRED" => "Lütfen tüm gerekli alanları doldurun",
"ERR_MISSING_RIGHT_MESSAGING" => "User may not receive any messages",
"ERR_MISSING_VALUE" => "Lütfen bir değer girin.",
...
"ERR_MSG_NOT_SENT" => "Deneme mesajı gönderilemedi. Lütfen tekrar deneyin.",
"ERR_NAME_REQUIRED" => "Ad gerekli",
...
"ERR_NOT_ENOUGH_CREDIT" => "Yeterli PamFax kontörünüzü yok. <a href=\"{portal_url}payment/buycredit/\">Hemen PamFax Kontörü Satın Al</a>.",
"ERR_NOT_VERIFIED" => "Code not verified",
"ERR_NO_ATTACHMENT_SELECTED" => "En az bir ek seçmek zorundasınız.",
"ERR_NO_COMPANY" => "Şirket bulunamadı",
"ERR_NO_COMPANY_OWNER_FOUND" => "Şirket sahibi bulunamadı",
"ERR_NO_CONTACTDATA" => "Contact not saved: Please enter some data",
"ERR_NO_CONTACTS_GIVEN" => "Hiçbir kişi verilmedi",
"ERR_NO_CONTACT_SELECTED" => "Lütfen en az bir kişi seçin.",
"ERR_NO_COUNTRIES_FOR_FAXIN" => "No countries for Fax-In numbers available",
"ERR_NO_ESKER_FAX" => "Henüz hiçbir bilgi yok",
"ERR_NO_FAX" => "Hiçbir faks yok",
...
"ERR_NO_FAXIN_NUMBER_IN_COUNTRY" => "Üzgünüz, şu anda bu ülke/adres için bir faks numarası öneremiyoruz. Lütfen başka bir ülke/şehir seçin.",
"ERR_NO_FILES_IN_FAX" => "Faks içinde hiçbir dosya yok",
"ERR_NO_JAVASCRIPT" => "Web tarayıcınızda JavaScript'ler kapatılmış. Bu sitenin tüm avantajlarından yararlanmak için onu açın ve sayfayı yeniden yükleyin.",
"ERR_NO_MEMBERSHIP" => "Üye bulunamadı",
"ERR_NO_NETWORK_CONNECTION" => "Ağ bağlantısı yok",
"ERR_NO_NEW_FAXES" => "No new faxes",
"ERR_NO_NEW_SKYPE_USERS_AVAILABLE" => "Yeni Skype kişisi yok",
"ERR_NO_NEW_USERS" => "Yeni kişi daveti yapılmadı. Tüm seçili kişiler zaten PamFax kullanıyorlar!",
"ERR_NO_PROFILE" => "Neden: Profil yok",
"ERR_NO_RECIPIENTS_IN_FAX" => "Hiçbir alıcı verilmedi",
"ERR_NO_RECIPIENT_FOUND" => "Eşleşen hiçbir alıcı bulunamadı: {filterval} veya adres defteri geçerli bir alıcı içermiyor.",
"ERR_NO_SCANNED_DOCUMENTS" => "Please scan a document",
"ERR_NO_SCANNER_FOUND" => "Hiçbir desteklenen tarayıcı bulunamadı",
"ERR_NO_SKYPE_USERS_AVAILABLE" => "Hiçbir Skype kişisi yok",
...
"ERR_PASSWORDS_DONT_MATCH" => "Parolalar eşleşmiyor",
"ERR_PASSWORD_EMPTY" => "Parola girilmedi. Lütfen bir parola girin.",
"ERR_PASSWORD_REQUIRED" => "Bir parola gerekli. Lütfen bir parola girin.",
"ERR_PASSWORD_TOO_SHORT" => "Parola çok kısa: En küçük parola uzunluğu 8 karakterdir.",
"ERR_PASS_CONFIRM_MISMATCH" => "The passwords do not match. Please re-enter.",
"ERR_PAYMENT_NOT_FOUND" => "Ödeme yöntemi bunamadı",
"ERR_PAYMENT_TOOLOW" => "Minimum ödeme tutarı {minpayment}. Lütfen bu miktar için farklı bir yöntem seçin.",
...
"ERR_TOO_MANY_REQUESTS" => "Çok fazla istek",
...
"ITEM_ABOUT" => "Hakkında...",
"ITEM_COPY" => "Copy",
"ITEM_CREDPACK" => "Kontör Paketleri",
"ITEM_CUT" => "Cut",
...
"ITEM_PORTAL" => "Portal",
"ITEM_RELOAD" => "Reload",
"ITEM_SKYPECREDIT" => "Skype Kontörü",
"ITEM_SKYPE_CONTATCS" => "Skype Contacts",
"ITEM_VOUCHER" => "Redeem voucher",
"ITEM_WEBSHOP" => "PamFax Kontör Paketleri",
"ITEM_WEB_CONTACTS" => "Import email addresses",
"LNGFAILUREMESSAGE_CHAT" => "PamFax'ınız {fax_recipient} alıcısına gönderimiz BAŞARISIZ oldu. Nedeni:{fail_reason}. Daha fazla bilgi PamFax Portal'ında mevcut {directlink}",
"LNGMESSAGE_CHAT_GROUPED" => "PamFax'ınız tüm {recipient_count} alıcıya gönderildi ({success_count} başarılı, {failure_count} başarısız ve {cancelled_count} iptal). Daha fazla bilgi PamFax Portal'ında mevcut {directlink}",
"LNGPROGRESSMESSAGE_CHAT" => "Faksınız {fax_recipient} alıcısına şu anda GÖNDERİLİYOR. Faksınız gönderildiğinde veya bir hata oluştuğunda, başka bir yazılı mesaj iletisi alacaksınız.",
"LNGPROGRESSMESSAGE_CHAT_GROUPED" => "Fakslarınız {recipient_count} alıcıya şu anda GÖNDERİLİYOR. Fakslarınız gönderildiğinde veya bir hata oluştuğunda, başka bir yazılı mesaj alacaksınız.",
"LNGSUCCESSMESSAGE_CHAT" => "Faksınız {fax_recipient} alıcısına BAŞARIYLA GÖNDERİLDİ.\nDaha fazla bilgi PamFax Portal'ında mevcut {directlink}",
"MENU_BUY" => "PamFax Kontörü Satın Al",
"MENU_HIDE" => "Hide",
...
"MSG_COVERTEXT_REQUIRED" => "Sadece kapak sayfası gönderdiğinizde, bir mesaj yazmalisiniz",
...
"MSG_CREDITS_RESTORED" => "PamFax Kontörünüz iade edildi",
"MSG_CREDIT_EXPIRATION_RESET_SUBJECT" => "PamFax hesabı yeniden etkinleştirildi",
"MSG_CREDIT_EXPIRATION_WARNING" => "Geçtiğimiz {inactivity} gün hiçbir bir faks göndermediniz. PamFax kontörünüzün süresi, hiçbir kullanım yapılmaz ise 180 gün sonra dolar. ({days_to_expiration} gün sonra dolacak)\n\nBakiyenizi nasıl aktif tutarsınız? Basit. Bir belge veya kapak sayfası gönderin (geçerli veya geçersiz bir numaraya) ya da mağazamızdan ({shop_url}) bir PamFax Kontör paketi veya bir plan satın alın",
...
"MSG_CREDIT_EXPIRATION_WARNING_MAIL_SUBJ" => "PamFax Kontörünüz yakında etkinsiz hale gelecek",
...
"MSG_CREDIT_NOTIFICATION_EMAIL_SUBJ" => "PamFax Kontörünüz bitiyor",
"MSG_CREDIT_REACTIVATED" => "Yeniden etkinleştirildiniz {reactivated_credit}",
"MSG_DELAYED_DATETIME_SAVED" => "Saved",
"MSG_DOWNLOADING_UPDATE" => "Downloading update...",
"MSG_DUPS_REMOVED" => "Listede bazı numaralar çift yazılmış.<br>Ek ücret ödenmemesi için bunlar otomatik olarak kaldırıldı.",
...
"MSG_FAXNUMBER_MISSING" => "Bir faks numarası girin",
...
"MSG_FOREIGN_COUNTRY" => "Bu faksı gönderdiğiniz yer {target_country}.",
...
"MSG_GENERATING_FAX" => "Faksınız oluşturuluyor.<br>\nLütfen bekleyin...",
...
"MSG_INIT" => "Başlatılıyor...",
"MSG_INIT1" => "Yükleniyor...",
...
"MSG_MAILRECIPIENT_MISSING" => "E-Posta için alıcı girin",
...
"MSG_MULFAXNUMBERS_MISSING" => "En az bir faks numarası girin",
"MSG_NEW_INBOX_FAXES" => "You have {faxes_cnt} new faxes",
"MSG_NOCREDITS_RESTORED" => "Üzgünüz, fakat hiçbir kredi geri yüklenmedi.",
"MSG_NO_DEVICE_CONTACTS" => "No contacts found on device",
"MSG_NO_RECIPIENT" => "Hiçbir geçerli alıcı bulunamadı",
"MSG_NO_RESULTS" => "No results found",
"MSG_NO_UNPAID_FAX_SENT" => "Yetersiz kontör nedeniyle, seçili olan ödenmemiş faksların hiçbiri gönderilmedi.",
...
"MSG_PACK_PURCHASED_SUBJECT" => "PamFax Kontör satın alımı onayı (Sipariş #{order_id})",
...
"MSG_PREPARE_PREVIEW" => "Önizleme hazırlanıyor...",
...
"MSG_REACTIVATION_CHAT" => "Aktif olmayan PamFax Kontörünüz ({reactivated_credit}) başarıyla yeniden etkinleştirildi.",
"MSG_REACTIVATION_MAIL" => "Aktif olmayan PamFax Kontörünüz ({reactivated_credit}) başarıyla yeniden etkinleştirildi.",
...
"MSG_SMSRECIPIENT_MISSING" => "SMS için alıcı girin",
"MSG_SOME_INVALID_NUMBERS" => "Bazı faks numaraları geçersiz görünüyor.",
"MSG_SOME_UNPAID_FAXES_SENT" => "Some unpaid faxes were sent, the others remain unpaid due to insufficient credit.",
"MSG_STORING_CREDIT" => "Kredi bilgisi kaydediliyor...",
...
"MSG_UPLOAD" => "Belge(ler) gönderiliyor. Lütfen bekleyin...",
...
"MSG_WAIT_DEFAULT" => "Lütfen bekleyin...",
...
"SHOP_CATEGORY_CREDIT" => "PamFax Kontörü",
...
"SHOP_ITEM_ONDEMAND" => "PamFax Kontörü",
...
"SHOP_PACK1" => "PamFax Kontör Paketi 1",
...
"SHOP_PACK2" => "PamFax Kontör Paketi 2",
...
"SHOP_PACK3" => "PamFax Kontör Paketi 3 - 5% kontör hediyeli",
...
"SHOP_PACK4" => "PamFax Kontör Paketi 4 - 10% kontör hediyeli",
...
"SHOP_PACK5" => "PamFax Kontör Paketi 5 - 15% kontör hediyeli",
...
"SHOP_PACK6" => "PamFax Kontör Paketi 6 - 20% kontör hediyeli",
...
"SHOP_PACK7" => "Kontör Paketi 7 - 25% kontör hediyeli",
...
"SHOP_PACK8" => "Kontör Paketi 8 - 30% kontör hediyeli",
...
"TITLE_COVER_TEXT" => "Bir mesaj girin",
...
"TITLE_NOTIFY" => "Bildirim Ayarları",
"TITLE_NUMBER" => "Alıcı(ları) girin",
"TITLE_PAY" => "Faks için ödeme yapın",
...
"TITLE_PRICEWARNING" => "Güncellenen fiyat",
...
"TITLE_SELECT_COVER" => "Bir kapak sayfası seçin",
...
"TXT_AMOUNT" => "PamFax kontörü eklendi",
"TXT_ANDROID_ACCEPT" => "I Accept",
"TXT_ANDROID_ADD_RECIPIENT" => "Alıcı ekle",
"TXT_ANDROID_ASKSEND" => "Göndermek istiyor musunuz",
"TXT_ANDROID_BALANCE" => "Mevcut bakiye",
"TXT_ANDROID_BENEFIT_1" => "ÜCRETSİZ 3 sayfa gönder",
"TXT_ANDROID_BENEFIT_2" => "İsteğe bağlı faks numarası",
"TXT_ANDROID_BENEFIT_3" => "Aylık maliyet yok",
"TXT_ANDROID_BENEFIT_4" => "Cazip fiyatlar",
"TXT_ANDROID_CAMERA" => "Kamera",
"TXT_ANDROID_CHECKOUT" => "Hata ayıkla",
"TXT_ANDROID_CLEAR" => "Temizle",
"TXT_ANDROID_CLEAR_FOLDER" => "Klasörü temizle",
"TXT_ANDROID_CONTACT_LIST" => "Kişi listesi",
"TXT_ANDROID_CREDIT_PACK" => "Kontör Paketleri",
"TXT_ANDROID_DELETE_ALL" => "Tümünü sil",
"TXT_ANDROID_DONE" => "Tamam",
"TXT_ANDROID_ERROR_OCCURS" => "Sadece bir hata olduğunda bildir",
"TXT_ANDROID_EXIT" => "Çıkış",
...
"TXT_ANDROID_FROM_CONTACT" => "Kişi listesinden",
"TXT_ANDROID_GALLERY" => "Galeri",
"TXT_ANDROID_INFO" => "Bilgi",
"TXT_ANDROID_LOCAL" => "Belge(ler)",
"TXT_ANDROID_MANUALLY" => "Bir numara gir",
"TXT_ANDROID_MYFOLDERS" => "Klasörler",
"TXT_ANDROID_NEW_PASSWORD" => "Yeni parola",
"TXT_ANDROID_NOPHONE" => "Kişinin hiçbir telefon numarası yok",
...
"TXT_ANDROID_NO_CREDIT" => "Bu faksı göndermek için yeterli PamFax Kontörünüz yok. Lütfen faksınızı göndermek için PamFax Kontörü satın alın.",
"TXT_ANDROID_ONLINE_STORAGE" => "Çevrimiçi Belgeler",
"TXT_ANDROID_ON_DEMAND" => "Kontör Paketleri",
"TXT_ANDROID_OUTGOING_NAME" => "Sender fax name",
"TXT_ANDROID_RECIPIENT_DETAILS" => "Recipient details",
"TXT_ANDROID_RESTORE" => "Geri yükle",
"TXT_ANDROID_RESTORE_ALL" => "Tümünü geri yükle",
"TXT_ANDROID_SELECT_FAX" => "Faks dosyalarını seç",
"TXT_ANDROID_SELECT_FILE" => "Dosya seç",
"TXT_ANDROID_SELECT_FROM" => "Şuradan dosya seç",
"TXT_ANDROID_SEND" => "Gönder",
"TXT_ANDROID_SEND_ALL" => "Tümünü gönder",
...
"TXT_ANDROID_SKYPE_CHAT" => "Skype Yazılı Mesaj",
"TXT_ANDROID_TESTEMAIL_SENT" => "Test e-postası gönderildi",
"TXT_ANDROID_TRASHBIN" => "Çöp kutusu",
"TXT_ANDROID_TRASH_BIN" => "Çöp kutusu",
"TXT_ANDROID_WELCOME" => "PamFax'a Hoş Geldiniz",
"TXT_ANONYMOUS" => "Bilinmiyor",
...
"TXT_BCP_ACCOUNT_DETAILS" => "Ayrıntılar",
"TXT_BCP_ADDCREDIT" => "PamFax Kontörü Ekle",
...
"TXT_BCP_COMPANY_COUTRY" => "Ülke",
"TXT_BCP_COMPANY_NAME" => "Şirket adı",
...
"TXT_BUY_IN_SHOP" => "Hemen PamFax Mağazasından Satın Al",
"TXT_BUY_PAMFAXCREDIT" => "PamFax Kontörü Satın Al",
"TXT_BYFAX_ABOUT" => "About [apptitle]",
"TXT_CAD" => "Kanada doları",
"TXT_CALCULATION" => "Plan and Number cost",
"TXT_CANCELFAXGROUPQUESTION" => "Do you really want to cancel all faxes in this group?",
"TXT_CANCELFAXQUESTION" => "Bu faksın gönderilmesini gerçekten iptal etmek istiyor musunuz?<br />\n<br />\nFaks gönderilmeyecek.",
...
"TXT_CLICKTOCLOSE" => "Kapatmak için tıklayın",
...
"TXT_CONFIRM_REACTIVATION" => "Kontörü yeniden etkinleştir",
...
"TXT_COUNTRY_AE" => "Birleşik Arap Emirlikleri",
"TXT_COUNTRY_AF" => "Afganistan",
"TXT_COUNTRY_AG" => "Antigua ve Barbuda",
"TXT_COUNTRY_AI" => "Anguilla",
"TXT_COUNTRY_AL" => "Arnavutluk",
"TXT_COUNTRY_AM" => "Ermenistan",
"TXT_COUNTRY_AN" => "Hollanda Antilleri",
"TXT_COUNTRY_AO" => "Angola",
"TXT_COUNTRY_AQ" => "Antarktika",
"TXT_COUNTRY_AR" => "Arjantin",
"TXT_COUNTRY_AS" => "Amerikan Samoası",
"TXT_COUNTRY_AT" => "Avusturya",
"TXT_COUNTRY_AU" => "Avustralya",
"TXT_COUNTRY_AW" => "Aruba",
"TXT_COUNTRY_AX" => "Aland Islands",
"TXT_COUNTRY_AZ" => "Azerbaycan",
"TXT_COUNTRY_BA" => "Bosna Hersek",
"TXT_COUNTRY_BB" => "Barbados",
"TXT_COUNTRY_BD" => "Bangladeş",
"TXT_COUNTRY_BE" => "Belçika",
"TXT_COUNTRY_BF" => "Burkina Faso",
"TXT_COUNTRY_BG" => "Bulgaristan",
"TXT_COUNTRY_BH" => "Bahreyn",
"TXT_COUNTRY_BI" => "Burundi",
"TXT_COUNTRY_BJ" => "Benin",
"TXT_COUNTRY_BM" => "Bermuda",
"TXT_COUNTRY_BN" => "Brunei",
"TXT_COUNTRY_BO" => "Bolivya",
"TXT_COUNTRY_BQ" => "Bonaire, Saint Eustatius and Saba",
"TXT_COUNTRY_BR" => "Brezilya",
"TXT_COUNTRY_BS" => "Bahamalar",
"TXT_COUNTRY_BT" => "Bhutan",
"TXT_COUNTRY_BV" => "Buvet Adası",
"TXT_COUNTRY_BW" => "Botsvana",
"TXT_COUNTRY_BY" => "Belarus",
"TXT_COUNTRY_BZ" => "Belize",
"TXT_COUNTRY_CA" => "Kanada",
"TXT_COUNTRY_CC" => "Cocos (Keeling) Adaları",
"TXT_COUNTRY_CD" => "Kongo Demokratik Cumhuriyeti",
"TXT_COUNTRY_CF" => "Orta Afrika Cumhuriyeti",
"TXT_COUNTRY_CG" => "Kongo",
"TXT_COUNTRY_CH" => "İsviçre",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "Fildişi Sahili",
"TXT_COUNTRY_CK" => "Cook Adaları",
"TXT_COUNTRY_CL" => "Şili",
"TXT_COUNTRY_CM" => "Kamerun",
"TXT_COUNTRY_CN" => "Çin",
"TXT_COUNTRY_CO" => "Kolombiya",
...
"TXT_COUNTRY_CX" => "Christmas Adası",
"TXT_COUNTRY_CY" => "Kıbrıs",
"TXT_COUNTRY_CZ" => "Çek Cumhuriyeti",
"TXT_COUNTRY_DE" => "Almanya",
"TXT_COUNTRY_DJ" => "Cibuti",
"TXT_COUNTRY_DK" => "Danimarka",
"TXT_COUNTRY_DM" => "Dominika",
"TXT_COUNTRY_DO" => "Dominik Cumhuriyeti",
"TXT_COUNTRY_DZ" => "Cezayir",
"TXT_COUNTRY_EC" => "Ekvator",
"TXT_COUNTRY_EE" => "Estonya",
"TXT_COUNTRY_EG" => "Mısır",
"TXT_COUNTRY_EH" => "Batı Sahra",
"TXT_COUNTRY_ER" => "Eritre",
"TXT_COUNTRY_ES" => "İspanya",
"TXT_COUNTRY_ET" => "Etiyopya",
"TXT_COUNTRY_FI" => "Finlandiya",
"TXT_COUNTRY_FJ" => "Fiji",
"TXT_COUNTRY_FK" => "Falkland Adaları (Malvinas)",
"TXT_COUNTRY_FM" => "Mikronezya Federal Devletleri",
"TXT_COUNTRY_FO" => "Faroe Adaları",
"TXT_COUNTRY_FR" => "Fransa",
"TXT_COUNTRY_GA" => "Gabon",
"TXT_COUNTRY_GB" => "Birleşik Krallık",
"TXT_COUNTRY_GD" => "Grenada",
"TXT_COUNTRY_GE" => "Gürcistan",
"TXT_COUNTRY_GF" => "Fransız Guyanası",
"TXT_COUNTRY_GG" => "Guernsey",
"TXT_COUNTRY_GH" => "Gana",
"TXT_COUNTRY_GI" => "Gibraltar",
"TXT_COUNTRY_GL" => "Grönland",
"TXT_COUNTRY_GM" => "Gambiya",
"TXT_COUNTRY_GN" => "Gine",
"TXT_COUNTRY_GP" => "Guatelup",
"TXT_COUNTRY_GQ" => "Ekvator Ginesi",
"TXT_COUNTRY_GR" => "Yunanistan",
"TXT_COUNTRY_GS" => "Güney Georgia ve Güney Sandwich Adaları",
"TXT_COUNTRY_GT" => "Guatemala",
"TXT_COUNTRY_GU" => "Guam",
"TXT_COUNTRY_GW" => "Gine Bissau",
"TXT_COUNTRY_GY" => "Guyena",
"TXT_COUNTRY_HK" => "Hong Kong",
"TXT_COUNTRY_HM" => "Heard Adası ve McDonald Adaları",
"TXT_COUNTRY_HN" => "Honduras",
"TXT_COUNTRY_HR" => "Hırvatistan",
"TXT_COUNTRY_HT" => "Haiti",
"TXT_COUNTRY_HU" => "Macaristan",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "Endonezya",
"TXT_COUNTRY_IE" => "İrlanda",
"TXT_COUNTRY_IL" => "İsrail",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "Hindistan",
"TXT_COUNTRY_IO" => "İngiliz Hint Okyanus Bölgesi",
"TXT_COUNTRY_IQ" => "Irak",
"TXT_COUNTRY_IR" => "İran",
"TXT_COUNTRY_IS" => "İzlanda",
"TXT_COUNTRY_IT" => "İtalya",
"TXT_COUNTRY_IX" => "Inmarsat SNAC",
"TXT_COUNTRY_JE" => "Jersey",
"TXT_COUNTRY_JM" => "Jamaika",
"TXT_COUNTRY_JO" => "Ürdün",
"TXT_COUNTRY_JP" => "Japonya",
"TXT_COUNTRY_KE" => "Kenya",
"TXT_COUNTRY_KG" => "Kırgızistan",
"TXT_COUNTRY_KH" => "Kamboçya",
"TXT_COUNTRY_KI" => "Kiribati",
"TXT_COUNTRY_KM" => "Komor",
"TXT_COUNTRY_KN" => "St. Kitts ve Nevis",
"TXT_COUNTRY_KP" => "Kore, Kuzey",
"TXT_COUNTRY_KR" => "Kore, Güney",
"TXT_COUNTRY_KW" => "Kuveyt",
"TXT_COUNTRY_KY" => "Cayman Adaları",
"TXT_COUNTRY_KZ" => "Kazakistan",
"TXT_COUNTRY_LA" => "Laos",
"TXT_COUNTRY_LB" => "Lübnan",
"TXT_COUNTRY_LC" => "Santa Lucia",
"TXT_COUNTRY_LI" => "Liechtenstein",
"TXT_COUNTRY_LK" => "Sri Lanka",
"TXT_COUNTRY_LR" => "Liberya",
"TXT_COUNTRY_LS" => "Lesotho",
"TXT_COUNTRY_LT" => "Litvanya",
"TXT_COUNTRY_LU" => "Lüksemburg",
"TXT_COUNTRY_LV" => "Letonya",
"TXT_COUNTRY_LY" => "Libya",
"TXT_COUNTRY_MA" => "Fas",
"TXT_COUNTRY_MC" => "Monako",
"TXT_COUNTRY_MD" => "Moldova",
"TXT_COUNTRY_ME" => "Karadağ",
"TXT_COUNTRY_MF" => "Saint Martin",
"TXT_COUNTRY_MG" => "Madagaskar",
"TXT_COUNTRY_MH" => "Marşal Adaları",
"TXT_COUNTRY_MK" => "Makedonya",
"TXT_COUNTRY_ML" => "Mali",
"TXT_COUNTRY_MM" => "Myanmar",
"TXT_COUNTRY_MN" => "Moğolistan",
"TXT_COUNTRY_MO" => "Makao",
"TXT_COUNTRY_MP" => "Kuzey Marian Adaları",
"TXT_COUNTRY_MQ" => "Martinik",
"TXT_COUNTRY_MR" => "Moritanya",
"TXT_COUNTRY_MS" => "Monserra",
"TXT_COUNTRY_MT" => "Malta",
"TXT_COUNTRY_MU" => "Mauritius",
"TXT_COUNTRY_MV" => "Maldivler",
"TXT_COUNTRY_MW" => "Malavi",
"TXT_COUNTRY_MX" => "Meksika",
"TXT_COUNTRY_MY" => "Malezya",
"TXT_COUNTRY_MZ" => "Mozambik",
"TXT_COUNTRY_NA" => "Namibya",
"TXT_COUNTRY_NC" => "Yeni Kaledonya",
"TXT_COUNTRY_NE" => "Nijer",
"TXT_COUNTRY_NF" => "Norfolk Adası",
"TXT_COUNTRY_NG" => "Nijerya",
"TXT_COUNTRY_NI" => "Nikaragua",
"TXT_COUNTRY_NL" => "Hollanda",
"TXT_COUNTRY_NO" => "Norveç",
"TXT_COUNTRY_NP" => "Nepal",
"TXT_COUNTRY_NR" => "Nauru",
"TXT_COUNTRY_NU" => "Niue",
"TXT_COUNTRY_NZ" => "Yeni Zelanda",
"TXT_COUNTRY_OM" => "Umman",
"TXT_COUNTRY_PA" => "Panama",
"TXT_COUNTRY_PE" => "Peru",
"TXT_COUNTRY_PF" => "Fransız Polenezyası",
"TXT_COUNTRY_PG" => "Papua Yeni Gine",
"TXT_COUNTRY_PH" => "Filipinler",
"TXT_COUNTRY_PK" => "Pakistan",
"TXT_COUNTRY_PL" => "Polonya",
"TXT_COUNTRY_PM" => "St. Pier ve Mikelon",
"TXT_COUNTRY_PN" => "Pitkeirn",
"TXT_COUNTRY_PR" => "Puerto Riko",
"TXT_COUNTRY_PS" => "Filistin Bölgesi",
"TXT_COUNTRY_PT" => "Portekiz",
"TXT_COUNTRY_PT-AZ" => "Azores",
"TXT_COUNTRY_PT-MA" => "Madeira",
"TXT_COUNTRY_PW" => "Palau",
"TXT_COUNTRY_PY" => "Paraguay",
"TXT_COUNTRY_QA" => "Katar",
"TXT_COUNTRY_RE" => "Reunyon",
"TXT_COUNTRY_RO" => "Romanya",
"TXT_COUNTRY_RS" => "Sırbistan",
"TXT_COUNTRY_RU" => "Rusya",
"TXT_COUNTRY_RW" => "Ruanda",
"TXT_COUNTRY_SA" => "Suudi Arabistan",
"TXT_COUNTRY_SB" => "Solomon Adaları",
"TXT_COUNTRY_SC" => "Seyşeller",
"TXT_COUNTRY_SD" => "Sudan",
"TXT_COUNTRY_SE" => "İsveç",
"TXT_COUNTRY_SG" => "Singapur",
"TXT_COUNTRY_SH" => "St. Helen",
"TXT_COUNTRY_SI" => "Slovenya",
"TXT_COUNTRY_SJ" => "Svalbard ve Jan Mayen",
"TXT_COUNTRY_SK" => "Slovakya",
"TXT_COUNTRY_SL" => "Sierra Leon",
"TXT_COUNTRY_SM" => "San Marino",
"TXT_COUNTRY_SN" => "Senegal",
"TXT_COUNTRY_SO" => "Somali",
"TXT_COUNTRY_SR" => "Surinam",
"TXT_COUNTRY_SS" => "South Sudan",
"TXT_COUNTRY_ST" => "Sao Tome ve Prensip",
"TXT_COUNTRY_SV" => "El Salvador",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Suriye",
"TXT_COUNTRY_SZ" => "Svaziland",
"TXT_COUNTRY_TC" => "Türk ve Kaikos Adaları",
"TXT_COUNTRY_TD" => "Çad",
"TXT_COUNTRY_TF" => "Fransa Güney Bölgesi",
"TXT_COUNTRY_TG" => "Togo",
"TXT_COUNTRY_TH" => "Tayland",
"TXT_COUNTRY_TJ" => "Tacikistan",
"TXT_COUNTRY_TK" => "Tokelau",
"TXT_COUNTRY_TL" => "Timor-Leste",
"TXT_COUNTRY_TM" => "Türkmenistan",
"TXT_COUNTRY_TN" => "Tunus",
"TXT_COUNTRY_TO" => "Tonga",
"TXT_COUNTRY_TR" => "Türkiye",
"TXT_COUNTRY_TT" => "Trinidad ve Tobago",
"TXT_COUNTRY_TV" => "Tuvalu",
"TXT_COUNTRY_TW" => "Tayvan",
"TXT_COUNTRY_TZ" => "Tanzanya",
"TXT_COUNTRY_UA" => "Ukrayna",
"TXT_COUNTRY_UG" => "Uganda",
"TXT_COUNTRY_UK" => "United Kingdom",
"TXT_COUNTRY_UM" => "United States Minor Outlying Islands",
"TXT_COUNTRY_US" => "Amerika Birleşik Devletleri",
"TXT_COUNTRY_US-AL" => "Alaska",
"TXT_COUNTRY_US-HI" => "Hawaii",
"TXT_COUNTRY_UY" => "Uruguay",
"TXT_COUNTRY_UZ" => "Özbekistan",
"TXT_COUNTRY_VA" => "Vatikan",
"TXT_COUNTRY_VC" => "St. Vensan ve Grenadines",
"TXT_COUNTRY_VE" => "Venezuela",
"TXT_COUNTRY_VG" => "İngiltere Virjin Adaları",
"TXT_COUNTRY_VI" => "U.S. Virgin Islands",
"TXT_COUNTRY_VN" => "Vietnam",
"TXT_COUNTRY_VU" => "Vanuatu",
"TXT_COUNTRY_WF" => "Valis ve Futuna",
"TXT_COUNTRY_WS" => "Samoa",
"TXT_COUNTRY_YE" => "Yemen",
"TXT_COUNTRY_YT" => "Mayotte",
"TXT_COUNTRY_ZA" => "Güney Afrika",
"TXT_COUNTRY_ZM" => "Zambiya",
"TXT_COUNTRY_ZW" => "Zimbabve",
"TXT_COVER" => "Faks kapağı",
...
"TXT_COVERPAGE_TEXT" => "Kapak sayfası metni",
"TXT_COVERS_RESTORED" => "Default PamFax covers have been restored",
"TXT_COVERTEXT_1" => "Seçili kapak için bir metin girin.",
...
"TXT_COVER_NONE" => "Kapaksız",
"TXT_COVER_SIMPLE" => "Simple",
"TXT_COVER_TEMPLATE" => "Kapak şablonu",
"TXT_CREATED" => "Created",
...
"TXT_CREDIT_ADDED" => "Kontör başarıyla eklendi.",
...
"TXT_CREDIT_PACK" => "{price} Kontör Paketi",
"TXT_CREDIT_TITLE" => "PamFax Kontörünüz",
...
"TXT_CURRENCY" => "Para birimi",
"TXT_CURRENCY_FORMAT" => "Para birimi biçimi",
"TXT_CURRENT_TEXT" => "Hemen",
"TXT_DASHBOARD" => "Gösterge Paneli",
"TXT_DASHBOARD_CREDIT_EXPLAIN" => "Bu, sizin PamFax Kontör bakiyeniz.",
...
"TXT_DATE" => "Tarih",
"TXT_DATETIMEFORMAT" => "Tarih/Saat biçimi",
"TXT_DECLINE" => "decline",
...
"TXT_EMAIL_RECIPIENT" => "E-Posta adresiniz",
"TXT_EMAIL_SUBJECT" => "Pamfax durum bildirimi",
...
"TXT_EXPLAIN_CREDIT_REACTIVATION_LINK" => "{inactive_credit} etkin olmayan kontörünüz var, linke tıkayın",
...
"TXT_FAILED" => "Başarısız Fakslar",
"TXT_FAILED_RECIPIENTS" => "({failed_recipients} recipients invalid)",
"TXT_FAILUREMESSAGE_EMAIL" => "Faks, {fax_recipient} alıcısına gönderilemedi: {fail_reason}.\nDaha fazla bilgi PamFax Portal'ında mevcut {directlink}",
"TXT_FAILUREMESSAGE_SMS" => "Faksınız {fax_recipient} alıcısına gönderilemedi: {fail_reason}.",
...
"TXT_FAXINGRATES" => "Faks Fiyatları",
...
"TXT_FAXPRICE" => "Bu faks <b>{pagesum} {pagename}</b> ve maliyeti <b>{price}</b>.",
"TXT_FAXPRICE_FREE" => "Bu faks <b>{pagesum} {pagename}</b>. İyi haber: Bir PamFax numarasına gönderdiğiniz için faksınız <b>ÜCRETSİZ!</b> olarak gönderilecektir<br>",
"TXT_FAXPRICE_MULTI" => "Bu faks <b>{pagesum} {pagename}</b> ({pages} {pagenamerec} x {recipients} alıcı) ve maliyeti <b>{price}</b>.",
...
"TXT_FILTER" => "Search...",
"TXT_FILTER_ALL" => "Tüm Desteklenen Türler",
"TXT_FILTER_CAD" => "CAD Biçimleri",
"TXT_FILTER_COUNTRY" => "Filter country",
"TXT_FILTER_GENERIC" => "Genel Biçimler",
"TXT_FILTER_IMAGE" => "Resimler",
"TXT_FILTER_PREFIX" => "Filter prefix",
"TXT_FILTER_PRESENTATION" => "Sunum Biçimleri",
"TXT_FILTER_SPREADSHEET" => "Excel Biçimleri",
"TXT_FILTER_TEXT" => "Metin",
"TXT_FILTER_WORD" => "Word",
"TXT_FINALMESSAGE_EMAIL_GROUPED" => "{recipient_count} alıcıya faks gönderiminin sonuçları:\n\nBaşarılı:    {success_count}\nBaşarısız: {failure_count}\nİptal:        {cancelled_count}\n\nDaha fazla bilgi PamFax Portal'ında mevcut {directlink}",
...
"TXT_FINISHED_1" => "<b>Faksınız şimdi gönderiliyor.</b><br><br>İşlem durumunu {link_portal}'dan kontrol edebilirsiniz.<br><br>Başka bir faks göndermek ister misiniz?<br>Başka bir faks göndermek için aşağıdaki butonları kullanın.<br><br>PamFax kullandığınız için teşekkür ederiz.",
...
"TXT_FREE_CREDIT" => "ücretsiz kontör",
"TXT_FROM" => "Sender",
"TXT_FROMTO" => "To/From",
...
"TXT_GBP" => "İngiliz Pound’u",
"TXT_GENERAL" => "Genel",
"TXT_GENERALNOTIFICATIONSETTINGS" => "Manage Recipients",
"TXT_GENERAL_SETTINGS" => "Genel Ayarlar",
...
"TXT_IMPORT" => "Start",
"TXT_IMPRINT" => "Imprint",
"TXT_INACTIVE_CREDIT" => "Aktif olmayan kontör",
...
"TXT_INCL_BONUS" => "({percent}% hediye kontör dahil)",
...
"TXT_INFO_CREDIT_SUCCESSFULLY_REACTIVATED" => "Kontörünüz başarıyla etkinleştirildi.",
...
"TXT_LOCALIZATION_CURR_DESC" => "PamFax'ın kullandığı, kontörünüzü gösteren para birimini değiştirebilirsiniz.",
...
"TXT_MAP_TITLE" => "Alıcının Google Maps üzerindeki konumu",
...
"TXT_NOTIFICATION_SETTINGS" => "Bildirim Ayarları",
...
"TXT_NOTIFICATION_SETTINGS_UPDATED_OK" => "Bildirim Ayarları başarıyla güncellendi!",
...
"TXT_NOVALIDFAXNUMBERLEFT" => "Girdiğiniz tüm faks numarları geçersiz. Lütfen en az bir geçerli faks numarası girin.",
"TXT_NO_COVER" => "(hiçbiri)",
...
"TXT_NO_EMAIL_RECIPIENT" => "Lütfen geçerli bir E-Posta alıcısı girin.",
...
"TXT_NO_SMS_RECIPIENT" => "Lütfen geçerli bir SMS alıcısı girin.",
"TXT_NO_UPDATE_AVAILABLE" => "No update available",
"TXT_NUMBER_1" => "Tek alıcı",
"TXT_NUMBER_2" => "Faks numarası:",
"TXT_NUMBER_3" => "Ülke seçin:",
"TXT_NUMBER_4" => "Alıcı adı:",
"TXT_NUMBER_5" => "Çoklu alıcı",
"TXT_NUMBER_6" => "(Her bir satıra bir faks numarası girin)",
"TXT_NUMBER_8" => "Faksı kime göndermek istiyorsunuz?",
"TXT_NUMBER_HINT" => "Numarayı ülke yada bölge koduyla girin",
...
"TXT_PAYMENTCANCELLED" => "Ödemeniz iptal edildi.<br>\n<br>\nLütfen şimdi bu tarayıcı penceresini kapatın ve PamFax ana penceresinden devam edin.",
"TXT_PAYMENTCANCELLED_TITLE" => "Ödeme iptal edildi",
"TXT_PAYMENT_PENDING" => "Ödemeniz bekliyor. Ödemenizi tamamladığınızda, PamFax Krediniz eklenecek.<br>\n<br>\nŞimdi bu pencereyi kapatabilirsiniz.",
...
"TXT_PAYTYPE_SKYPE" => "Skype Kontör Ödemesi",
"TXT_PAYTYPE_VOUCHER" => "Voucher code",
"TXT_PAYTYPE_WEBSHOP" => "PamFax Mağazası",
"TXT_PAY_3" => "<br>\n<br>\nFaksınızı göndermek için \"Faks Gönder\"e tıklayın.",
...
"TXT_PAY_SUMMARY" => "Bu faks <b>{pagesum} {pagename}</b> ve maliyeti <b>{price}</b>.<br><br>\n{recipient} alıcısına gönderilecek.",
"TXT_PAY_SUMMARY_2" => "This fax has {pagesum} {pagename} and will cost {price}.\n\nIt will be sent to {recipient}.",
"TXT_PAY_SUMMARY_FREE" => "Bu faks <b>{pagesum} {pagename}</b>. İyi haber: Bir PamFax numarasına gönderdiğiniz için faksınız <b>ÜCRETSİZ!</b> olarak gönderilecektir<br><br>\n{recipient} alıcısına gönderilecek.",
...
"TXT_PAY_WEBSHOP" => "Bir PamFax Kontör Paketi Satın Al:",
...
"TXT_PRICE" => "Fiyat",
"TXT_PRICEWARNING_1" => "Seçtiğiniz faks numarasının (veya bazılarının) yavaş olduğu biliniyor. Dolayısıyla fksa maliyetiniz artacak. Aşağıdaki tabloda fiyat(lar)ı görebilirsiniz. Eğer faksınız tahmin edilenden daha hızlı gönderilirse, fark PamFax kredisi olarak geri ödenecek.<br>\nRahatsızlık için özür dileriz. Devam etmek için \"Kabul Et\" butonuna tıklayın.",
...
"TXT_PRICEWARNING_TAB1" => "Numara",
"TXT_PRICEWARNING_TAB2" => "Umulan fiyat",
...
"TXT_PRINT" => "Print",
"TXT_PRIVACY" => "Gizlilik Politikası",
...
"TXT_PROFILE_SAVED" => "Ayarlar kaydedildi.",
...
"TXT_RATE" => "Fiyat",
"TXT_RATES" => "Fiyatlar",
"TXT_RATES_PER_PAGE" => "Tüm fiyatlar, sayfa başına fiyatlardır.",
"TXT_REACTIVATE_CREDIT_LINK" => "kontörü yeniden etkinleştir",
...
"TXT_REFRESH" => "Yenile",
"TXT_REFUND" => "Refund",
"TXT_REFUNDED" => "geri ödendi: %1",
"TXT_REFUNDED_ALL" => "{price} geri ödendi.",
"TXT_REFUNDED_NONE" => "Hiçbir geri ödeme mevcut değil.",
"TXT_REFUNDED_PART" => "{refunded_value} / {price} geri ödendi.",
"TXT_REGION" => "Region",
...
"TXT_RESERVE_GENERAL" => "{img_info} <b>Düzenli faks gönderiyor musunuz? Faks göndermek için PamFax kredisi satın alın. Böylece, her bir faks için ayrı bir ödeme yapmak zorunda kalmayın: Sağ üst köşedeki \"PamFax Kredisi Satın Al\" butonuna tıklayın.</b>",
"TXT_RESETMESSAGE_ALREADY_SENT" => "Password reset message has already been sent.",
"TXT_RESTART_HINT" => "Güncelleme bitirilemedi çünkü dosyalar değiştirilemedi. Lütfen, yüklemeyi tamamlamak için bilgisayarınızı yeniden başlatın.",
"TXT_RESTOFWORLD" => "Dünya'nın geri kalanı",
...
"TXT_SAVE_AS_DEFAULT" => "Varsayılan olarak kaydet",
...
"TXT_SECONDS" => "Seconds",
"TXT_SEK" => "İsveç kronu",
"TXT_SELECTCOVER_1" => "Faksınız için bir kapak sayfası seçin. Sonraki adımda, kapak sayfasına bir mesaj ekleyebileceksiniz.<br><br>",
"TXT_SELECTCOVER_2" => "<br>(Önizleme için resme çift-tıklayın)",
...
"TXT_SELECTFILE_4" => "Bir dosya seçin...",
...
"TXT_SENDER_COMPANY" => "Şirket adı",
"TXT_SENDER_DETAILS" => "Gönderen bilgisi",
"TXT_SENDER_FAX" => "Faks numarası",
...
"TXT_SEND_EMAIL_STATUS" => "Faks durumunu E-Posta ile gönder",
"TXT_SEND_FAX" => "Send a fax",
"TXT_SEND_FAX_NOW" => "Send fax now",
"TXT_SEND_MAILS_TO" => "Send emails to",
"TXT_SEND_SKYPECHAT_STATUS" => "Faks durum bilgisini Skype yazılı mesaj ile gönder",
"TXT_SEND_SMS_STATUS" => "Başarılı/Başarısız bildirimini SMS ile gönder (SMS başına {cost})",
...
"TXT_SGD" => "Singapur doları",
"TXT_SHARED_NUMBER" => "shared",
"TXT_SHOP" => "PamFax Mağazası",
...
"TXT_SHOP_ORDER_INFO" => "PamFax Mağazası siparişi: {cnt} x {product} {credit}",
"TXT_SHOP_ORDER_REFUND" => "PamFax Mağazası sipariş iadesi: {cnt} x {product} {credit}",
"TXT_SHOW" => "Show",
...
"TXT_SKYPECHAT" => "Skype Yazılı Mesaj",
...
"TXT_SMS_RECIPIENT" => "Mobil telefon numarası",
...
"TXT_STATE_ACCEPTED" => "Kabul edildi",
"TXT_STATE_BUSY" => "Meşgul",
"TXT_STATE_CANCELLED" => "İptal edildi",
"TXT_STATE_CANCEL_PENDING" => "Cancel pending",
"TXT_STATE_CLEANED_UP" => "Cleaned Up",
"TXT_STATE_CONVERTING" => "Dönüştürülüyor",
"TXT_STATE_DELAYED" => "Delayed",
"TXT_STATE_DELETED" => "Kullanıcı tarafından silindi",
"TXT_STATE_DELIVERING" => "In progress",
"TXT_STATE_DELIVERY_ERROR" => "Delivery error",
"TXT_STATE_FAILURE" => "Başarısız",
"TXT_STATE_HOLD" => "Beklemede",
"TXT_STATE_INVALIDATED" => "Onaylanmamış",
"TXT_STATE_IN_QUEUE" => "Sırada",
"TXT_STATE_ONRETRY" => "Yeniden deneniyor",
"TXT_STATE_READY" => "Hazır",
"TXT_STATE_SENDING" => "İşleniyor",
"TXT_STATE_SUBMITTED" => "Gönderildi",
"TXT_STATE_SUCCESS" => "Başarılı Fakslar",
"TXT_STATE_UNKNOWN" => "İşleniyor",
"TXT_STATE_UNPAID" => "Unpaid",
"TXT_STATE_UNPAYED" => "Waiting for payment",
"TXT_STATE_USER_CANCELLED" => "Kullanıcı tarafından iptal edildi",
"TXT_STATE_USER_CANCELLED_HINT" => "Canceled by user",
"TXT_STATE_USER_CANCEL_PENDING" => "Cancel pending",
"TXT_STATE_USER_DELETED" => "Kullanıcı tarafından silindi",
"TXT_STATUS" => "Durum",
"TXT_STATUS_DETAILS" => "Durum ayrıntıları",
...
"TXT_SUCCESSFUL_FAXES" => "Başarılı Fakslar",
"TXT_SUCCESSMESSAGE_EMAIL" => "Faksınız {fax_recipient} alıcısına başarıyla gönderildi. Daha fazla bilgi PamFax Portal'ında mevcut {directlink}",
"TXT_SUCCESSMESSAGE_SMS" => "Faksınız {fax_recipient} alıcısına başarıyla gönderildi.  PamFax'ı kullandığınız için teşekkür ederiz.",
"TXT_SUGGESTED_FOR_YOU" => "Recommended Download",
"TXT_SUPPORT" => "Support",
"TXT_SUPPORT_TICKET" => "Support-Ticket",
"TXT_TAB_DASHBOARD" => "Gösterge Paneli",
"TXT_TAB_FAXRATES" => "Fiyatlar",
...
"TXT_TAB_MY_COMPANY" => "Ayarlar",
"TXT_TASK" => "Görevler",
"TXT_TERMS" => "Kullanım Koşulları",
...
"TXT_TESTESMS_SENT" => "Test SMS'i gönderildi.",
"TXT_TESTING_CONNECTION" => "Checking connection to server...",
"TXT_THANKYOU" => "Siparişiniz için teşekkürler.<br>\n<br>\nLütfen şimdi bu tarayıcı penceresini kapatın ve PamFax ile devam edin.",
"TXT_THANKYOU_TITLE" => "Teşekkürler",
"TXT_TIME" => "Time",
...
"TXT_TIMEZONE" => "Zaman dilimi",
"TXT_TITLE" => "Alıcıları seçin",
"TXT_TO" => "Kime",
"TXT_TOTAL" => "Toplam",
"TXT_TOTAL_COST" => "Total cost",
"TXT_TRANSACTION_TYPE" => "Tür",
"TXT_TRANSMISSIONS" => "Faks aktarım geçmişi",
"TXT_TRANSMISSION_RECEIPT_FOOTER" => "Aktarım raporu PamFax tarafından {date} tarihinde oluşturuldu",
"TXT_TRANSMISSION_TIME" => "Aktarım Zamanı",
"TXT_TRASH" => "Çöp",
"TXT_TRY" => "Turkish lira",
"TXT_TRY_TO_CONNECT" => "Trying to connect...",
"TXT_TWD" => "Tayvan doları",
...
"TXT_UPDATE_HINT" => "Tüm dosyalar indirildi. Güncellemeyi şimdi yüklemek ister misiniz?",
...
"TXT_WAITING_DLG" => "PamFax yükleniyor...",
...
"TXT_WALLWIDGET_INTRO" => "Hoş geldin {username},",
"TXT_WALL_RETRY" => "Retrying fax to {fax_recipient}. Reason: {fail_reason}",
"TXT_WALL_TYPE" => "Etkinlik Türü",
"TXT_WEAK_PASS" => "Zayıf",
"TXT_WEBSITE" => "web sitesi",
...
"TXT_WEB_CONTACTS_PASS" => "Parola",
"TXT_WEB_CONTACTS_SERVICE" => "Hizmet",
"TXT_WEB_CONTACTS_USER" => "Kullanıcı adı",
"TXT_WELCOME" => "Hoş Geldin",
"TXT_WELCOMEFAX_SENDER_NAME" => "PamFax Karşılama Faksı",
...
"TXT_WHATIS_RECOVERY" => "Bu nedir?",
"TXT_WHATS_NEW" => "What's new",
"TXT_WHY_PARTIAL_REFUND" => "Neden?",
"TXT_WINDOW" => "Window",
"TXT_WIZARD_TITLE_FILES" => "Dosyaları Seçin",
...
"TXT_YOUR_BENEFITS" => "Size faydaları",
"TXT_YOUR_COMPANY_OR_MEMBERSHIP" => "Şirket Yöneticisi",
"TXT_YOUR_NUMBER" => "Your number",
"TXT_YOUR_REFERAL_LINK" => "PamFax yönlendirme bağlantısı",
"TXT_ZAR" => "South African rand",
"TXT_ZIP" => "Zip",
"TXT_ZIP_CITY" => "Zip/City",
"TXT_ZONE" => "Alan %s1",
"WINDOW_ADD_FROM_ONLINESTORAGE" => "Çevrimiçi belge(ler) ekle",
"WINDOW_AUTH_ONLINESTORAGE" => "PamFax'ı yetkilendir",
"WINDOW_CONNECT_SKYPE" => "PamFax ile Skype'a bağlan",
"WINDOW_DEFINE_PW" => "Parola tanımla",
"WINDOW_FORBIDDEN" => "Erişim reddedildi",
"WINDOW_INBOX" => "Gelen kutusu",
"WINDOW_RECOMMEND" => "PamFax'ı Öner",
"WINDOW_REGISTER" => "ÜCRETSİZ hesap oluştur",
"WINDOW_SENDFAX" => "Bir Faks Gönder",
"WINDOW_TITLE" => "PamFax - Dünyadaki herhangi bir faks numarasına bir faks gönderin",
