...
"TXT_COUNTRY_BR" => "Brazilia",
"TXT_COUNTRY_BS" => "Bahamas",
"TXT_COUNTRY_BT" => "Bhutan",
"TXT_COUNTRY_BV" => "Insula Bouvet",
"TXT_COUNTRY_BW" => "Botswana",
"TXT_COUNTRY_BY" => "Belarus",
"TXT_COUNTRY_BZ" => "Belize",
"TXT_COUNTRY_CA" => "Canada",
"TXT_COUNTRY_CC" => "Insula Cocos (Keeling)",
"TXT_COUNTRY_CD" => "Congo, Republica Democrată",
"TXT_COUNTRY_CF" => "Republica Centrafricană",
"TXT_COUNTRY_CG" => "Congo",
"TXT_COUNTRY_CH" => "Elveţia",
"TXT_COUNTRY_CHOICE" => "Select a number from one of the <b>{availablecountries}</b> countries available.",
"TXT_COUNTRY_CI" => "Coasta de Fildeş",
"TXT_COUNTRY_CK" => "Insulele Cook",
"TXT_COUNTRY_CL" => "Chile",
"TXT_COUNTRY_CM" => "Camerun",
"TXT_COUNTRY_CN" => "China",
"TXT_COUNTRY_CO" => "Columbia",
"TXT_COUNTRY_CODE_NUMBER" => "Country, code and number",
"TXT_COUNTRY_CR" => "Costa Rica",
"TXT_COUNTRY_CS" => "Serbia and Montenegro",
"TXT_COUNTRY_CU" => "Cuba",
"TXT_COUNTRY_CV" => "Capul Verde",
"TXT_COUNTRY_CW" => "Curaçao",
"TXT_COUNTRY_CX" => "Insula Christmas",
"TXT_COUNTRY_CY" => "Cipru",
"TXT_COUNTRY_CZ" => "Republica Cehă",
"TXT_COUNTRY_DE" => "Germania",
"TXT_COUNTRY_DJ" => "Djibouti",
"TXT_COUNTRY_DK" => "Danemarca",
"TXT_COUNTRY_DM" => "Dominica",
"TXT_COUNTRY_DO" => "Republica Dominicană",
"TXT_COUNTRY_DZ" => "Algeria",
"TXT_COUNTRY_EC" => "Ecuador",
"TXT_COUNTRY_EE" => "Estonia",
"TXT_COUNTRY_EG" => "Egipt",
"TXT_COUNTRY_EH" => "Sahara de Vest",
"TXT_COUNTRY_ER" => "Eritreea",
"TXT_COUNTRY_ES" => "Spania",
"TXT_COUNTRY_ET" => "Etiopia",
"TXT_COUNTRY_FI" => "Finlanda",
"TXT_COUNTRY_FJ" => "Fiji",
"TXT_COUNTRY_FK" => "Insulele Falkland (Malvine)",
"TXT_COUNTRY_FM" => "Micronezia, Statul Federal",
"TXT_COUNTRY_FO" => "Insulele Faroe",
"TXT_COUNTRY_FR" => "Franţa",
"TXT_COUNTRY_GA" => "Gabon",
"TXT_COUNTRY_GB" => "Marea Britanie",
"TXT_COUNTRY_GD" => "Grenada",
"TXT_COUNTRY_GE" => "Georgia",
"TXT_COUNTRY_GF" => "Guyana Franceză",
"TXT_COUNTRY_GG" => "Guernsey",
"TXT_COUNTRY_GH" => "Ghana",
"TXT_COUNTRY_GI" => "Gibraltar",
"TXT_COUNTRY_GL" => "Groenlanda",
"TXT_COUNTRY_GM" => "Gambia",
"TXT_COUNTRY_GN" => "Guineea",
"TXT_COUNTRY_GP" => "Guadalupa",
"TXT_COUNTRY_GQ" => "Guineea Ecuatorială",
"TXT_COUNTRY_GR" => "Grecia",
"TXT_COUNTRY_GS" => "Georgia de Sud şi Insulele Sandwich de Sud",
"TXT_COUNTRY_GT" => "Guatemala",
"TXT_COUNTRY_GU" => "Guam",
"TXT_COUNTRY_GW" => "Guineea Bissau",
"TXT_COUNTRY_GY" => "Guyana",
"TXT_COUNTRY_HK" => "Hong Kong",
"TXT_COUNTRY_HM" => "Insula Heard şi Insulele McDonald",
"TXT_COUNTRY_HN" => "Honduras",
"TXT_COUNTRY_HR" => "Croaţia",
"TXT_COUNTRY_HT" => "Haiti",
"TXT_COUNTRY_HU" => "Ungaria",
"TXT_COUNTRY_IC" => "Canary Islands",
"TXT_COUNTRY_ID" => "Indonezia",
"TXT_COUNTRY_IE" => "Irlanda",
"TXT_COUNTRY_IL" => "Israel",
"TXT_COUNTRY_IM" => "Isle of Man",
"TXT_COUNTRY_IN" => "India",
"TXT_COUNTRY_IO" => "Teritoriul Britanic din Oceanul Indian",
"TXT_COUNTRY_IQ" => "Irak",
"TXT_COUNTRY_IR" => "Iran",
...
"TXT_COUNTRY_JO" => "Iordania",
"TXT_COUNTRY_JP" => "Japonia",
"TXT_COUNTRY_KE" => "Kenya",
"TXT_COUNTRY_KG" => "Kirgizstan",
"TXT_COUNTRY_KH" => "Cambodgia",
"TXT_COUNTRY_KI" => "Kiribati",
"TXT_COUNTRY_KM" => "Comore",
"TXT_COUNTRY_KN" => "Saint Kitts şi Nevis",
"TXT_COUNTRY_KP" => "Coreea de Nord",
"TXT_COUNTRY_KR" => "Coreea de Sud",
"TXT_COUNTRY_KW" => "Kuwait",
"TXT_COUNTRY_KY" => "Insulele Cayman",
"TXT_COUNTRY_KZ" => "Kazahstan",
"TXT_COUNTRY_LA" => "Laos",
"TXT_COUNTRY_LB" => "Liban",
"TXT_COUNTRY_LC" => "Sfânta Lucia",
...
"TXT_COUNTRY_MX" => "Mexic",
"TXT_COUNTRY_MY" => "Malaezia",
"TXT_COUNTRY_MZ" => "Mozambic",
"TXT_COUNTRY_NA" => "Namibia",
"TXT_COUNTRY_NC" => "Noua Caledonie",
"TXT_COUNTRY_NE" => "Niger",
"TXT_COUNTRY_NF" => "Insula Norfolk",
"TXT_COUNTRY_NG" => "Nigeria",
"TXT_COUNTRY_NI" => "Nicaragua",
"TXT_COUNTRY_NL" => "Olanda",
"TXT_COUNTRY_NO" => "Norvegia",
"TXT_COUNTRY_NP" => "Nepal",
"TXT_COUNTRY_NR" => "Nauru",
"TXT_COUNTRY_NU" => "Niue",
"TXT_COUNTRY_NZ" => "Noua Zeelandă",
"TXT_COUNTRY_OM" => "Oman",
"TXT_COUNTRY_PA" => "Panama",
"TXT_COUNTRY_PE" => "Peru",
"TXT_COUNTRY_PF" => "Polinezia Franceză",
"TXT_COUNTRY_PG" => "Papua Noua Guinee",
"TXT_COUNTRY_PH" => "Filipine",
"TXT_COUNTRY_PK" => "Pakistan",
"TXT_COUNTRY_PL" => "Polonia",
"TXT_COUNTRY_PM" => "Sfântul Pierre Miquelon",
"TXT_COUNTRY_PN" => "Pitcairn",
"TXT_COUNTRY_PR" => "Puerto Rico",
"TXT_COUNTRY_PS" => "Teritoriul Palestinian",
...
"TXT_COUNTRY_RO" => "România",
"TXT_COUNTRY_RS" => "Serbia",
"TXT_COUNTRY_RU" => "Rusia",
"TXT_COUNTRY_RW" => "Ruanda",
"TXT_COUNTRY_SA" => "Arabia Saudită",
"TXT_COUNTRY_SB" => "Insulele Solomon",
"TXT_COUNTRY_SC" => "Seychelles",
"TXT_COUNTRY_SD" => "Sudan",
"TXT_COUNTRY_SE" => "Suedia",
"TXT_COUNTRY_SG" => "Singapore",
"TXT_COUNTRY_SH" => "Sfânta Elena",
"TXT_COUNTRY_SI" => "Slovenia",
"TXT_COUNTRY_SJ" => "Svalbard şi Jan Mayen",
"TXT_COUNTRY_SK" => "Slovacia",
...
"TXT_COUNTRY_ST" => "Sao Tome şi Principe",
"TXT_COUNTRY_SV" => "El Salvador",
"TXT_COUNTRY_SX" => "Sint Maarten",
"TXT_COUNTRY_SY" => "Siria",
"TXT_COUNTRY_SZ" => "Swaziland",
"TXT_COUNTRY_TC" => "Insulele Turks şi Caicos",
"TXT_COUNTRY_TD" => "Ciad",
"TXT_COUNTRY_TF" => "Teritoriile Franceze de Sud",
"TXT_COUNTRY_TG" => "Togo",
"TXT_COUNTRY_TH" => "Thailanda",
"TXT_COUNTRY_TJ" => "Tadjikistan",
"TXT_COUNTRY_TK" => "Tokelau",
"TXT_COUNTRY_TL" => "Timorul de Est",
"TXT_COUNTRY_TM" => "Turkmenistan",
"TXT_COUNTRY_TN" => "Tunisia",
"TXT_COUNTRY_TO" => "Tonga",
"TXT_COUNTRY_TR" => "Turcia",
"TXT_COUNTRY_TT" => "Trinidad Tobago",
