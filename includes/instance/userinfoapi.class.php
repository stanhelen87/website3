...
class UserInfoApi extends ApiClient
{
	...
	*/
	public function AddIdentifier($profiletype, $identifier, $externalprofile = false)
	{
		return $this->CallApi('UserInfo/AddIdentifier',array('profiletype' => $profiletype, 'identifier' => $identifier, 'externalprofile' => $externalprofile),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('UserInfo/RemoveIdentifier',array('identifier' => $identifier),false);
	}
	...
	*/
	public function AssignFaxNumber($areacode_id, $fullname, $street, $zip, $city, $country_code, $company = false, $building_number = false, $verify_doc_uuid = false)
	{
		return $this->CallApi('UserInfo/AssignFaxNumber',array('areacode_id' => $areacode_id, 'fullname' => $fullname, 'street' => $street, 'zip' => $zip, 'city' => $city, 'country_code' => $country_code, 'company' => $company, 'building_number' => $building_number, 'verify_doc_uuid' => $verify_doc_uuid),false);
	}
	...
	*/
	public function SetNumberAlias($number, $alias_number)
	{
		return $this->CallApi('UserInfo/SetNumberAlias',array('number' => $number, 'alias_number' => $alias_number),false);
	}

	/**
	* Removes an alias for a fax number.
	*/
	public function RemoveNumberAlias($number, $alias_number)
	{
		return $this->CallApi('UserInfo/RemoveNumberAlias',array('number' => $number, 'alias_number' => $alias_number),false);
	}
	...
	*/
	...
	{
		return $this->CallApi('UserInfo/CancelNumber',array('number' => $number),false);
	}
