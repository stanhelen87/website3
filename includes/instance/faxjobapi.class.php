...
class FaxJobApi extends ApiClient
{
	...
	*/
	public function QuickSend($username, $password, $user_ip, $origin, $rec_number, $rec_name, $cover_id = false, $cover_text = false)
	{
		return $this->CallApi('FaxJob/QuickSend',array('username' => $username, 'password' => $password, 'user_ip' => $user_ip, 'origin' => $origin, 'rec_number' => $rec_number, 'rec_name' => $rec_name, 'cover_id' => $cover_id, 'cover_text' => $cover_text),false);
	}
