...
class ShoppingApi extends ApiClient
{
	...
	*/
	public function HandleOrderSuccess($shop_user_id, $order_id, $items, $orderdata, $filedata = false)
	{
		return $this->CallApi('Shopping/HandleOrderSuccess',array('shop_user_id' => $shop_user_id, 'order_id' => $order_id, 'items' => $items, 'orderdata' => $orderdata, 'filedata' => $filedata),false);
	}
	...
	* Refund a shop order
	*/
	public function HandleOrderRefund($shop_user_id, $order_id, $items)
	{
		return $this->CallApi('Shopping/HandleOrderRefund',array('shop_user_id' => $shop_user_id, 'order_id' => $order_id, 'items' => $items),false);
	}
	...
	*/
	public function CheckAddressForFaxInNumber($group_id, $salutation, $country_code_a3, $city, $zip_code, $street_name, $building_number, $building_letter = '', $company_name = '', $first_name = '', $last_name = '', $verify_doc_uuid = '', $token = '', $rnd = '', $trial_request = '')
	{
	...
	*/
	public function ValidateAddressForFaxInNumber($area_code_id, $name, $company, $address1, $zip, $city, $country_code)
	{
		return $this->CallApi('Shopping/ValidateAddressForFaxInNumber',array('area_code_id' => $area_code_id, 'name' => $name, 'company' => $company, 'address1' => $address1, 'zip' => $zip, 'city' => $city, 'country_code' => $country_code),false);
	}
