...
class AccountApi extends ApiClient
{
	...
	*/
	public static function ExportResellerData($from, $to)
	{
		return self::StaticApi('Account/ExportResellerData',array('from' => $from, 'to' => $to),false);
	}
	...
	*/
	...
	{
		return self::StaticApi('Account/GetInfo',array(),false);
	}
	...
	*/
	...
	{
		return self::StaticApi('Account/SetDefaultTimezone',array('timezone' => $timezone),false);
	}
}
?>
