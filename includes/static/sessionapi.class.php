...
class SessionApi extends ApiClient
{
	...
	*/
	public static function VerifyFromIdentifier($identifier, $user_ip = false, $type = false)
	{
		return self::StaticApi('Session/VerifyFromIdentifier',array('identifier' => $identifier, 'user_ip' => $user_ip, 'type' => $type),false);
	}
